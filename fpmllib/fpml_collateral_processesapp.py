...
#
# Generated Tue Feb 23 09:01:03 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_collateral_processeslib.py')
#   ('-s', 'fpml01/fpml_collateral_processesapp.py')
#   ('--super', 'fpml01/fpml_collateral_processeslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-collateral-processes.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_collateral_processeslib.py" -s "fpml01/fpml_collateral_processesapp.py" --super="fpml01/fpml_collateral_processeslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-collateral-processes.xsd
#
...
import fpml01/fpml_collateral_processeslib as supermod
...
class AssetsSub(supermod.Assets):
    def __init__(self, underlyingAsset=None):
        super(AssetsSub, self).__init__(underlyingAsset, )
supermod.Assets.subclass = AssetsSub
# end class AssetsSub


class AgreedAmountSub(supermod.AgreedAmount):
    def __init__(self, giverPartyReference=None, takerPartyReference=None, variationMargin=None, segregatedIndependentAmount=None):
        super(AgreedAmountSub, self).__init__(giverPartyReference, takerPartyReference, variationMargin, segregatedIndependentAmount, )
supermod.AgreedAmount.subclass = AgreedAmountSub
# end class AgreedAmountSub


class AggregatedIndependentAmountSub(supermod.AggregatedIndependentAmount):
    def __init__(self, trade=None, valueAtRisk=None, netOpenPosition=None):
        super(AggregatedIndependentAmountSub, self).__init__(trade, valueAtRisk, netOpenPosition, )
supermod.AggregatedIndependentAmount.subclass = AggregatedIndependentAmountSub
# end class AggregatedIndependentAmountSub


class BothDirectionsInterestRequirementSub(supermod.BothDirectionsInterestRequirement):
    def __init__(self, netTreatment=None, grossTreatment=None, interestAccrued=None):
        super(BothDirectionsInterestRequirementSub, self).__init__(netTreatment, grossTreatment, interestAccrued, )
supermod.BothDirectionsInterestRequirement.subclass = BothDirectionsInterestRequirementSub
# end class BothDirectionsInterestRequirementSub


class BothDirectionsInterestStatementRequirementSub(supermod.BothDirectionsInterestStatementRequirement):
    def __init__(self, interestAccrued=None):
        super(BothDirectionsInterestStatementRequirementSub, self).__init__(interestAccrued, )
supermod.BothDirectionsInterestStatementRequirement.subclass = BothDirectionsInterestStatementRequirementSub
# end class BothDirectionsInterestStatementRequirementSub


class CashDeliveryReturnSub(supermod.CashDeliveryReturn):
    def __init__(self, assetReference=None, nominalAmount=None, valueDate=None, marketValue=None, haircut=None, collateralValue=None):
        super(CashDeliveryReturnSub, self).__init__(assetReference, nominalAmount, valueDate, marketValue, haircut, collateralValue, )
supermod.CashDeliveryReturn.subclass = CashDeliveryReturnSub
# end class CashDeliveryReturnSub


class CashTypeSub(supermod.CashType):
    def __init__(self, currency=None):
        super(CashTypeSub, self).__init__(currency, )
supermod.CashType.subclass = CashTypeSub
# end class CashTypeSub


class CollateralBalanceSub(supermod.CollateralBalance):
    def __init__(self, variationMargin=None, segregatedIndependentAmount=None):
        super(CollateralBalanceSub, self).__init__(variationMargin, segregatedIndependentAmount, )
supermod.CollateralBalance.subclass = CollateralBalanceSub
# end class CollateralBalanceSub


class CollateralResponseReasonSub(supermod.CollateralResponseReason):
    def __init__(self, reasonCode=None, description=None):
        super(CollateralResponseReasonSub, self).__init__(reasonCode, description, )
supermod.CollateralResponseReason.subclass = CollateralResponseReasonSub
# end class CollateralResponseReasonSub


class CollateralResponseReasonCodeSub(supermod.CollateralResponseReasonCode):
    def __init__(self, collateralResponseReasonScheme='http://www.fpml.org/coding-scheme/collateral-response-reason', valueOf_=None):
        super(CollateralResponseReasonCodeSub, self).__init__(collateralResponseReasonScheme, valueOf_, )
supermod.CollateralResponseReasonCode.subclass = CollateralResponseReasonCodeSub
# end class CollateralResponseReasonCodeSub


class CollateralRetractionReasonSub(supermod.CollateralRetractionReason):
    def __init__(self, reasonCode=None, description=None):
        super(CollateralRetractionReasonSub, self).__init__(reasonCode, description, )
supermod.CollateralRetractionReason.subclass = CollateralRetractionReasonSub
# end class CollateralRetractionReasonSub


class CollateralRetractionReasonCodeSub(supermod.CollateralRetractionReasonCode):
    def __init__(self, collateralRetractionReasonScheme='http://www.fpml.org/coding-scheme/collateral-retraction-reason', valueOf_=None):
        super(CollateralRetractionReasonCodeSub, self).__init__(collateralRetractionReasonScheme, valueOf_, )
supermod.CollateralRetractionReasonCode.subclass = CollateralRetractionReasonCodeSub
# end class CollateralRetractionReasonCodeSub


class DailyInterestCalculationSub(supermod.DailyInterestCalculation):
    def __init__(self, calculationDate=None, openingPrincipalAmount=None, principalMovement=None, effectivePrincipalAmount=None, observedRate=None, spread=None, effectiveRate=None, accruedInterestAmount=None, cumulativeInterestAmount=None):
        super(DailyInterestCalculationSub, self).__init__(calculationDate, openingPrincipalAmount, principalMovement, effectivePrincipalAmount, observedRate, spread, effectiveRate, accruedInterestAmount, cumulativeInterestAmount, )
supermod.DailyInterestCalculation.subclass = DailyInterestCalculationSub
# end class DailyInterestCalculationSub


class DisputedCollateralSub(supermod.DisputedCollateral):
    def __init__(self, disputedAmount=None, disputeDate=None, disputeResolutionMethod=None):
        super(DisputedCollateralSub, self).__init__(disputedAmount, disputeDate, disputeResolutionMethod, )
supermod.DisputedCollateral.subclass = DisputedCollateralSub
# end class DisputedCollateralSub


class DisputeResolutionCodeSub(supermod.DisputeResolutionCode):
    def __init__(self, collateralDisputeResolutionMethodReasonScheme='http://www.fpml.org/coding-scheme/collateral-dispute-resolution-method-reason', valueOf_=None):
        super(DisputeResolutionCodeSub, self).__init__(collateralDisputeResolutionMethodReasonScheme, valueOf_, )
supermod.DisputeResolutionCode.subclass = DisputeResolutionCodeSub
# end class DisputeResolutionCodeSub


class DisputeResolutionMethodSub(supermod.DisputeResolutionMethod):
    def __init__(self, resolutionCode=None, description=None):
        super(DisputeResolutionMethodSub, self).__init__(resolutionCode, description, )
supermod.DisputeResolutionMethod.subclass = DisputeResolutionMethodSub
# end class DisputeResolutionMethodSub


class ExpectedCollateralSub(supermod.ExpectedCollateral):
    def __init__(self, variationMargin=None, segregatedIndependentAmount=None):
        super(ExpectedCollateralSub, self).__init__(variationMargin, segregatedIndependentAmount, )
supermod.ExpectedCollateral.subclass = ExpectedCollateralSub
# end class ExpectedCollateralSub


class ExpectedCollateralDeliveryReturnSub(supermod.ExpectedCollateralDeliveryReturn):
    def __init__(self, deliver=None, return_=None):
        super(ExpectedCollateralDeliveryReturnSub, self).__init__(deliver, return_, )
supermod.ExpectedCollateralDeliveryReturn.subclass = ExpectedCollateralDeliveryReturnSub
# end class ExpectedCollateralDeliveryReturnSub


class ExpectedCollateralDeliverySub(supermod.ExpectedCollateralDelivery):
    def __init__(self, cashType=None, securityType=None, letterOfCreditType=None):
        super(ExpectedCollateralDeliverySub, self).__init__(cashType, securityType, letterOfCreditType, )
supermod.ExpectedCollateralDelivery.subclass = ExpectedCollateralDeliverySub
# end class ExpectedCollateralDeliverySub


class ExposureSub(supermod.Exposure):
    def __init__(self, exposedPartyReference=None, obligatedPartyReference=None, exposureAmount=None):
        super(ExposureSub, self).__init__(exposedPartyReference, obligatedPartyReference, exposureAmount, )
supermod.Exposure.subclass = ExposureSub
# end class ExposureSub


class GrossTreatmentSub(supermod.GrossTreatment):
    def __init__(self, paymentDetails=None):
        super(GrossTreatmentSub, self).__init__(paymentDetails, )
supermod.GrossTreatment.subclass = GrossTreatmentSub
# end class GrossTreatmentSub


class HeldCollateralSub(supermod.HeldCollateral):
    def __init__(self, holdingPartyReference=None, postingPartyReference=None, paymentAmount=None):
        super(HeldCollateralSub, self).__init__(holdingPartyReference, postingPartyReference, paymentAmount, )
supermod.HeldCollateral.subclass = HeldCollateralSub
# end class HeldCollateralSub


class IndependentAmountTypeSub(supermod.IndependentAmountType):
    def __init__(self, giverPartyReference=None, takerPartyReference=None, paymentAmount=None, convention=None):
        super(IndependentAmountTypeSub, self).__init__(giverPartyReference, takerPartyReference, paymentAmount, convention, )
supermod.IndependentAmountType.subclass = IndependentAmountTypeSub
# end class IndependentAmountTypeSub


class InterestAccruedSub(supermod.InterestAccrued):
    def __init__(self, deliveringPartyReference=None, receivingPartyReference=None, interest=None, withholdingTax=None, withholdingTaxTerms=None, interestCalculationTerms=None, interestCalculationDetails=None):
        super(InterestAccruedSub, self).__init__(deliveringPartyReference, receivingPartyReference, interest, withholdingTax, withholdingTaxTerms, interestCalculationTerms, interestCalculationDetails, )
supermod.InterestAccrued.subclass = InterestAccruedSub
# end class InterestAccruedSub


class InterestCalculationDetailsSub(supermod.InterestCalculationDetails):
    def __init__(self, dailyInterestCalculation=None):
        super(InterestCalculationDetailsSub, self).__init__(dailyInterestCalculation, )
supermod.InterestCalculationDetails.subclass = InterestCalculationDetailsSub
# end class InterestCalculationDetailsSub


class InterestCalculationTermsSub(supermod.InterestCalculationTerms):
    def __init__(self, calculationType=None, index=None, spread=None, dayCountFraction=None):
        super(InterestCalculationTermsSub, self).__init__(calculationType, index, spread, dayCountFraction, )
supermod.InterestCalculationTerms.subclass = InterestCalculationTermsSub
# end class InterestCalculationTermsSub


class InterestDirectionSub(supermod.InterestDirection):
    def __init__(self, singleDirection=None, bothDirections=None):
        super(InterestDirectionSub, self).__init__(singleDirection, bothDirections, )
supermod.InterestDirection.subclass = InterestDirectionSub
# end class InterestDirectionSub


class InterestPeriodSub(supermod.InterestPeriod):
    def __init__(self, startDate=None, endDate=None):
        super(InterestPeriodSub, self).__init__(startDate, endDate, )
supermod.InterestPeriod.subclass = InterestPeriodSub
# end class InterestPeriodSub


class InterestRequirementSub(supermod.InterestRequirement):
    def __init__(self, interestPeriod=None, variationMargin=None, segregatedIndependentAmount=None):
        super(InterestRequirementSub, self).__init__(interestPeriod, variationMargin, segregatedIndependentAmount, )
supermod.InterestRequirement.subclass = InterestRequirementSub
# end class InterestRequirementSub


class InterestResponseSub(supermod.InterestResponse):
    def __init__(self, interestApproved=None, interestResponseReason=None):
        super(InterestResponseSub, self).__init__(interestApproved, interestResponseReason, )
supermod.InterestResponse.subclass = InterestResponseSub
# end class InterestResponseSub


class InterestResponseReasonSub(supermod.InterestResponseReason):
    def __init__(self, reasonCode=None, description=None):
        super(InterestResponseReasonSub, self).__init__(reasonCode, description, )
supermod.InterestResponseReason.subclass = InterestResponseReasonSub
# end class InterestResponseReasonSub


class InterestResponseReasonCodeSub(supermod.InterestResponseReasonCode):
    def __init__(self, collateralInterestResponseReasonScheme='http://www.fpml.org/coding-scheme/collateral-interest-response-reason', valueOf_=None):
        super(InterestResponseReasonCodeSub, self).__init__(collateralInterestResponseReasonScheme, valueOf_, )
supermod.InterestResponseReasonCode.subclass = InterestResponseReasonCodeSub
# end class InterestResponseReasonCodeSub


class InterestStatementDirectionSub(supermod.InterestStatementDirection):
    def __init__(self, singleDirection=None, bothDirections=None):
        super(InterestStatementDirectionSub, self).__init__(singleDirection, bothDirections, )
supermod.InterestStatementDirection.subclass = InterestStatementDirectionSub
# end class InterestStatementDirectionSub


class InterestStatementRequirementSub(supermod.InterestStatementRequirement):
    def __init__(self, interestPeriod=None, variationMargin=None, segregatedIndependentAmount=None):
        super(InterestStatementRequirementSub, self).__init__(interestPeriod, variationMargin, segregatedIndependentAmount, )
supermod.InterestStatementRequirement.subclass = InterestStatementRequirementSub
# end class InterestStatementRequirementSub


class LcSummarySub(supermod.LcSummary):
    def __init__(self, identifier=None, extensiontype_=None):
        super(LcSummarySub, self).__init__(identifier, extensiontype_, )
supermod.LcSummary.subclass = LcSummarySub
# end class LcSummarySub


class LetterOfCreditCollateralSub(supermod.LetterOfCreditCollateral):
    def __init__(self, identifier=None, amount=None, valueDate=None, marketValue=None, haircut=None, collateralValue=None):
        super(LetterOfCreditCollateralSub, self).__init__(identifier, amount, valueDate, marketValue, haircut, collateralValue, )
supermod.LetterOfCreditCollateral.subclass = LetterOfCreditCollateralSub
# end class LetterOfCreditCollateralSub


class LetterOfCreditTypeSub(supermod.LetterOfCreditType):
    def __init__(self, description=None):
        super(LetterOfCreditTypeSub, self).__init__(description, )
supermod.LetterOfCreditType.subclass = LetterOfCreditTypeSub
# end class LetterOfCreditTypeSub


class MarginCallResponseReasonSub(supermod.MarginCallResponseReason):
    def __init__(self, reasonCode=None, description=None):
        super(MarginCallResponseReasonSub, self).__init__(reasonCode, description, )
supermod.MarginCallResponseReason.subclass = MarginCallResponseReasonSub
# end class MarginCallResponseReasonSub


class MarginCallResponseReasonCodeSub(supermod.MarginCallResponseReasonCode):
    def __init__(self, collateralMarginCallResponseReasonScheme='http://www.fpml.org/coding-scheme/collateral-margin-call-response-reason', valueOf_=None):
        super(MarginCallResponseReasonCodeSub, self).__init__(collateralMarginCallResponseReasonScheme, valueOf_, )
supermod.MarginCallResponseReasonCode.subclass = MarginCallResponseReasonCodeSub
# end class MarginCallResponseReasonCodeSub


class MarginCallResultSub(supermod.MarginCallResult):
    def __init__(self, variationMargin=None, segregatedIndependentAmount=None):
        super(MarginCallResultSub, self).__init__(variationMargin, segregatedIndependentAmount, )
supermod.MarginCallResult.subclass = MarginCallResultSub
# end class MarginCallResultSub


class MarginCollateralSub(supermod.MarginCollateral):
    def __init__(self, pendingCollateral=None, heldCollateral=None):
        super(MarginCollateralSub, self).__init__(pendingCollateral, heldCollateral, )
supermod.MarginCollateral.subclass = MarginCollateralSub
# end class MarginCollateralSub


class MarginRequirementSub(supermod.MarginRequirement):
    def __init__(self, variationMargin=None, segregatedIndependentAmount=None):
        super(MarginRequirementSub, self).__init__(variationMargin, segregatedIndependentAmount, )
supermod.MarginRequirement.subclass = MarginRequirementSub
# end class MarginRequirementSub


class MarginRequirementDeliverSub(supermod.MarginRequirementDeliver):
    def __init__(self, deliveringPartyReference=None, receivingPartyReference=None, currency=None, amount=None):
        super(MarginRequirementDeliverSub, self).__init__(deliveringPartyReference, receivingPartyReference, currency, amount, )
supermod.MarginRequirementDeliver.subclass = MarginRequirementDeliverSub
# end class MarginRequirementDeliverSub


class MarginRequirementReturnSub(supermod.MarginRequirementReturn):
    def __init__(self, deliveringPartyReference=None, receivingPartyReference=None, currency=None, amount=None):
        super(MarginRequirementReturnSub, self).__init__(deliveringPartyReference, receivingPartyReference, currency, amount, )
supermod.MarginRequirementReturn.subclass = MarginRequirementReturnSub
# end class MarginRequirementReturnSub


class MarginTermSub(supermod.MarginTerm):
    def __init__(self, currency=None, variationMargin=None, segregatedIndependentAmount=None):
        super(MarginTermSub, self).__init__(currency, variationMargin, segregatedIndependentAmount, )
supermod.MarginTerm.subclass = MarginTermSub
# end class MarginTermSub


class MarkToMarketSub(supermod.MarkToMarket):
    def __init__(self, exposure=None, convention=None):
        super(MarkToMarketSub, self).__init__(exposure, convention, )
supermod.MarkToMarket.subclass = MarkToMarketSub
# end class MarkToMarketSub


class NetTreatmentSub(supermod.NetTreatment):
    def __init__(self, paymentDetails=None):
        super(NetTreatmentSub, self).__init__(paymentDetails, )
supermod.NetTreatment.subclass = NetTreatmentSub
# end class NetTreatmentSub


class PendingCollateralSub(supermod.PendingCollateral):
    def __init__(self, giverPartyReference=None, takerPartyReference=None, paymentAmount=None):
        super(PendingCollateralSub, self).__init__(giverPartyReference, takerPartyReference, paymentAmount, )
supermod.PendingCollateral.subclass = PendingCollateralSub
# end class PendingCollateralSub


class PrincipalMovementSub(supermod.PrincipalMovement):
    def __init__(self, identifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, paymentAmount=None):
        super(PrincipalMovementSub, self).__init__(identifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, paymentAmount, )
supermod.PrincipalMovement.subclass = PrincipalMovementSub
# end class PrincipalMovementSub


class ProposedCollateralSub(supermod.ProposedCollateral):
    def __init__(self, deliver=None, return_=None):
        super(ProposedCollateralSub, self).__init__(deliver, return_, )
supermod.ProposedCollateral.subclass = ProposedCollateralSub
# end class ProposedCollateralSub


class ProposedCollateralDeliveryReturnSub(supermod.ProposedCollateralDeliveryReturn):
    def __init__(self, deliveringPartyReference=None, receivingPartyReference=None, cash=None, security=None, letterOfCredit=None):
        super(ProposedCollateralDeliveryReturnSub, self).__init__(deliveringPartyReference, receivingPartyReference, cash, security, letterOfCredit, )
supermod.ProposedCollateralDeliveryReturn.subclass = ProposedCollateralDeliveryReturnSub
# end class ProposedCollateralDeliveryReturnSub


class ProposedCollateralResponseSub(supermod.ProposedCollateralResponse):
    def __init__(self, proposalApproved=None, collateralResponseReason=None, expectedCollateral=None):
        super(ProposedCollateralResponseSub, self).__init__(proposalApproved, collateralResponseReason, expectedCollateral, )
supermod.ProposedCollateralResponse.subclass = ProposedCollateralResponseSub
# end class ProposedCollateralResponseSub


class SecurityDeliveryReturnSub(supermod.SecurityDeliveryReturn):
    def __init__(self, assetReference=None, valueDate=None, nominalAmount=None, dirtyPrice=None, numberOfUnits=None, unitPrice=None, marketValue=None, haircut=None, collateralValue=None):
        super(SecurityDeliveryReturnSub, self).__init__(assetReference, valueDate, nominalAmount, dirtyPrice, numberOfUnits, unitPrice, marketValue, haircut, collateralValue, )
supermod.SecurityDeliveryReturn.subclass = SecurityDeliveryReturnSub
# end class SecurityDeliveryReturnSub


class SecurityTypeSub(supermod.SecurityType):
    def __init__(self, description=None):
        super(SecurityTypeSub, self).__init__(description, )
supermod.SecurityType.subclass = SecurityTypeSub
# end class SecurityTypeSub


class SegregatedIndependentAmountMarginTermSub(supermod.SegregatedIndependentAmountMarginTerm):
    def __init__(self, minimumTransferAmount=None, transferRounding=None):
        super(SegregatedIndependentAmountMarginTermSub, self).__init__(minimumTransferAmount, transferRounding, )
supermod.SegregatedIndependentAmountMarginTerm.subclass = SegregatedIndependentAmountMarginTermSub
# end class SegregatedIndependentAmountMarginTermSub


class SingleDirectionInterestRequirementSub(supermod.SingleDirectionInterestRequirement):
    def __init__(self, singleTreatment=None, interestAccrued=None):
        super(SingleDirectionInterestRequirementSub, self).__init__(singleTreatment, interestAccrued, )
supermod.SingleDirectionInterestRequirement.subclass = SingleDirectionInterestRequirementSub
# end class SingleDirectionInterestRequirementSub


class SingleDirectionInterestStatementRequirementSub(supermod.SingleDirectionInterestStatementRequirement):
    def __init__(self, interestAccrued=None):
        super(SingleDirectionInterestStatementRequirementSub, self).__init__(interestAccrued, )
supermod.SingleDirectionInterestStatementRequirement.subclass = SingleDirectionInterestStatementRequirementSub
# end class SingleDirectionInterestStatementRequirementSub


class SingleTreatmentSub(supermod.SingleTreatment):
    def __init__(self, paymentDetails=None):
        super(SingleTreatmentSub, self).__init__(paymentDetails, )
supermod.SingleTreatment.subclass = SingleTreatmentSub
# end class SingleTreatmentSub


class SubstituteCollateralSub(supermod.SubstituteCollateral):
    def __init__(self, return_=None, deliver=None, substitutionAmount=None):
        super(SubstituteCollateralSub, self).__init__(return_, deliver, substitutionAmount, )
supermod.SubstituteCollateral.subclass = SubstituteCollateralSub
# end class SubstituteCollateralSub


class SubstitutionConfirmationSub(supermod.SubstitutionConfirmation):
    def __init__(self, released=None, description=None):
        super(SubstitutionConfirmationSub, self).__init__(released, description, )
supermod.SubstitutionConfirmation.subclass = SubstitutionConfirmationSub
# end class SubstitutionConfirmationSub


class SubstitutionResponseSub(supermod.SubstitutionResponse):
    def __init__(self, substitutionApproved=None, substitutionResponseReason=None):
        super(SubstitutionResponseSub, self).__init__(substitutionApproved, substitutionResponseReason, )
supermod.SubstitutionResponse.subclass = SubstitutionResponseSub
# end class SubstitutionResponseSub


class SubstitutionResponseReasonSub(supermod.SubstitutionResponseReason):
    def __init__(self, reasonCode=None, description=None):
        super(SubstitutionResponseReasonSub, self).__init__(reasonCode, description, )
supermod.SubstitutionResponseReason.subclass = SubstitutionResponseReasonSub
# end class SubstitutionResponseReasonSub


class SubstitutionResponseReasonCodeSub(supermod.SubstitutionResponseReasonCode):
    def __init__(self, collateralSubstitutionResponseReasonScheme='http://www.fpml.org/coding-scheme/collateral-substitution-response-reason', valueOf_=None):
        super(SubstitutionResponseReasonCodeSub, self).__init__(collateralSubstitutionResponseReasonScheme, valueOf_, )
supermod.SubstitutionResponseReasonCode.subclass = SubstitutionResponseReasonCodeSub
# end class SubstitutionResponseReasonCodeSub


class ThresholdSub(supermod.Threshold):
    def __init__(self, amount=None, type_=None):
        super(ThresholdSub, self).__init__(amount, type_, )
supermod.Threshold.subclass = ThresholdSub
# end class ThresholdSub


class TransferRoundingSub(supermod.TransferRounding):
    def __init__(self, direction=None, amount=None):
        super(TransferRoundingSub, self).__init__(direction, amount, )
supermod.TransferRounding.subclass = TransferRoundingSub
# end class TransferRoundingSub


class VariationMarginTermSub(supermod.VariationMarginTerm):
    def __init__(self, threshold=None, minimumTransferAmount=None, transferRounding=None):
        super(VariationMarginTermSub, self).__init__(threshold, minimumTransferAmount, transferRounding, )
supermod.VariationMarginTerm.subclass = VariationMarginTermSub
# end class VariationMarginTermSub


class VariationRequirementSub(supermod.VariationRequirement):
    def __init__(self, deliver=None, return_=None):
        super(VariationRequirementSub, self).__init__(deliver, return_, )
supermod.VariationRequirement.subclass = VariationRequirementSub
# end class VariationRequirementSub


class VariationResultSub(supermod.VariationResult):
    def __init__(self, giverPartyReference=None, takerPartyReference=None, marginCallAmount=None):
        super(VariationResultSub, self).__init__(giverPartyReference, takerPartyReference, marginCallAmount, )
supermod.VariationResult.subclass = VariationResultSub
# end class VariationResultSub


class WithholdingTaxTermsSub(supermod.WithholdingTaxTerms):
    def __init__(self, jurisdiction=None, rate=None):
        super(WithholdingTaxTermsSub, self).__init__(jurisdiction, rate, )
supermod.WithholdingTaxTerms.subclass = WithholdingTaxTermsSub
# end class WithholdingTaxTermsSub
...
class InterestPaymentDetailsSub(supermod.InterestPaymentDetails):
    def __init__(self, id=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, paymentDate=None, paymentAmount=None, method=None):
        super(InterestPaymentDetailsSub, self).__init__(id, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, paymentDate, paymentAmount, method, )
supermod.InterestPaymentDetails.subclass = InterestPaymentDetailsSub
# end class InterestPaymentDetailsSub
...
class SubstitutionStatusRetractedSub(supermod.SubstitutionStatusRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, substitutionIssuerPartyReference=None, substitutionReceiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(SubstitutionStatusRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, substitutionIssuerPartyReference, substitutionReceiverPartyReference, party, account, collateralRetractionReason, )
supermod.SubstitutionStatusRetracted.subclass = SubstitutionStatusRetractedSub
# end class SubstitutionStatusRetractedSub


class SubstitutionStatusSub(supermod.SubstitutionStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, substitutionIssuerPartyReference=None, substitutionReceiverPartyReference=None, creditSupportAgreement=None, variationMargin=None, segregatedIndependentAmount=None, assets=None, party=None, account=None):
        super(SubstitutionStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, substitutionIssuerPartyReference, substitutionReceiverPartyReference, creditSupportAgreement, variationMargin, segregatedIndependentAmount, assets, party, account, )
supermod.SubstitutionStatus.subclass = SubstitutionStatusSub
# end class SubstitutionStatusSub


class SubstituteReturnConfirmationStatusSub(supermod.SubstituteReturnConfirmationStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, substitutionIssuerPartyReference=None, substitutionReceiverPartyReference=None, creditSupportAgreement=None, variationMargin=None, segregatedIndependentAmount=None, assets=None, party=None, account=None):
        super(SubstituteReturnConfirmationStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, substitutionIssuerPartyReference, substitutionReceiverPartyReference, creditSupportAgreement, variationMargin, segregatedIndependentAmount, assets, party, account, )
supermod.SubstituteReturnConfirmationStatus.subclass = SubstituteReturnConfirmationStatusSub
# end class SubstituteReturnConfirmationStatusSub


class RequestSubstitutionRetractedSub(supermod.RequestSubstitutionRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, substitutionIssuerPartyReference=None, substitutionReceiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(RequestSubstitutionRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, substitutionIssuerPartyReference, substitutionReceiverPartyReference, party, account, collateralRetractionReason, )
supermod.RequestSubstitutionRetracted.subclass = RequestSubstitutionRetractedSub
# end class RequestSubstitutionRetractedSub


class RequestSubstitutionSub(supermod.RequestSubstitution):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, substitutionIssuerPartyReference=None, substitutionReceiverPartyReference=None, creditSupportAgreement=None, variationMargin=None, segregatedIndependentAmount=None, assets=None, party=None, account=None):
        super(RequestSubstitutionSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, substitutionIssuerPartyReference, substitutionReceiverPartyReference, creditSupportAgreement, variationMargin, segregatedIndependentAmount, assets, party, account, )
supermod.RequestSubstitution.subclass = RequestSubstitutionSub
# end class RequestSubstitutionSub


class RequestMarginRetractedSub(supermod.RequestMarginRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(RequestMarginRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, party, account, collateralRetractionReason, )
supermod.RequestMarginRetracted.subclass = RequestMarginRetractedSub
# end class RequestMarginRetractedSub


class RequestMarginSub(supermod.RequestMargin):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, creditSupportAgreement=None, valuationDate=None, baseCurrency=None, markToMarket=None, independentAmount=None, marginTerm=None, collateral=None, marginRequirement=None, marginCallResult=None, expectedCollateral=None, assets=None, party=None, account=None):
        super(RequestMarginSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, creditSupportAgreement, valuationDate, baseCurrency, markToMarket, independentAmount, marginTerm, collateral, marginRequirement, marginCallResult, expectedCollateral, assets, party, account, )
supermod.RequestMargin.subclass = RequestMarginSub
# end class RequestMarginSub


class RequestInterestRetractedSub(supermod.RequestInterestRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, issuerPartyReference=None, receiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(RequestInterestRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, issuerPartyReference, receiverPartyReference, party, account, collateralRetractionReason, )
supermod.RequestInterestRetracted.subclass = RequestInterestRetractedSub
# end class RequestInterestRetractedSub


class RequestInterestSub(supermod.RequestInterest):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, issuerPartyReference=None, receiverPartyReference=None, creditSupportAgreement=None, interestRequirement=None, comment=None, party=None, account=None):
        super(RequestInterestSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, issuerPartyReference, receiverPartyReference, creditSupportAgreement, interestRequirement, comment, party, account, )
supermod.RequestInterest.subclass = RequestInterestSub
# end class RequestInterestSub


class RequestCollateralAcceptanceSub(supermod.RequestCollateralAcceptance):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, agreedAmount=None, variationMargin=None, segregatedIndependentAmount=None, assets=None, party=None, account=None):
        super(RequestCollateralAcceptanceSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, agreedAmount, variationMargin, segregatedIndependentAmount, assets, party, account, )
supermod.RequestCollateralAcceptance.subclass = RequestCollateralAcceptanceSub
# end class RequestCollateralAcceptanceSub


class MarginCallStatusRetractedSub(supermod.MarginCallStatusRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(MarginCallStatusRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, party, account, collateralRetractionReason, )
supermod.MarginCallStatusRetracted.subclass = MarginCallStatusRetractedSub
# end class MarginCallStatusRetractedSub


class MarginCallStatusSub(supermod.MarginCallStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, creditSupportAgreement=None, valuationDate=None, baseCurrency=None, markToMarket=None, independentAmount=None, marginTerm=None, collateral=None, agreedAmount=None, marginCallResponseReason=None, party=None, account=None):
        super(MarginCallStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, creditSupportAgreement, valuationDate, baseCurrency, markToMarket, independentAmount, marginTerm, collateral, agreedAmount, marginCallResponseReason, party, account, )
supermod.MarginCallStatus.subclass = MarginCallStatusSub
# end class MarginCallStatusSub


class InterestStatusRetractedSub(supermod.InterestStatusRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, issuerPartyReference=None, receiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(InterestStatusRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, issuerPartyReference, receiverPartyReference, party, account, collateralRetractionReason, )
supermod.InterestStatusRetracted.subclass = InterestStatusRetractedSub
# end class InterestStatusRetractedSub


class InterestStatusSub(supermod.InterestStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, issuerPartyReference=None, receiverPartyReference=None, creditSupportAgreement=None, variationMargin=None, segregatedIndependentAmount=None, party=None, account=None):
        super(InterestStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, issuerPartyReference, receiverPartyReference, creditSupportAgreement, variationMargin, segregatedIndependentAmount, party, account, )
supermod.InterestStatus.subclass = InterestStatusSub
# end class InterestStatusSub


class InterestStatementSub(supermod.InterestStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, issuerPartyReference=None, receiverPartyReference=None, creditSupportAgreement=None, interestRequirement=None, comment=None, party=None, account=None):
        super(InterestStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, issuerPartyReference, receiverPartyReference, creditSupportAgreement, interestRequirement, comment, party, account, )
supermod.InterestStatement.subclass = InterestStatementSub
# end class InterestStatementSub


class DisputeRetractedSub(supermod.DisputeRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, party=None, account=None, collateralRetractionReason=None):
        super(DisputeRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, party, account, collateralRetractionReason, )
supermod.DisputeRetracted.subclass = DisputeRetractedSub
# end class DisputeRetractedSub


class DisputeNotificationSub(supermod.DisputeNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, creditSupportAgreement=None, valuationDate=None, baseCurrency=None, variationMargin=None, segregatedIndependentAmount=None, party=None, account=None):
        super(DisputeNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, creditSupportAgreement, valuationDate, baseCurrency, variationMargin, segregatedIndependentAmount, party, account, )
supermod.DisputeNotification.subclass = DisputeNotificationSub
# end class DisputeNotificationSub


class CollateralProposalStatusSub(supermod.CollateralProposalStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, marginCallIssuerPartyReference=None, marginCallReceiverPartyReference=None, variationMargin=None, segregatedIndependentAmount=None, assets=None, party=None, account=None):
        super(CollateralProposalStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, marginCallIssuerPartyReference, marginCallReceiverPartyReference, variationMargin, segregatedIndependentAmount, assets, party, account, )
supermod.CollateralProposalStatus.subclass = CollateralProposalStatusSub
# end class CollateralProposalStatusSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_collateral_processeslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_collateral_processeslib as model_\n\n')
