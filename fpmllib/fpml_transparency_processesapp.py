...
#
# Generated Tue Feb 23 09:04:16 2016 by generateDS.py version 2.19b.
#
...
import fpml01/fpml_transparency_processeslib as supermod
...
class PublicExecutionReportRetractedSub(supermod.PublicExecutionReportRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, withdrawal=None, primaryAssetClass=None, tradeIdentifier=None, eventIdentifier=None, party=None, account=None):
        super(PublicExecutionReportRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, withdrawal, primaryAssetClass, tradeIdentifier, eventIdentifier, party, account, )
supermod.PublicExecutionReportRetracted.subclass = PublicExecutionReportRetractedSub
# end class PublicExecutionReportRetractedSub


class PublicExecutionReportSub(supermod.PublicExecutionReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, withdrawal=None, quote=None, party=None, account=None):
        super(PublicExecutionReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, withdrawal, quote, party, account, )
supermod.PublicExecutionReport.subclass = PublicExecutionReportSub
# end class PublicExecutionReportSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        ...
        rootClass = supermod.PublicExecutionReport
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_transparency_processeslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_transparency_processeslib as model_\n\n')
