...
#
# Generated Tue Feb 23 09:04:27 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_valuation_reportinglib.py')
#   ('-s', 'fpml01/fpml_valuation_reportingapp.py')
#   ('--super', 'fpml01/fpml_valuation_reportinglib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-valuation-reporting.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_valuation_reportinglib.py" -s "fpml01/fpml_valuation_reportingapp.py" --super="fpml01/fpml_valuation_reportinglib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-valuation-reporting.xsd
#
...
import fpml01/fpml_valuation_reportinglib as supermod
...
class PositionSub(supermod.Position):
    def __init__(self, id=None, positionId=None, version=None, status=None, creationDate=None, originatingEvent=None, history=None, reportingRoles=None, constituent=None, scheduledDate=None, valuation=None):
        super(PositionSub, self).__init__(id, positionId, version, status, creationDate, originatingEvent, history, reportingRoles, constituent, scheduledDate, valuation, )
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'PortfolioValuationItem'
        rootClass = supermod.PortfolioValuationItem
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_valuation_reportinglib import *\n\n')
        sys.stdout.write('import fpml01/fpml_valuation_reportinglib as model_\n\n')
