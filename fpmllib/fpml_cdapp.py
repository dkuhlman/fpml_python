...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AdditionalFixedPayments'
        rootClass = supermod.AdditionalFixedPayments
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_cdlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_cdlib as model_\n\n')
