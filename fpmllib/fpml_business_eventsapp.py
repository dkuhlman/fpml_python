...
#
# Generated Tue Feb 23 09:00:38 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_business_eventslib.py')
#   ('-s', 'fpml01/fpml_business_eventsapp.py')
#   ('--super', 'fpml01/fpml_business_eventslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-business-events.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_business_eventslib.py" -s "fpml01/fpml_business_eventsapp.py" --super="fpml01/fpml_business_eventslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-business-events.xsd
#
...
import fpml01/fpml_business_eventslib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AbstractEvent'
        rootClass = supermod.AbstractEvent
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_business_eventslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_business_eventslib as model_\n\n')
