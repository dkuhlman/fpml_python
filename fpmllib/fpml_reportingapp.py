...
#
# Generated Tue Feb 23 09:03:44 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_reportinglib.py')
#   ('-s', 'fpml01/fpml_reportingapp.py')
#   ('--super', 'fpml01/fpml_reportinglib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-reporting.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_reportinglib.py" -s "fpml01/fpml_reportingapp.py" --super="fpml01/fpml_reportinglib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-reporting.xsd
#
...
import fpml01/fpml_reportinglib as supermod
...
class AffectedPositionsSub(supermod.AffectedPositions):
    def __init__(self, position=None):
        super(AffectedPositionsSub, self).__init__(position, )
supermod.AffectedPositions.subclass = AffectedPositionsSub
# end class AffectedPositionsSub


class ExposurePartyTypeSub(supermod.ExposurePartyType):
    def __init__(self, partyTypeScheme='http://www.fpml.org/coding-scheme/exposure-party-code', valueOf_=None):
        super(ExposurePartyTypeSub, self).__init__(partyTypeScheme, valueOf_, )
supermod.ExposurePartyType.subclass = ExposurePartyTypeSub
# end class ExposurePartyTypeSub


class ExposureTypeSub(supermod.ExposureType):
    def __init__(self, exposureTypeScheme='http://www.fpml.org/coding-scheme/exposure-type', valueOf_=None):
        super(ExposureTypeSub, self).__init__(exposureTypeScheme, valueOf_, )
supermod.ExposureType.subclass = ExposureTypeSub
# end class ExposureTypeSub


class ExposureUnderlyingAssetSub(supermod.ExposureUnderlyingAsset):
    def __init__(self, description=None, underlyingAsset=None, instrumentId=None):
        super(ExposureUnderlyingAssetSub, self).__init__(description, underlyingAsset, instrumentId, )
supermod.ExposureUnderlyingAsset.subclass = ExposureUnderlyingAssetSub
# end class ExposureUnderlyingAssetSub


class PositionPaymentSub(supermod.PositionPayment):
    def __init__(self, identifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, paymentAmount=None, adjustedPaymentDate=None, calculationDetails=None):
        super(PositionPaymentSub, self).__init__(identifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, paymentAmount, adjustedPaymentDate, calculationDetails, )
supermod.PositionPayment.subclass = PositionPaymentSub
# end class PositionPaymentSub


class PositionUpdateSub(supermod.PositionUpdate):
    def __init__(self, timestamp=None, type_=None, reason=None, position=None):
        super(PositionUpdateSub, self).__init__(timestamp, type_, reason, position, )
supermod.PositionUpdate.subclass = PositionUpdateSub
# end class PositionUpdateSub


class PositionUpdateReasonSub(supermod.PositionUpdateReason):
    def __init__(self, code=None, comment=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, change=None, optionExercise=None, optionExpiry=None, deClear=None, withdrawal=None, additionalEvent=None):
        super(PositionUpdateReasonSub, self).__init__(code, comment, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, change, optionExercise, optionExpiry, deClear, withdrawal, additionalEvent, )
supermod.PositionUpdateReason.subclass = PositionUpdateReasonSub
# end class PositionUpdateReasonSub


class PositionUpdateReasonCodeSub(supermod.PositionUpdateReasonCode):
    def __init__(self, positionUpdateReasonCodeScheme='http://www.fpml.org/coding-scheme/position-update-reason-code', valueOf_=None):
        super(PositionUpdateReasonCodeSub, self).__init__(positionUpdateReasonCodeScheme, valueOf_, )
supermod.PositionUpdateReasonCode.subclass = PositionUpdateReasonCodeSub
# end class PositionUpdateReasonCodeSub


class ReportedExposureSub(supermod.ReportedExposure):
    def __init__(self, region=None, country=None, counterpartyType=None, creditRating=None, partyReference=None, accountReference=None, relatedParty=None, cleared=None, industryClassification=None, category=None, assetClass=None, productType=None, productId=None, currency=None, underlyingAsset=None, relatedAsset=None, exposureType=None, indexTenor=None, sector=None, sectorType=None, seniority=None, restructuring=None, couponRate=None, futuresEquivalentMonth=None, priceReferenceMonth=None, optionType=None, expirationDate=None, quote=None, exposure=None):
        super(ReportedExposureSub, self).__init__(region, country, counterpartyType, creditRating, partyReference, accountReference, relatedParty, cleared, industryClassification, category, assetClass, productType, productId, currency, underlyingAsset, relatedAsset, exposureType, indexTenor, sector, sectorType, seniority, restructuring, couponRate, futuresEquivalentMonth, priceReferenceMonth, optionType, expirationDate, quote, exposure, )
supermod.ReportedExposure.subclass = ReportedExposureSub
# end class ReportedExposureSub


class SectorSub(supermod.Sector):
    def __init__(self, sectorScheme=None, valueOf_=None):
        super(SectorSub, self).__init__(sectorScheme, valueOf_, )
supermod.Sector.subclass = SectorSub
# end class SectorSub


class SectorTypeSub(supermod.SectorType):
    def __init__(self, sectorType=None, valueOf_=None):
        super(SectorTypeSub, self).__init__(sectorType, valueOf_, )
...
class ReportedPositionSub(supermod.ReportedPosition):
    def __init__(self, id=None, positionId=None, version=None, status=None, creationDate=None, originatingEvent=None, history=None, reportingRoles=None, constituent=None, scheduledDate=None, valuation=None, payment=None):
        super(ReportedPositionSub, self).__init__(id, positionId, version, status, creationDate, originatingEvent, history, reportingRoles, constituent, scheduledDate, valuation, payment, )
supermod.ReportedPosition.subclass = ReportedPositionSub
# end class ReportedPositionSub
...
class TerminatingEventsReportSub(supermod.TerminatingEventsReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, reportContents=None, fromDateTime=None, toDateTime=None, optionExpiry=None, tradeMaturity=None, party=None, account=None):
        super(TerminatingEventsReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, reportContents, fromDateTime, toDateTime, optionExpiry, tradeMaturity, party, account, )
supermod.TerminatingEventsReport.subclass = TerminatingEventsReportSub
# end class TerminatingEventsReportSub


class ResetReportSub(supermod.ResetReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, dataSetName=None, reportContents=None, index=None, indexSource=None, rateObservation=None, affectedPositions=None, party=None, account=None):
        super(ResetReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, dataSetName, reportContents, index, indexSource, rateObservation, affectedPositions, party, account, )
supermod.ResetReport.subclass = ResetReportSub
# end class ResetReportSub


class RequestPositionReportSub(supermod.RequestPositionReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, dataSetName=None, requestedPositions=None, reportContents=None, party=None, account=None):
        super(RequestPositionReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, dataSetName, requestedPositions, reportContents, party, account, )
supermod.RequestPositionReport.subclass = RequestPositionReportSub
# end class RequestPositionReportSub


class PositionReportSub(supermod.PositionReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, dataSetName=None, reportContents=None, quotationCharacteristics=None, submissionsComplete=None, position=None, party=None, account=None):
        super(PositionReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, dataSetName, reportContents, quotationCharacteristics, submissionsComplete, position, party, account, )
supermod.PositionReport.subclass = PositionReportSub
# end class PositionReportSub


class PositionActivityReportSub(supermod.PositionActivityReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, dataSetName=None, reportContents=None, quotationCharacteristics=None, fromDateTime=None, toDateTime=None, submissionsComplete=None, positionUpdate=None, party=None, account=None):
        super(PositionActivityReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, dataSetName, reportContents, quotationCharacteristics, fromDateTime, toDateTime, submissionsComplete, positionUpdate, party, account, )
supermod.PositionActivityReport.subclass = PositionActivityReportSub
# end class PositionActivityReportSub


class PartyReportSub(supermod.PartyReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, dataSetName=None, reportContents=None, party=None, account=None):
        super(PartyReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, dataSetName, reportContents, party, account, )
supermod.PartyReport.subclass = PartyReportSub
# end class PartyReportSub


class ExposureReportSub(supermod.ExposureReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, asOfTime=None, dataSetName=None, reportContents=None, quotationCharacteristics=None, exposure=None, party=None, account=None):
        super(ExposureReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, asOfTime, dataSetName, reportContents, quotationCharacteristics, exposure, party, account, )
supermod.ExposureReport.subclass = ExposureReportSub
# end class ExposureReportSub


class EventActivityReportSub(supermod.EventActivityReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, asOfDate=None, dataSetName=None, quotationCharacteristics=None, fromDateTime=None, toDateTime=None, submissionsComplete=None, reportContents=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, change=None, optionExercise=None, optionExpiry=None, deClear=None, withdrawal=None, additionalEvent=None, clearingStatusItem=None, party=None, account=None):
        super(EventActivityReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, asOfDate, dataSetName, quotationCharacteristics, fromDateTime, toDateTime, submissionsComplete, reportContents, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, change, optionExercise, optionExpiry, deClear, withdrawal, additionalEvent, clearingStatusItem, party, account, )
supermod.EventActivityReport.subclass = EventActivityReportSub
# end class EventActivityReportSub


class CollateralAllocationReportSub(supermod.CollateralAllocationReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, serviceName=None, collateralGiverPartyReference=None, collateralAllocation=None, party=None, account=None):
        super(CollateralAllocationReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, serviceName, collateralGiverPartyReference, collateralAllocation, party, account, )
supermod.CollateralAllocationReport.subclass = CollateralAllocationReportSub
# end class CollateralAllocationReportSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AffectedPositions'
        rootClass = supermod.AffectedPositions
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_reportinglib import *\n\n')
        sys.stdout.write('import fpml01/fpml_reportinglib as model_\n\n')
