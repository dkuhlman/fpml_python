...
#
# Generated Tue Feb 23 09:03:05 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_pretrade_processeslib.py')
#   ('-s', 'fpml01/fpml_pretrade_processesapp.py')
#   ('--super', 'fpml01/fpml_pretrade_processeslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-pretrade-processes.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_pretrade_processeslib.py" -s "fpml01/fpml_pretrade_processesapp.py" --super="fpml01/fpml_pretrade_processeslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-pretrade-processes.xsd
#
...
import fpml01/fpml_pretrade_processeslib as supermod
...
class CreditApprovalModelSub(supermod.CreditApprovalModel):
    def __init__(self, creditApprovalModelScheme='http://www.fpml.org/coding-scheme/credit-approval-model', valueOf_=None):
        super(CreditApprovalModelSub, self).__init__(creditApprovalModelScheme, valueOf_, )
supermod.CreditApprovalModel.subclass = CreditApprovalModelSub
# end class CreditApprovalModelSub


class CreditLimitCheckReasonSub(supermod.CreditLimitCheckReason):
    def __init__(self, reasonCode=None, description=None):
        super(CreditLimitCheckReasonSub, self).__init__(reasonCode, description, )
supermod.CreditLimitCheckReason.subclass = CreditLimitCheckReasonSub
# end class CreditLimitCheckReasonSub


class CreditLimitCheckReasonCodeSub(supermod.CreditLimitCheckReasonCode):
    def __init__(self, creditLimitCheckReasonScheme='http://www.fpml.org/coding-scheme/credit-limit-check-reason', valueOf_=None):
        super(CreditLimitCheckReasonCodeSub, self).__init__(creditLimitCheckReasonScheme, valueOf_, )
supermod.CreditLimitCheckReasonCode.subclass = CreditLimitCheckReasonCodeSub
# end class CreditLimitCheckReasonCodeSub


class CreditLimitInformationExtendedSub(supermod.CreditLimitInformationExtended):
    def __init__(self, partyInformation=None, limitModel=None, creditLimit=None):
        super(CreditLimitInformationExtendedSub, self).__init__(partyInformation, limitModel, creditLimit, )
supermod.CreditLimitInformationExtended.subclass = CreditLimitInformationExtendedSub
# end class CreditLimitInformationExtendedSub


class CreditRiskLimitSub(supermod.CreditRiskLimit):
    def __init__(self, fullApproval=None, requestedNotionalAmount=None, approvedNotionalAmount=None, requestedNumberOfOptions=None, approvedNumberOfOptions=None, requestedNumberOfUnits=None, approvedNumberOfUnits=None, reason=None, limitExpiryTimeStamp=None, creditLimitReference=None, originalRequestDetails=None):
        super(CreditRiskLimitSub, self).__init__(fullApproval, requestedNotionalAmount, approvedNotionalAmount, requestedNumberOfOptions, approvedNumberOfOptions, requestedNumberOfUnits, approvedNumberOfUnits, reason, limitExpiryTimeStamp, creditLimitReference, originalRequestDetails, )
supermod.CreditRiskLimit.subclass = CreditRiskLimitSub
# end class CreditRiskLimitSub


class CreditRiskLimitRefusedSub(supermod.CreditRiskLimitRefused):
    def __init__(self, limitRefused=None, reason=None, limitExpiryTimeStamp=None, creditLimitReference=None, originalRequestDetails=None):
        super(CreditRiskLimitRefusedSub, self).__init__(limitRefused, reason, limitExpiryTimeStamp, creditLimitReference, originalRequestDetails, )
supermod.CreditRiskLimitRefused.subclass = CreditRiskLimitRefusedSub
# end class CreditRiskLimitRefusedSub


class OrderFillSub(supermod.OrderFill):
    def __init__(self, orderId=None, fillId=None, size=None, price=None, executionDateTime=None, counterpartyReference=None):
        super(OrderFillSub, self).__init__(orderId, fillId, size, price, executionDateTime, counterpartyReference, )
supermod.OrderFill.subclass = OrderFillSub
# end class OrderFillSub


class OrderStatusSub(supermod.OrderStatus):
    def __init__(self, requesterOrderId=None, orderId=None, submittedTime=None, order=None, status=None, reason=None, counterofferQuote=None, totalSize=None, fills=None, filledSize=None, remainingSize=None, fill=None, trade=None, tradeIdentifier=None, tradePackage=None, creditLimitReference=None):
        super(OrderStatusSub, self).__init__(requesterOrderId, orderId, submittedTime, order, status, reason, counterofferQuote, totalSize, fills, filledSize, remainingSize, fill, trade, tradeIdentifier, tradePackage, creditLimitReference, )
supermod.OrderStatus.subclass = OrderStatusSub
# end class OrderStatusSub


class OriginalRequestDetailsSub(supermod.OriginalRequestDetails):
    def __init__(self, requestingPartyReference=None, creditApprovalRequestType=None, creditApprovalModel=None, originalTrade=None, tradeIdentifier=None, originalPackage=None, packageIdentifier=None):
        super(OriginalRequestDetailsSub, self).__init__(requestingPartyReference, creditApprovalRequestType, creditApprovalModel, originalTrade, tradeIdentifier, originalPackage, packageIdentifier, )
supermod.OriginalRequestDetails.subclass = OriginalRequestDetailsSub
# end class OriginalRequestDetailsSub
...
class CreditLimitSub(supermod.CreditLimit):
    def __init__(self, limitId=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, currency=None, tenor=None, limitApplicable=None, expirationDate=None, extensiontype_=None):
        super(CreditLimitSub, self).__init__(limitId, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, currency, tenor, limitApplicable, expirationDate, extensiontype_, )
...
class CreditLimitExtendedSub(supermod.CreditLimitExtended):
    def __init__(self, limitId=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, currency=None, tenor=None, limitApplicable=None, expirationDate=None, rfqRevalidation=None, orderRevalidation=None):
        super(CreditLimitExtendedSub, self).__init__(limitId, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, currency, tenor, limitApplicable, expirationDate, rfqRevalidation, orderRevalidation, )
supermod.CreditLimitExtended.subclass = CreditLimitExtendedSub
# end class CreditLimitExtendedSub
...
class CorrectableRequestMessage2Sub(supermod.CorrectableRequestMessage2):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, extensiontype_=None):
        super(CorrectableRequestMessage2Sub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, extensiontype_, )
...
class SuspendCreditSub(supermod.SuspendCredit):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, partyReference=None, accountReference=None, creditLimit=None, reason=None, party=None, account=None):
        super(SuspendCreditSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, partyReference, accountReference, creditLimit, reason, party, account, )
supermod.SuspendCredit.subclass = SuspendCreditSub
# end class SuspendCreditSub


class SetCreditLimitSub(supermod.SetCreditLimit):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, creditLimitInformation=None, party=None, account=None):
        super(SetCreditLimitSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, creditLimitInformation, party, account, )
supermod.SetCreditLimit.subclass = SetCreditLimitSub
# end class SetCreditLimitSub


class RestoreCreditSub(supermod.RestoreCredit):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, reason=None, creditLimitInformation=None, party=None, account=None):
        super(RestoreCreditSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, reason, creditLimitInformation, party, account, )
supermod.RestoreCredit.subclass = RestoreCreditSub
# end class RestoreCreditSub


class RequestLimitCheckSub(supermod.RequestLimitCheck):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, requestingPartyReference=None, creditApprovalRequestType=None, creditApprovalModel=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, quote=None, party=None, account=None):
        super(RequestLimitCheckSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, requestingPartyReference, creditApprovalRequestType, creditApprovalModel, tradePackage, originatingEvent, trade, tradingEvent, deClear, quote, party, account, )
supermod.RequestLimitCheck.subclass = RequestLimitCheckSub
# end class RequestLimitCheckSub


class OrderStatusNotificationSub(supermod.OrderStatusNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, orderStatus=None, party=None, account=None):
        super(OrderStatusNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, orderStatus, party, account, )
supermod.OrderStatusNotification.subclass = OrderStatusNotificationSub
# end class OrderStatusNotificationSub


class LimitCheckRefusedSub(supermod.LimitCheckRefused):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, creditRiskLimit=None, party=None, account=None):
        super(LimitCheckRefusedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, creditRiskLimit, party, account, )
supermod.LimitCheckRefused.subclass = LimitCheckRefusedSub
# end class LimitCheckRefusedSub


class LimitCheckApprovedSub(supermod.LimitCheckApproved):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, creditRiskLimit=None, party=None, account=None):
        super(LimitCheckApprovedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, creditRiskLimit, party, account, )
supermod.LimitCheckApproved.subclass = LimitCheckApprovedSub
# end class LimitCheckApprovedSub


class CreditLimitResponseSub(supermod.CreditLimitResponse):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, response=None, reason=None, party=None, account=None):
        super(CreditLimitResponseSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, response, reason, party, account, )
supermod.CreditLimitResponse.subclass = CreditLimitResponseSub
# end class CreditLimitResponseSub


class CreditLimitReportSub(supermod.CreditLimitReport):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, creditLimitInformation=None, party=None, account=None):
        super(CreditLimitReportSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, creditLimitInformation, party, account, )
supermod.CreditLimitReport.subclass = CreditLimitReportSub
# end class CreditLimitReportSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'CreditApprovalModel'
        rootClass = supermod.CreditApprovalModel
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_pretrade_processeslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_pretrade_processeslib as model_\n\n')
