...
#
# Generated Tue Feb 23 09:04:02 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_riskdeflib.py')
#   ('-s', 'fpml01/fpml_riskdefapp.py')
#   ('--super', 'fpml01/fpml_riskdeflib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-riskdef.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_riskdeflib.py" -s "fpml01/fpml_riskdefapp.py" --super="fpml01/fpml_riskdeflib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-riskdef.xsd
#
...
import fpml01/fpml_riskdeflib as supermod
...
class QuotedAssetSetSub(supermod.QuotedAssetSet):
    def __init__(self, instrumentSet=None, assetQuote=None):
        super(QuotedAssetSetSub, self).__init__(instrumentSet, assetQuote, )
...
class PricingStructureValuationSub(supermod.PricingStructureValuation):
    def __init__(self, id=None, definitionRef=None, objectReference=None, valuationScenarioReference=None, baseDate=None, spotDate=None, inputDataDate=None, endDate=None, buildDateTime=None):
        super(PricingStructureValuationSub, self).__init__(id, definitionRef, objectReference, valuationScenarioReference, baseDate, spotDate, inputDataDate, endDate, buildDateTime, )
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AssetOrTermPointOrPricingStructureReference'
        rootClass = supermod.AssetOrTermPointOrPricingStructureReference
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_riskdeflib import *\n\n')
        sys.stdout.write('import fpml01/fpml_riskdeflib as model_\n\n')
