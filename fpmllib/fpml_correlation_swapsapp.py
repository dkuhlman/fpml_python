...
#
# Generated Tue Feb 23 09:01:24 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_correlation_swapslib.py')
#   ('-s', 'fpml01/fpml_correlation_swapsapp.py')
#   ('--super', 'fpml01/fpml_correlation_swapslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-correlation-swaps.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_correlation_swapslib.py" -s "fpml01/fpml_correlation_swapsapp.py" --super="fpml01/fpml_correlation_swapslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-correlation-swaps.xsd
#
...
import fpml01/fpml_correlation_swapslib as supermod
...
class CorrelationSwapSub(supermod.CorrelationSwap):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, additionalPayment=None, extraordinaryEvents=None, correlationLeg=None):
        super(CorrelationSwapSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, additionalPayment, extraordinaryEvents, correlationLeg, )
supermod.CorrelationSwap.subclass = CorrelationSwapSub
# end class CorrelationSwapSub


class CorrelationAmountSub(supermod.CorrelationAmount):
    def __init__(self, calculationDates=None, observationStartDate=None, optionsExchangeDividends=None, additionalDividends=None, allDividends=None, correlation=None):
        super(CorrelationAmountSub, self).__init__(calculationDates, observationStartDate, optionsExchangeDividends, additionalDividends, allDividends, correlation, )
supermod.CorrelationAmount.subclass = CorrelationAmountSub
# end class CorrelationAmountSub
...
class CorrelationLegSub(supermod.CorrelationLeg):
    def __init__(self, id=None, legIdentifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, effectiveDate=None, terminationDate=None, underlyer=None, settlementType=None, settlementDate=None, settlementAmount=None, settlementCurrency=None, fxFeature=None, valuation=None, amount=None):
        super(CorrelationLegSub, self).__init__(id, legIdentifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, effectiveDate, terminationDate, underlyer, settlementType, settlementDate, settlementAmount, settlementCurrency, fxFeature, valuation, amount, )
supermod.CorrelationLeg.subclass = CorrelationLegSub
# end class CorrelationLegSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'CorrelationAmount'
        rootClass = supermod.CorrelationAmount
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_correlation_swapslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_correlation_swapslib as model_\n\n')
