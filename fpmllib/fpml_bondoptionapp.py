...
#
# Generated Tue Feb 23 09:00:31 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_bondoptionlib.py')
#   ('-s', 'fpml01/fpml_bondoptionapp.py')
#   ('--super', 'fpml01/fpml_bondoptionlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-bond-option.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_bondoptionlib.py" -s "fpml01/fpml_bondoptionapp.py" --super="fpml01/fpml_bondoptionlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-bond-option.xsd
#
...
import fpml01/fpml_bondoptionlib as supermod
...
class BondOptionStrikeSub(supermod.BondOptionStrike):
    def __init__(self, referenceSwapCurve=None, price=None):
        super(BondOptionStrikeSub, self).__init__(referenceSwapCurve, price, )
supermod.BondOptionStrike.subclass = BondOptionStrikeSub
# end class BondOptionStrikeSub


class ReferenceSwapCurveSub(supermod.ReferenceSwapCurve):
    def __init__(self, swapUnwindValue=None, makeWholeAmount=None):
        super(ReferenceSwapCurveSub, self).__init__(swapUnwindValue, makeWholeAmount, )
supermod.ReferenceSwapCurve.subclass = ReferenceSwapCurveSub
# end class ReferenceSwapCurveSub


class SwapCurveValuationSub(supermod.SwapCurveValuation):
    def __init__(self, floatingRateIndex=None, indexTenor=None, spread=None, side=None, extensiontype_=None):
        super(SwapCurveValuationSub, self).__init__(floatingRateIndex, indexTenor, spread, side, extensiontype_, )
supermod.SwapCurveValuation.subclass = SwapCurveValuationSub
# end class SwapCurveValuationSub
...
class MakeWholeAmountSub(supermod.MakeWholeAmount):
    def __init__(self, floatingRateIndex=None, indexTenor=None, spread=None, side=None, interpolationMethod=None, earlyCallDate=None):
        super(MakeWholeAmountSub, self).__init__(floatingRateIndex, indexTenor, spread, side, interpolationMethod, earlyCallDate, )
supermod.MakeWholeAmount.subclass = MakeWholeAmountSub
# end class MakeWholeAmountSub
...
class BondOptionSub(supermod.BondOption):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, premium=None, exercise=None, exerciseProcedure=None, feature=None, notionalReference=None, notionalAmount=None, optionEntitlement=None, entitlementCurrency=None, numberOfOptions=None, settlementType=None, settlementDate=None, settlementAmount=None, settlementCurrency=None, strike=None, bond=None, convertibleBond=None):
        super(BondOptionSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, premium, exercise, exerciseProcedure, feature, notionalReference, notionalAmount, optionEntitlement, entitlementCurrency, numberOfOptions, settlementType, settlementDate, settlementAmount, settlementCurrency, strike, bond, convertibleBond, )
supermod.BondOption.subclass = BondOptionSub
# end class BondOptionSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_bondoptionlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_bondoptionlib as model_\n\n')
