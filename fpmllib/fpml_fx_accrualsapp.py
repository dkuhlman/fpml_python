...
#
# Generated Tue Feb 23 09:02:00 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_fx_accrualslib.py')
#   ('-s', 'fpml01/fpml_fx_accrualsapp.py')
#   ('--super', 'fpml01/fpml_fx_accrualslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-fx-accruals.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_fx_accrualslib.py" -s "fpml01/fpml_fx_accrualsapp.py" --super="fpml01/fpml_fx_accrualslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-fx-accruals.xsd
#
...
import fpml01/fpml_fx_accrualslib as supermod
...
class FxAccrualSub(supermod.FxAccrual):
    def __init__(self, id=None, observable=None, accrualRegion=None, fixingSchedule=None):
        super(FxAccrualSub, self).__init__(id, observable, accrualRegion, fixingSchedule, )
supermod.FxAccrual.subclass = FxAccrualSub
# end class FxAccrualSub


class FxAccrualLeverageSub(supermod.FxAccrualLeverage):
    def __init__(self, id=None, condition=None, level=None, quoteBasis=None, strikeReference=None, averageStrikeReference=None, triggerReference=None, ratio=None, notionalAmount=None, counterCurrencyAmount=None):
        super(FxAccrualLeverageSub, self).__init__(id, condition, level, quoteBasis, strikeReference, averageStrikeReference, triggerReference, ratio, notionalAmount, counterCurrencyAmount, )
supermod.FxAccrualLeverage.subclass = FxAccrualLeverageSub
# end class FxAccrualLeverageSub


class FxAccrualPayoffRegionSub(supermod.FxAccrualPayoffRegion):
    def __init__(self, id=None, extensiontype_=None):
        super(FxAccrualPayoffRegionSub, self).__init__(id, extensiontype_, )
supermod.FxAccrualPayoffRegion.subclass = FxAccrualPayoffRegionSub
# end class FxAccrualPayoffRegionSub


class FxAccrualSettlementPeriodPayoffSub(supermod.FxAccrualSettlementPeriodPayoff):
    def __init__(self, payoffRegionReference=None, strike=None, counterCurrencyAmount=None, averageStrikeFixingDates=None, averageRateFixingDates=None, lowerBound=None, upperBound=None, leverage=None, payoffCap=None):
        super(FxAccrualSettlementPeriodPayoffSub, self).__init__(payoffRegionReference, strike, counterCurrencyAmount, averageStrikeFixingDates, averageRateFixingDates, lowerBound, upperBound, leverage, payoffCap, )
supermod.FxAccrualSettlementPeriodPayoff.subclass = FxAccrualSettlementPeriodPayoffSub
# end class FxAccrualSettlementPeriodPayoffSub


class FxAccrualSettlementPeriodScheduleSub(supermod.FxAccrualSettlementPeriodSchedule):
    def __init__(self, settlementPeriod=None):
        super(FxAccrualSettlementPeriodScheduleSub, self).__init__(settlementPeriod, )
supermod.FxAccrualSettlementPeriodSchedule.subclass = FxAccrualSettlementPeriodScheduleSub
# end class FxAccrualSettlementPeriodScheduleSub


class FxAccrualRegionSub(supermod.FxAccrualRegion):
    def __init__(self, observableReference=None, upperBound=None, lowerBound=None, startDate=None, endDate=None, accrualFactor=None, notionalAmount=None, counterCurrencyAmount=None):
        super(FxAccrualRegionSub, self).__init__(observableReference, upperBound, lowerBound, startDate, endDate, accrualFactor, notionalAmount, counterCurrencyAmount, )
supermod.FxAccrualRegion.subclass = FxAccrualRegionSub
# end class FxAccrualRegionSub


class FxAccrualRegionLowerBoundSub(supermod.FxAccrualRegionLowerBound):
    def __init__(self, condition=None, level=None, quoteBasis=None, strikeReference=None, averageStrikeReference=None, triggerReference=None):
        super(FxAccrualRegionLowerBoundSub, self).__init__(condition, level, quoteBasis, strikeReference, averageStrikeReference, triggerReference, )
supermod.FxAccrualRegionLowerBound.subclass = FxAccrualRegionLowerBoundSub
# end class FxAccrualRegionLowerBoundSub


class FxAccrualRegionUpperBoundSub(supermod.FxAccrualRegionUpperBound):
    def __init__(self, condition=None, level=None, quoteBasis=None, strikeReference=None, averageStrikeReference=None, triggerReference=None):
        super(FxAccrualRegionUpperBoundSub, self).__init__(condition, level, quoteBasis, strikeReference, averageStrikeReference, triggerReference, )
supermod.FxAccrualRegionUpperBound.subclass = FxAccrualRegionUpperBoundSub
# end class FxAccrualRegionUpperBoundSub


class FxAdjustedDateAndDateAdjustmentsSub(supermod.FxAdjustedDateAndDateAdjustments):
    def __init__(self, dateAdjustments=None, adjustedDate=None, extensiontype_=None):
        super(FxAdjustedDateAndDateAdjustmentsSub, self).__init__(dateAdjustments, adjustedDate, extensiontype_, )
supermod.FxAdjustedDateAndDateAdjustments.subclass = FxAdjustedDateAndDateAdjustmentsSub
# end class FxAdjustedDateAndDateAdjustmentsSub


class FxCrossRateObservableSub(supermod.FxCrossRateObservable):
    def __init__(self, quotedCurrencyPair=None, informationSource=None):
        super(FxCrossRateObservableSub, self).__init__(quotedCurrencyPair, informationSource, )
supermod.FxCrossRateObservable.subclass = FxCrossRateObservableSub
# end class FxCrossRateObservableSub


class FxExpiryDateSub(supermod.FxExpiryDate):
    def __init__(self, dateAdjustments=None, adjustedDate=None, expiryTime=None):
        super(FxExpiryDateSub, self).__init__(dateAdjustments, adjustedDate, expiryTime, )
supermod.FxExpiryDate.subclass = FxExpiryDateSub
# end class FxExpiryDateSub


class FxFixingObservationSub(supermod.FxFixingObservation):
    def __init__(self, date=None, weight=None):
        super(FxFixingObservationSub, self).__init__(date, weight, )
supermod.FxFixingObservation.subclass = FxFixingObservationSub
# end class FxFixingObservationSub


class FxFixingScheduleSub(supermod.FxFixingSchedule):
    def __init__(self, dateAdjustments=None, fixingDate=None, startDate=None, endDate=None, observationFrequency=None, dayType=None, businessCentersReference=None, businessCenters=None, numberOfFixings=None):
        super(FxFixingScheduleSub, self).__init__(dateAdjustments, fixingDate, startDate, endDate, observationFrequency, dayType, businessCentersReference, businessCenters, numberOfFixings, )
supermod.FxFixingSchedule.subclass = FxFixingScheduleSub
# end class FxFixingScheduleSub


class FxRateObservableSub(supermod.FxRateObservable):
    def __init__(self, id=None, quotedCurrencyPair=None, informationSource=None, crossRate=None, extensiontype_=None):
        super(FxRateObservableSub, self).__init__(id, quotedCurrencyPair, informationSource, crossRate, extensiontype_, )
supermod.FxRateObservable.subclass = FxRateObservableSub
# end class FxRateObservableSub


class FxWeightedFixingScheduleSub(supermod.FxWeightedFixingSchedule):
    def __init__(self, dateAdjustments=None, fixing=None, startDate=None, endDate=None, observationFrequency=None, dayType=None, businessCentersReference=None, businessCenters=None, numberOfFixings=None):
        super(FxWeightedFixingScheduleSub, self).__init__(dateAdjustments, fixing, startDate, endDate, observationFrequency, dayType, businessCentersReference, businessCenters, numberOfFixings, )
supermod.FxWeightedFixingSchedule.subclass = FxWeightedFixingScheduleSub
# end class FxWeightedFixingScheduleSub


class FxComplexBarrierBaseSub(supermod.FxComplexBarrierBase):
    def __init__(self, id=None, barrierType=None, style=None, scope=None, condition=None, triggerRate=None, observationStartDate=None, observationStartTime=None, observationEndDate=None, observationEndTime=None, extensiontype_=None):
        super(FxComplexBarrierBaseSub, self).__init__(id, barrierType, style, scope, condition, triggerRate, observationStartDate, observationStartTime, observationEndDate, observationEndTime, extensiontype_, )
supermod.FxComplexBarrierBase.subclass = FxComplexBarrierBaseSub
# end class FxComplexBarrierBaseSub


class FxDateOffsetSub(supermod.FxDateOffset):
    def __init__(self, convention=None, offset=None, relativeTo=None):
        super(FxDateOffsetSub, self).__init__(convention, offset, relativeTo, )
supermod.FxDateOffset.subclass = FxDateOffsetSub
# end class FxDateOffsetSub


class FxExchangedCurrencySub(supermod.FxExchangedCurrency):
    def __init__(self, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, currency=None):
        super(FxExchangedCurrencySub, self).__init__(payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, currency, )
supermod.FxExchangedCurrency.subclass = FxExchangedCurrencySub
# end class FxExchangedCurrencySub


class FxKnockoutCountSub(supermod.FxKnockoutCount):
    def __init__(self, conditionalFixings=None, settlementAtKnockout=None):
        super(FxKnockoutCountSub, self).__init__(conditionalFixings, settlementAtKnockout, )
supermod.FxKnockoutCount.subclass = FxKnockoutCountSub
# end class FxKnockoutCountSub


class FxKnockoutLevelSub(supermod.FxKnockoutLevel):
    def __init__(self, amount=None, intrinsicValue=None, targetStyle=None, settlementAdjustmentStyle=None):
        super(FxKnockoutLevelSub, self).__init__(amount, intrinsicValue, targetStyle, settlementAdjustmentStyle, )
supermod.FxKnockoutLevel.subclass = FxKnockoutLevelSub
# end class FxKnockoutLevelSub


class FxOutstandingGainSub(supermod.FxOutstandingGain):
    def __init__(self, targetReference=None, settlementAdjustmentStyle=None):
        super(FxOutstandingGainSub, self).__init__(targetReference, settlementAdjustmentStyle, )
supermod.FxOutstandingGain.subclass = FxOutstandingGainSub
# end class FxOutstandingGainSub


class FxPayoffCapSub(supermod.FxPayoffCap):
    def __init__(self, condition=None, rate=None, settlementAdjustmentStyle=None):
        super(FxPayoffCapSub, self).__init__(condition, rate, settlementAdjustmentStyle, )
supermod.FxPayoffCap.subclass = FxPayoffCapSub
# end class FxPayoffCapSub


class FxScheduleSub(supermod.FxSchedule):
    def __init__(self, id=None, dateAdjustments=None, adjustedDate=None, startDate=None, endDate=None, observationFrequency=None, dayType=None, businessCentersReference=None, businessCenters=None, dateOffset=None, extensiontype_=None):
        super(FxScheduleSub, self).__init__(id, dateAdjustments, adjustedDate, startDate, endDate, observationFrequency, dayType, businessCentersReference, businessCenters, dateOffset, extensiontype_, )
supermod.FxSchedule.subclass = FxScheduleSub
# end class FxScheduleSub


class FxSettlementPeriodBarrierSub(supermod.FxSettlementPeriodBarrier):
    def __init__(self, barrierReference=None, triggerRate=None):
        super(FxSettlementPeriodBarrierSub, self).__init__(barrierReference, triggerRate, )
supermod.FxSettlementPeriodBarrier.subclass = FxSettlementPeriodBarrierSub
# end class FxSettlementPeriodBarrierSub


class FxSettlementScheduleSub(supermod.FxSettlementSchedule):
    def __init__(self, id=None, dateAdjustments=None, adjustedDate=None, startDate=None, endDate=None, observationFrequency=None, dayType=None, businessCentersReference=None, businessCenters=None, dateOffset=None, finalSettlementDate=None):
        super(FxSettlementScheduleSub, self).__init__(id, dateAdjustments, adjustedDate, startDate, endDate, observationFrequency, dayType, businessCentersReference, businessCenters, dateOffset, finalSettlementDate, )
supermod.FxSettlementSchedule.subclass = FxSettlementScheduleSub
# end class FxSettlementScheduleSub


class FxTargetSub(supermod.FxTarget):
    def __init__(self, id=None, accumulationRegion=None, knockoutLevel=None, knockoutCount=None):
        super(FxTargetSub, self).__init__(id, accumulationRegion, knockoutLevel, knockoutCount, )
supermod.FxTarget.subclass = FxTargetSub
# end class FxTargetSub


class FxTargetAccumulationRegionSub(supermod.FxTargetAccumulationRegion):
    def __init__(self, upperBound=None, lowerBound=None, multiplier=None):
        super(FxTargetAccumulationRegionSub, self).__init__(upperBound, lowerBound, multiplier, )
supermod.FxTargetAccumulationRegion.subclass = FxTargetAccumulationRegionSub
# end class FxTargetAccumulationRegionSub


class FxTargetBarrierSub(supermod.FxTargetBarrier):
    def __init__(self, id=None, barrierType=None, style=None, scope=None, condition=None, triggerRate=None, observationStartDate=None, observationStartTime=None, observationEndDate=None, observationEndTime=None, rebate=None):
        super(FxTargetBarrierSub, self).__init__(id, barrierType, style, scope, condition, triggerRate, observationStartDate, observationStartTime, observationEndDate, observationEndTime, rebate, )
supermod.FxTargetBarrier.subclass = FxTargetBarrierSub
# end class FxTargetBarrierSub


class FxTargetConstantPayoffSub(supermod.FxTargetConstantPayoff):
    def __init__(self, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, payment=None, fixingAdjustment=None):
        super(FxTargetConstantPayoffSub, self).__init__(payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, payment, fixingAdjustment, )
supermod.FxTargetConstantPayoff.subclass = FxTargetConstantPayoffSub
# end class FxTargetConstantPayoffSub


class FxTargetLeverageSub(supermod.FxTargetLeverage):
    def __init__(self, id=None, condition=None, level=None, strikeReference=None, pivotReference=None, barrierReference=None, levelReference=None, ratio=None, notionalAmount=None, counterCurrencyAmount=None):
        super(FxTargetLeverageSub, self).__init__(id, condition, level, strikeReference, pivotReference, barrierReference, levelReference, ratio, notionalAmount, counterCurrencyAmount, )
supermod.FxTargetLeverage.subclass = FxTargetLeverageSub
# end class FxTargetLeverageSub


class FxTargetPayoffRegionSub(supermod.FxTargetPayoffRegion):
    def __init__(self, id=None, extensiontype_=None):
        super(FxTargetPayoffRegionSub, self).__init__(id, extensiontype_, )
supermod.FxTargetPayoffRegion.subclass = FxTargetPayoffRegionSub
# end class FxTargetPayoffRegionSub


class FxTargetRebateSub(supermod.FxTargetRebate):
    def __init__(self, payment=None, outstandingGain=None):
        super(FxTargetRebateSub, self).__init__(payment, outstandingGain, )
supermod.FxTargetRebate.subclass = FxTargetRebateSub
# end class FxTargetRebateSub


class FxTargetRegionLowerBoundSub(supermod.FxTargetRegionLowerBound):
    def __init__(self, condition=None, level=None, strikeReference=None, pivotReference=None, barrierReference=None, levelReference=None):
        super(FxTargetRegionLowerBoundSub, self).__init__(condition, level, strikeReference, pivotReference, barrierReference, levelReference, )
supermod.FxTargetRegionLowerBound.subclass = FxTargetRegionLowerBoundSub
# end class FxTargetRegionLowerBoundSub


class FxTargetRegionUpperBoundSub(supermod.FxTargetRegionUpperBound):
    def __init__(self, condition=None, level=None, strikeReference=None, pivotReference=None, barrierReference=None, levelReference=None):
        super(FxTargetRegionUpperBoundSub, self).__init__(condition, level, strikeReference, pivotReference, barrierReference, levelReference, )
supermod.FxTargetRegionUpperBound.subclass = FxTargetRegionUpperBoundSub
# end class FxTargetRegionUpperBoundSub


class FxTargetSettlementPeriodPayoffSub(supermod.FxTargetSettlementPeriodPayoff):
    def __init__(self, payoffRegionReference=None, strike=None, counterCurrencyAmount=None, lowerBound=None, upperBound=None, leverage=None, payoffCap=None):
        super(FxTargetSettlementPeriodPayoffSub, self).__init__(payoffRegionReference, strike, counterCurrencyAmount, lowerBound, upperBound, leverage, payoffCap, )
supermod.FxTargetSettlementPeriodPayoff.subclass = FxTargetSettlementPeriodPayoffSub
# end class FxTargetSettlementPeriodPayoffSub


class FxTargetSettlementPeriodScheduleSub(supermod.FxTargetSettlementPeriodSchedule):
    def __init__(self, settlementPeriod=None):
        super(FxTargetSettlementPeriodScheduleSub, self).__init__(settlementPeriod, )
supermod.FxTargetSettlementPeriodSchedule.subclass = FxTargetSettlementPeriodScheduleSub
# end class FxTargetSettlementPeriodScheduleSub


class FxTargetPhysicalSettlementSub(supermod.FxTargetPhysicalSettlement):
    def __init__(self, exchangedCurrency1=None, exchangedCurrency2=None, settlementAdjustmentStyle=None, strike=None, strikeReference=None):
        super(FxTargetPhysicalSettlementSub, self).__init__(exchangedCurrency1, exchangedCurrency2, settlementAdjustmentStyle, strike, strikeReference, )
supermod.FxTargetPhysicalSettlement.subclass = FxTargetPhysicalSettlementSub
# end class FxTargetPhysicalSettlementSub


class SettlementPeriodSub(supermod.SettlementPeriod):
    def __init__(self, expiryDate=None, settlementDate=None, notionalAmount=None, extensiontype_=None):
        super(SettlementPeriodSub, self).__init__(expiryDate, settlementDate, notionalAmount, extensiontype_, )
supermod.SettlementPeriod.subclass = SettlementPeriodSub
# end class SettlementPeriodSub


class SettlementPeriodFixingDatesSub(supermod.SettlementPeriodFixingDates):
    def __init__(self, fixingDate=None, startDate=None, endDate=None, numberOfFixings=None):
        super(SettlementPeriodFixingDatesSub, self).__init__(fixingDate, startDate, endDate, numberOfFixings, )
supermod.SettlementPeriodFixingDates.subclass = SettlementPeriodFixingDatesSub
# end class SettlementPeriodFixingDatesSub


class SettlementPeriodLeverageSub(supermod.SettlementPeriodLeverage):
    def __init__(self, ratio=None, notionalAmount=None, counterCurrencyAmount=None):
        super(SettlementPeriodLeverageSub, self).__init__(ratio, notionalAmount, counterCurrencyAmount, )
supermod.SettlementPeriodLeverage.subclass = SettlementPeriodLeverageSub
# end class SettlementPeriodLeverageSub
...
class NonNegativeAmountScheduleSub(supermod.NonNegativeAmountSchedule):
    def __init__(self, id=None, initialValue=None, step=None, currency=None, extensiontype_=None):
        super(NonNegativeAmountScheduleSub, self).__init__(id, initialValue, step, currency, extensiontype_, )
...
class FxTargetReferenceSub(supermod.FxTargetReference):
    def __init__(self, href=None):
        super(FxTargetReferenceSub, self).__init__(href, )
supermod.FxTargetReference.subclass = FxTargetReferenceSub
# end class FxTargetReferenceSub


class FxTargetSettlementPeriodSub(supermod.FxTargetSettlementPeriod):
    def __init__(self, expiryDate=None, settlementDate=None, notionalAmount=None, pivot=None, payoff=None, barrier=None):
        super(FxTargetSettlementPeriodSub, self).__init__(expiryDate, settlementDate, notionalAmount, pivot, payoff, barrier, )
supermod.FxTargetSettlementPeriod.subclass = FxTargetSettlementPeriodSub
# end class FxTargetSettlementPeriodSub


class FxTargetPayoffRegionReferenceSub(supermod.FxTargetPayoffRegionReference):
    def __init__(self, href=None):
        super(FxTargetPayoffRegionReferenceSub, self).__init__(href, )
supermod.FxTargetPayoffRegionReference.subclass = FxTargetPayoffRegionReferenceSub
# end class FxTargetPayoffRegionReferenceSub


class FxTargetLinearPayoffRegionSub(supermod.FxTargetLinearPayoffRegion):
    def __init__(self, id=None, exchangedCurrency1=None, exchangedCurrency2=None, strike=None, counterCurrencyAmount=None, lowerBound=None, upperBound=None, leverage=None, payoffCap=None):
        super(FxTargetLinearPayoffRegionSub, self).__init__(id, exchangedCurrency1, exchangedCurrency2, strike, counterCurrencyAmount, lowerBound, upperBound, leverage, payoffCap, )
supermod.FxTargetLinearPayoffRegion.subclass = FxTargetLinearPayoffRegionSub
# end class FxTargetLinearPayoffRegionSub


class FxTargetKnockoutForwardSub(supermod.FxTargetKnockoutForward):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, quotedCurrencyPair=None, notionalAmount=None, target=None, expirySchedule=None, settlementSchedule=None, fixingInformationSource=None, spotRate=None, pivot=None, constantPayoffRegion=None, linearPayoffRegion=None, barrier=None, additionalPayment=None, cashSettlement=None, settlementPeriodSchedule=None):
        super(FxTargetKnockoutForwardSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, quotedCurrencyPair, notionalAmount, target, expirySchedule, settlementSchedule, fixingInformationSource, spotRate, pivot, constantPayoffRegion, linearPayoffRegion, barrier, additionalPayment, cashSettlement, settlementPeriodSchedule, )
supermod.FxTargetKnockoutForward.subclass = FxTargetKnockoutForwardSub
# end class FxTargetKnockoutForwardSub


class FxTargetConstantPayoffRegionSub(supermod.FxTargetConstantPayoffRegion):
    def __init__(self, id=None, upperBound=None, lowerBound=None, payoff=None, physicalSettlement=None):
        super(FxTargetConstantPayoffRegionSub, self).__init__(id, upperBound, lowerBound, payoff, physicalSettlement, )
supermod.FxTargetConstantPayoffRegion.subclass = FxTargetConstantPayoffRegionSub
# end class FxTargetConstantPayoffRegionSub


class FxStrikeReferenceSub(supermod.FxStrikeReference):
    def __init__(self, href=None):
        super(FxStrikeReferenceSub, self).__init__(href, )
supermod.FxStrikeReference.subclass = FxStrikeReferenceSub
# end class FxStrikeReferenceSub


class FxStrikeSub(supermod.FxStrike):
    def __init__(self, id=None, initialValue=None, step=None):
        super(FxStrikeSub, self).__init__(id, initialValue, step, )
supermod.FxStrike.subclass = FxStrikeSub
# end class FxStrikeSub


class FxScheduleReferenceSub(supermod.FxScheduleReference):
    def __init__(self, href=None):
        super(FxScheduleReferenceSub, self).__init__(href, )
supermod.FxScheduleReference.subclass = FxScheduleReferenceSub
# end class FxScheduleReferenceSub


class FxPivotReferenceSub(supermod.FxPivotReference):
    def __init__(self, href=None):
        super(FxPivotReferenceSub, self).__init__(href, )
supermod.FxPivotReference.subclass = FxPivotReferenceSub
# end class FxPivotReferenceSub


class FxPivotSub(supermod.FxPivot):
    def __init__(self, id=None, initialValue=None, step=None):
        super(FxPivotSub, self).__init__(id, initialValue, step, )
supermod.FxPivot.subclass = FxPivotSub
# end class FxPivotSub


class FxLevelReferenceSub(supermod.FxLevelReference):
    def __init__(self, href=None):
        super(FxLevelReferenceSub, self).__init__(href, )
supermod.FxLevelReference.subclass = FxLevelReferenceSub
# end class FxLevelReferenceSub


class FxLevelSub(supermod.FxLevel):
    def __init__(self, id=None, initialValue=None, step=None):
        super(FxLevelSub, self).__init__(id, initialValue, step, )
supermod.FxLevel.subclass = FxLevelSub
# end class FxLevelSub


class FxExpiryScheduleSub(supermod.FxExpirySchedule):
    def __init__(self, id=None, dateAdjustments=None, adjustedDate=None, startDate=None, endDate=None, observationFrequency=None, dayType=None, businessCentersReference=None, businessCenters=None, dateOffset=None, finalExpiryDate=None, expiryTime=None):
        super(FxExpiryScheduleSub, self).__init__(id, dateAdjustments, adjustedDate, startDate, endDate, observationFrequency, dayType, businessCentersReference, businessCenters, dateOffset, finalExpiryDate, expiryTime, )
supermod.FxExpirySchedule.subclass = FxExpiryScheduleSub
# end class FxExpiryScheduleSub


class FxCounterCurrencyAmountSub(supermod.FxCounterCurrencyAmount):
    def __init__(self, id=None, initialValue=None, step=None, currency=None, strikeReference=None):
        super(FxCounterCurrencyAmountSub, self).__init__(id, initialValue, step, currency, strikeReference, )
supermod.FxCounterCurrencyAmount.subclass = FxCounterCurrencyAmountSub
# end class FxCounterCurrencyAmountSub


class FxComplexBarrierBaseReferenceSub(supermod.FxComplexBarrierBaseReference):
    def __init__(self, href=None):
        super(FxComplexBarrierBaseReferenceSub, self).__init__(href, )
supermod.FxComplexBarrierBaseReference.subclass = FxComplexBarrierBaseReferenceSub
# end class FxComplexBarrierBaseReferenceSub


class FxRateObservableReferenceSub(supermod.FxRateObservableReference):
    def __init__(self, href=None):
        super(FxRateObservableReferenceSub, self).__init__(href, )
supermod.FxRateObservableReference.subclass = FxRateObservableReferenceSub
# end class FxRateObservableReferenceSub


class FxRangeAccrualSub(supermod.FxRangeAccrual):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, notionalAmount=None, accrual=None, expiryDate=None, expirySchedule=None, settlementDate=None, settlementSchedule=None, barrier=None, premium=None):
        super(FxRangeAccrualSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, notionalAmount, accrual, expiryDate, expirySchedule, settlementDate, settlementSchedule, barrier, premium, )
supermod.FxRangeAccrual.subclass = FxRangeAccrualSub
# end class FxRangeAccrualSub


class FxAveragingProcessSub(supermod.FxAveragingProcess):
    def __init__(self, id=None, quotedCurrencyPair=None, informationSource=None, crossRate=None, fixingSchedule=None, averagingMethod=None, precision=None, extensiontype_=None):
        super(FxAveragingProcessSub, self).__init__(id, quotedCurrencyPair, informationSource, crossRate, fixingSchedule, averagingMethod, precision, extensiontype_, )
supermod.FxAveragingProcess.subclass = FxAveragingProcessSub
# end class FxAveragingProcessSub


class FxAverageStrikeSub(supermod.FxAverageStrike):
    def __init__(self, id=None, quotedCurrencyPair=None, informationSource=None, crossRate=None, fixingSchedule=None, averagingMethod=None, precision=None, strikeAdjustment=None):
        super(FxAverageStrikeSub, self).__init__(id, quotedCurrencyPair, informationSource, crossRate, fixingSchedule, averagingMethod, precision, strikeAdjustment, )
supermod.FxAverageStrike.subclass = FxAverageStrikeSub
# end class FxAverageStrikeSub


class FxAverageRateSub(supermod.FxAverageRate):
    def __init__(self, id=None, quotedCurrencyPair=None, informationSource=None, crossRate=None, fixingSchedule=None, averagingMethod=None, precision=None):
        super(FxAverageRateSub, self).__init__(id, quotedCurrencyPair, informationSource, crossRate, fixingSchedule, averagingMethod, precision, )
supermod.FxAverageRate.subclass = FxAverageRateSub
# end class FxAverageRateSub


class FxAccrualTriggerReferenceSub(supermod.FxAccrualTriggerReference):
    def __init__(self, href=None):
        super(FxAccrualTriggerReferenceSub, self).__init__(href, )
supermod.FxAccrualTriggerReference.subclass = FxAccrualTriggerReferenceSub
# end class FxAccrualTriggerReferenceSub


class FxAccrualTriggerSub(supermod.FxAccrualTrigger):
    def __init__(self, triggerCondition=None, quotedCurrencyPair=None, triggerRate=None, spotRate=None, id=None, informationSource=None):
        super(FxAccrualTriggerSub, self).__init__(triggerCondition, quotedCurrencyPair, triggerRate, spotRate, id, informationSource, )
supermod.FxAccrualTrigger.subclass = FxAccrualTriggerSub
# end class FxAccrualTriggerSub


class FxAccrualStrikeReferenceSub(supermod.FxAccrualStrikeReference):
    def __init__(self, href=None):
        super(FxAccrualStrikeReferenceSub, self).__init__(href, )
supermod.FxAccrualStrikeReference.subclass = FxAccrualStrikeReferenceSub
# end class FxAccrualStrikeReferenceSub


class FxAccrualStrikeSub(supermod.FxAccrualStrike):
    def __init__(self, id=None, initialValue=None, step=None, extensiontype_=None):
        super(FxAccrualStrikeSub, self).__init__(id, initialValue, step, extensiontype_, )
supermod.FxAccrualStrike.subclass = FxAccrualStrikeSub
# end class FxAccrualStrikeSub


class FxAccrualSettlementPeriodSub(supermod.FxAccrualSettlementPeriod):
    def __init__(self, expiryDate=None, settlementDate=None, notionalAmount=None, payoff=None, accrualFactor=None, barrier=None, accrualFixingDates=None):
        super(FxAccrualSettlementPeriodSub, self).__init__(expiryDate, settlementDate, notionalAmount, payoff, accrualFactor, barrier, accrualFixingDates, )
supermod.FxAccrualSettlementPeriod.subclass = FxAccrualSettlementPeriodSub
# end class FxAccrualSettlementPeriodSub


class FxAccrualPayoffRegionReferenceSub(supermod.FxAccrualPayoffRegionReference):
    def __init__(self, href=None):
        super(FxAccrualPayoffRegionReferenceSub, self).__init__(href, )
supermod.FxAccrualPayoffRegionReference.subclass = FxAccrualPayoffRegionReferenceSub
# end class FxAccrualPayoffRegionReferenceSub


class FxAccrualOptionSub(supermod.FxAccrualOption):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, putCurrency=None, callCurrency=None, notionalAmount=None, accrual=None, expiryDate=None, expirySchedule=None, settlementDate=None, settlementSchedule=None, exerciseProcedure=None, spotRate=None, strike=None, counterCurrencyAmount=None, averageStrike=None, averageRate=None, barrier=None, premium=None):
        super(FxAccrualOptionSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, putCurrency, callCurrency, notionalAmount, accrual, expiryDate, expirySchedule, settlementDate, settlementSchedule, exerciseProcedure, spotRate, strike, counterCurrencyAmount, averageStrike, averageRate, barrier, premium, )
supermod.FxAccrualOption.subclass = FxAccrualOptionSub
# end class FxAccrualOptionSub


class FxAccrualLinearPayoffRegionSub(supermod.FxAccrualLinearPayoffRegion):
    def __init__(self, id=None, exchangedCurrency1=None, exchangedCurrency2=None, strike=None, counterCurrencyAmount=None, averageStrike=None, upperBound=None, lowerBound=None, leverage=None, payoffCap=None):
        super(FxAccrualLinearPayoffRegionSub, self).__init__(id, exchangedCurrency1, exchangedCurrency2, strike, counterCurrencyAmount, averageStrike, upperBound, lowerBound, leverage, payoffCap, )
supermod.FxAccrualLinearPayoffRegion.subclass = FxAccrualLinearPayoffRegionSub
# end class FxAccrualLinearPayoffRegionSub


class FxAccrualForwardSub(supermod.FxAccrualForward):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, notionalAmount=None, accrual=None, expiryDate=None, expirySchedule=None, settlementDate=None, settlementSchedule=None, spotRate=None, linearPayoffRegion=None, averageRate=None, barrier=None, additionalPayment=None, cashSettlement=None, settlementPeriodSchedule=None):
        super(FxAccrualForwardSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, notionalAmount, accrual, expiryDate, expirySchedule, settlementDate, settlementSchedule, spotRate, linearPayoffRegion, averageRate, barrier, additionalPayment, cashSettlement, settlementPeriodSchedule, )
supermod.FxAccrualForward.subclass = FxAccrualForwardSub
# end class FxAccrualForwardSub


class FxAccrualDigitalOptionSub(supermod.FxAccrualDigitalOption):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, notionalAmount=None, accrual=None, expiryDate=None, expirySchedule=None, settlementDate=None, settlementSchedule=None, exerciseProcedure=None, trigger=None, barrier=None, premium=None):
        super(FxAccrualDigitalOptionSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, notionalAmount, accrual, expiryDate, expirySchedule, settlementDate, settlementSchedule, exerciseProcedure, trigger, barrier, premium, )
supermod.FxAccrualDigitalOption.subclass = FxAccrualDigitalOptionSub
# end class FxAccrualDigitalOptionSub


class FxAccrualBarrierSub(supermod.FxAccrualBarrier):
    def __init__(self, id=None, barrierType=None, style=None, scope=None, condition=None, triggerRate=None, observationStartDate=None, observationStartTime=None, observationEndDate=None, observationEndTime=None, accrualRetention=None, observableReference=None, quotedCurrencyPair=None, informationSource=None):
        super(FxAccrualBarrierSub, self).__init__(id, barrierType, style, scope, condition, triggerRate, observationStartDate, observationStartTime, observationEndDate, observationEndTime, accrualRetention, observableReference, quotedCurrencyPair, informationSource, )
supermod.FxAccrualBarrier.subclass = FxAccrualBarrierSub
# end class FxAccrualBarrierSub


class FxAccrualAverageStrikeReferenceSub(supermod.FxAccrualAverageStrikeReference):
    def __init__(self, href=None):
        super(FxAccrualAverageStrikeReferenceSub, self).__init__(href, )
supermod.FxAccrualAverageStrikeReference.subclass = FxAccrualAverageStrikeReferenceSub
# end class FxAccrualAverageStrikeReferenceSub
...
class FxOptionStrikePriceSub(supermod.FxOptionStrikePrice):
    def __init__(self, id=None, initialValue=None, step=None, strikeQuoteBasis=None):
        super(FxOptionStrikePriceSub, self).__init__(id, initialValue, step, strikeQuoteBasis, )
supermod.FxOptionStrikePrice.subclass = FxOptionStrikePriceSub
# end class FxOptionStrikePriceSub


class FxForwardStrikePriceSub(supermod.FxForwardStrikePrice):
    def __init__(self, id=None, initialValue=None, step=None, quoteBasis=None):
        super(FxForwardStrikePriceSub, self).__init__(id, initialValue, step, quoteBasis, )
supermod.FxForwardStrikePrice.subclass = FxForwardStrikePriceSub
# end class FxForwardStrikePriceSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_fx_accrualslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_fx_accrualslib as model_\n\n')
