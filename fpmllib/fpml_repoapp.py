...
#
# Generated Tue Feb 23 09:03:52 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_repolib.py')
#   ('-s', 'fpml01/fpml_repoapp.py')
#   ('--super', 'fpml01/fpml_repolib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-repo.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_repolib.py" -s "fpml01/fpml_repoapp.py" --super="fpml01/fpml_repolib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-repo.xsd
#
...
import fpml01/fpml_repolib as supermod
...
class CollateralProfileSub(supermod.CollateralProfile):
    def __init__(self, collateralProfileScheme=None, valueOf_=None):
        super(CollateralProfileSub, self).__init__(collateralProfileScheme, valueOf_, )
supermod.CollateralProfile.subclass = CollateralProfileSub
# end class CollateralProfileSub


class CollateralTypeSub(supermod.CollateralType):
    def __init__(self, collateralTypeScheme=None, valueOf_=None):
        super(CollateralTypeSub, self).__init__(collateralTypeScheme, valueOf_, )
supermod.CollateralType.subclass = CollateralTypeSub
# end class CollateralTypeSub


class CollateralValuationSub(supermod.CollateralValuation):
    def __init__(self, nominalAmount=None, cleanPrice=None, accruals=None, dirtyPrice=None, relativePrice=None, yieldToMaturity=None, inflationFactor=None, allInPrice=None, accrualsAmount=None, numberOfUnits=None, unitPrice=None, assetReference=None):
        super(CollateralValuationSub, self).__init__(nominalAmount, cleanPrice, accruals, dirtyPrice, relativePrice, yieldToMaturity, inflationFactor, allInPrice, accrualsAmount, numberOfUnits, unitPrice, assetReference, )
supermod.CollateralValuation.subclass = CollateralValuationSub
# end class CollateralValuationSub


class DeliveryMethodSub(supermod.DeliveryMethod):
    def __init__(self, deliveryMethodScheme='http://www.fpml.org/coding-scheme/delivery-method', valueOf_=None):
        super(DeliveryMethodSub, self).__init__(deliveryMethodScheme, valueOf_, )
supermod.DeliveryMethod.subclass = DeliveryMethodSub
# end class DeliveryMethodSub


class InitialMarginSub(supermod.InitialMargin):
    def __init__(self, marginType=None, margin=None, marginThreshold=None, minimumTransferAmount=None):
        super(InitialMarginSub, self).__init__(marginType, margin, marginThreshold, minimumTransferAmount, )
supermod.InitialMargin.subclass = InitialMarginSub
# end class InitialMarginSub


class InitialMarginCalculationSub(supermod.InitialMarginCalculation):
    def __init__(self, marginRatio=None, marginRatioThreshold=None, haircut=None, haircutThreshold=None, assetReference=None):
        super(InitialMarginCalculationSub, self).__init__(marginRatio, marginRatioThreshold, haircut, haircutThreshold, assetReference, )
supermod.InitialMarginCalculation.subclass = InitialMarginCalculationSub
# end class InitialMarginCalculationSub


class PartyNoticePeriodSub(supermod.PartyNoticePeriod):
    def __init__(self, partyReference=None, noticePeriod=None):
        super(PartyNoticePeriodSub, self).__init__(partyReference, noticePeriod, )
supermod.PartyNoticePeriod.subclass = PartyNoticePeriodSub
# end class PartyNoticePeriodSub


class RelativePriceSub(supermod.RelativePrice):
    def __init__(self, spread=None, bond=None, convertibleBond=None, equity=None):
        super(RelativePriceSub, self).__init__(spread, bond, convertibleBond, equity, )
supermod.RelativePrice.subclass = RelativePriceSub
# end class RelativePriceSub


class TriPartySub(supermod.TriParty):
    def __init__(self, triPartyAgent=None, collateralProfile=None, collateralType=None):
        super(TriPartySub, self).__init__(triPartyAgent, collateralProfile, collateralType, )
supermod.TriParty.subclass = TriPartySub
# end class TriPartySub
...
class RepoLegBaseSub(supermod.RepoLegBase):
    def __init__(self, id=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, settlementDate=None, extensiontype_=None):
        super(RepoLegBaseSub, self).__init__(id, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, settlementDate, extensiontype_, )
supermod.RepoLegBase.subclass = RepoLegBaseSub
# end class RepoLegBaseSub


class RepoFarLegSub(supermod.RepoFarLeg):
    def __init__(self, id=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, settlementDate=None, settlementAmount=None, settlementCurrency=None, fxRate=None, deliveryMethod=None, deliveryDate=None, collateral=None, repoInterest=None):
        super(RepoFarLegSub, self).__init__(id, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, settlementDate, settlementAmount, settlementCurrency, fxRate, deliveryMethod, deliveryDate, collateral, repoInterest, )
supermod.RepoFarLeg.subclass = RepoFarLegSub
# end class RepoFarLegSub


class RepoSub(supermod.Repo):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, fixedRateSchedule=None, floatingRateCalculation=None, dayCountFraction=None, duration=None, callingParty=None, callDate=None, noticePeriod=None, partyNoticePeriod=None, initialMargin=None, nearLeg=None, farLeg=None, bond=None, convertibleBond=None, equity=None, triParty=None):
        super(RepoSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, fixedRateSchedule, floatingRateCalculation, dayCountFraction, duration, callingParty, callDate, noticePeriod, partyNoticePeriod, initialMargin, nearLeg, farLeg, bond, convertibleBond, equity, triParty, )
supermod.Repo.subclass = RepoSub
# end class RepoSub


class AdjustableOffsetSub(supermod.AdjustableOffset):
    def __init__(self, id=None, periodMultiplier=None, period=None, dayType=None, businessCentersReference=None, businessCenters=None):
        super(AdjustableOffsetSub, self).__init__(id, periodMultiplier, period, dayType, businessCentersReference, businessCenters, )
supermod.AdjustableOffset.subclass = AdjustableOffsetSub
# end class AdjustableOffsetSub
...
class RepoNearLegSub(supermod.RepoNearLeg):
    def __init__(self, id=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, settlementDate=None, settlementAmount=None, fxRate=None, deliveryMethod=None, deliveryDate=None, collateral=None):
        super(RepoNearLegSub, self).__init__(id, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, settlementDate, settlementAmount, fxRate, deliveryMethod, deliveryDate, collateral, )
supermod.RepoNearLeg.subclass = RepoNearLegSub
# end class RepoNearLegSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AdjustableOffset'
        rootClass = supermod.AdjustableOffset
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_repolib import *\n\n')
        sys.stdout.write('import fpml01/fpml_repolib as model_\n\n')
