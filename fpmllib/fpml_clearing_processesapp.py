...
#
# Generated Tue Feb 23 09:00:50 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_clearing_processeslib.py')
#   ('-s', 'fpml01/fpml_clearing_processesapp.py')
#   ('--super', 'fpml01/fpml_clearing_processeslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-clearing-processes.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_clearing_processeslib.py" -s "fpml01/fpml_clearing_processesapp.py" --super="fpml01/fpml_clearing_processeslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-clearing-processes.xsd
#
...
import fpml01/fpml_clearing_processeslib as supermod
...
class ClearingRequirementsSub(supermod.ClearingRequirements):
    def __init__(self, supervisoryBody=None, mandatorilyClearable=None, reason=None):
        super(ClearingRequirementsSub, self).__init__(supervisoryBody, mandatorilyClearable, reason, )
supermod.ClearingRequirements.subclass = ClearingRequirementsSub
# end class ClearingRequirementsSub


class MarginsSub(supermod.Margins):
    def __init__(self, margin=None):
        super(MarginsSub, self).__init__(margin, )
supermod.Margins.subclass = MarginsSub
# end class MarginsSub


class MarketDataSub(supermod.MarketData):
    def __init__(self, fxRate=None):
        super(MarketDataSub, self).__init__(fxRate, )
supermod.MarketData.subclass = MarketDataSub
# end class MarketDataSub


class MarginQuoteSub(supermod.MarginQuote):
    def __init__(self, valueDate=None, valueTime=None, tradeIdentifier=None, valuations=None, margins=None, marketData=None):
        super(MarginQuoteSub, self).__init__(valueDate, valueTime, tradeIdentifier, valuations, margins, marketData, )
supermod.MarginQuote.subclass = MarginQuoteSub
# end class MarginQuoteSub


class MarginQuoteTypeSub(supermod.MarginQuoteType):
    def __init__(self, marginQuoteTypeScheme='http://www.fpml.org/coding-scheme/margin-quote-type', valueOf_=None):
        super(MarginQuoteTypeSub, self).__init__(marginQuoteTypeScheme, valueOf_, )
supermod.MarginQuoteType.subclass = MarginQuoteTypeSub
# end class MarginQuoteTypeSub


class ValuationsBasicQuotationSub(supermod.ValuationsBasicQuotation):
    def __init__(self, valuation=None):
        super(ValuationsBasicQuotationSub, self).__init__(valuation, )
supermod.ValuationsBasicQuotation.subclass = ValuationsBasicQuotationSub
# end class ValuationsBasicQuotationSub
...
class RequestMarginQuoteSub(supermod.RequestMarginQuote):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, portfolioReference=None, marginQuoteType=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, party=None, account=None):
        super(RequestMarginQuoteSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, portfolioReference, marginQuoteType, tradePackage, originatingEvent, trade, tradingEvent, deClear, party, account, )
supermod.RequestMarginQuote.subclass = RequestMarginQuoteSub
# end class RequestMarginQuoteSub


class RequestClearingEligibilitySub(supermod.RequestClearingEligibility):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, requestingPartyReference=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, party=None, account=None):
        super(RequestClearingEligibilitySub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, requestingPartyReference, tradePackage, originatingEvent, trade, tradingEvent, deClear, party, account, )
supermod.RequestClearingEligibility.subclass = RequestClearingEligibilitySub
# end class RequestClearingEligibilitySub


class MarginQuoteRefusedSub(supermod.MarginQuoteRefused):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, quote=None, party=None, account=None, reason=None):
        super(MarginQuoteRefusedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, deClear, quote, party, account, reason, )
supermod.MarginQuoteRefused.subclass = MarginQuoteRefusedSub
# end class MarginQuoteRefusedSub


class MarginQuoteConfirmedSub(supermod.MarginQuoteConfirmed):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, partyTradeIdentifier=None, marginQuote=None, party=None, account=None):
        super(MarginQuoteConfirmedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, deClear, partyTradeIdentifier, marginQuote, party, account, )
supermod.MarginQuoteConfirmed.subclass = MarginQuoteConfirmedSub
# end class MarginQuoteConfirmedSub


class MarginQuoteAcknowledgementSub(supermod.MarginQuoteAcknowledgement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, originalMessage=None, tradeReferenceInformation=None, party=None, account=None):
        super(MarginQuoteAcknowledgementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, originalMessage, tradeReferenceInformation, party, account, )
supermod.MarginQuoteAcknowledgement.subclass = MarginQuoteAcknowledgementSub
# end class MarginQuoteAcknowledgementSub


class ClearingEligibilitySub(supermod.ClearingEligibility):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, partyTradeIdentifier=None, eligibleForClearing=None, clearingRequirements=None, party=None, account=None):
        super(ClearingEligibilitySub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, deClear, partyTradeIdentifier, eligibleForClearing, clearingRequirements, party, account, )
supermod.ClearingEligibility.subclass = ClearingEligibilitySub
# end class ClearingEligibilitySub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ClearingEligibility'
        rootClass = supermod.ClearingEligibility
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_clearing_processeslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_clearing_processeslib as model_\n\n')
