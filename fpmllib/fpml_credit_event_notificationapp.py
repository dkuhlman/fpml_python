...
#
# Generated Tue Feb 23 09:01:30 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_credit_event_notificationlib.py')
#   ('-s', 'fpml01/fpml_credit_event_notificationapp.py')
#   ('--super', 'fpml01/fpml_credit_event_notificationlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-credit-event-notification.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_credit_event_notificationlib.py" -s "fpml01/fpml_credit_event_notificationapp.py" --super="fpml01/fpml_credit_event_notificationlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-credit-event-notification.xsd
#
...
import fpml01/fpml_credit_event_notificationlib as supermod
...
class AffectedTransactionsSub(supermod.AffectedTransactions):
    def __init__(self, trade=None, tradeReference=None):
        super(AffectedTransactionsSub, self).__init__(trade, tradeReference, )
supermod.AffectedTransactions.subclass = AffectedTransactionsSub
# end class AffectedTransactionsSub


class CreditEventSub(supermod.CreditEvent):
    def __init__(self, extensiontype_=None):
        super(CreditEventSub, self).__init__(extensiontype_, )
supermod.CreditEvent.subclass = CreditEventSub
# end class CreditEventSub


class CreditEventNoticeDocumentSub(supermod.CreditEventNoticeDocument):
    def __init__(self, affectedTransactions=None, referenceEntity=None, creditEvent=None, publiclyAvailableInformation=None, notifyingPartyReference=None, notifiedPartyReference=None, creditEventNoticeDate=None, creditEventDate=None):
        super(CreditEventNoticeDocumentSub, self).__init__(affectedTransactions, referenceEntity, creditEvent, publiclyAvailableInformation, notifyingPartyReference, notifiedPartyReference, creditEventNoticeDate, creditEventDate, )
supermod.CreditEventNoticeDocument.subclass = CreditEventNoticeDocumentSub
# end class CreditEventNoticeDocumentSub


class FailureToPayEventSub(supermod.FailureToPayEvent):
    def __init__(self):
        super(FailureToPayEventSub, self).__init__()
supermod.FailureToPayEvent.subclass = FailureToPayEventSub
# end class FailureToPayEventSub


class ObligationAccelerationEventSub(supermod.ObligationAccelerationEvent):
    def __init__(self):
        super(ObligationAccelerationEventSub, self).__init__()
supermod.ObligationAccelerationEvent.subclass = ObligationAccelerationEventSub
# end class ObligationAccelerationEventSub


class ObligationDefaultEventSub(supermod.ObligationDefaultEvent):
    def __init__(self):
        super(ObligationDefaultEventSub, self).__init__()
supermod.ObligationDefaultEvent.subclass = ObligationDefaultEventSub
# end class ObligationDefaultEventSub


class RepudiationMoratoriumEventSub(supermod.RepudiationMoratoriumEvent):
    def __init__(self):
        super(RepudiationMoratoriumEventSub, self).__init__()
supermod.RepudiationMoratoriumEvent.subclass = RepudiationMoratoriumEventSub
# end class RepudiationMoratoriumEventSub


class RestructuringEventSub(supermod.RestructuringEvent):
    def __init__(self, partialExerciseAmount=None):
        super(RestructuringEventSub, self).__init__(partialExerciseAmount, )
supermod.RestructuringEvent.subclass = RestructuringEventSub
# end class RestructuringEventSub
...
class BankruptcyEventSub(supermod.BankruptcyEvent):
    def __init__(self):
        super(BankruptcyEventSub, self).__init__()
supermod.BankruptcyEvent.subclass = BankruptcyEventSub
# end class BankruptcyEventSub
...
class CreditEventNotificationRetractedSub(supermod.CreditEventNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, creditEventNotice=None, party=None):
        super(CreditEventNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, creditEventNotice, party, )
supermod.CreditEventNotificationRetracted.subclass = CreditEventNotificationRetractedSub
# end class CreditEventNotificationRetractedSub


class CreditEventNotificationSub(supermod.CreditEventNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, creditEventNotice=None, party=None):
        super(CreditEventNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, creditEventNotice, party, )
supermod.CreditEventNotification.subclass = CreditEventNotificationSub
# end class CreditEventNotificationSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AffectedTransactions'
        rootClass = supermod.AffectedTransactions
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_credit_event_notificationlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_credit_event_notificationlib as model_\n\n')
