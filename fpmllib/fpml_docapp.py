...
#
# Generated Tue Feb 23 09:01:41 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_doclib.py')
#   ('-s', 'fpml01/fpml_docapp.py')
#   ('--super', 'fpml01/fpml_doclib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-doc.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_doclib.py" -s "fpml01/fpml_docapp.py" --super="fpml01/fpml_doclib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-doc.xsd
#
...
import fpml01/fpml_doclib as supermod
...
class DocumentSub(supermod.Document):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None):
        super(DocumentSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, )
...
class PortfolioSub(supermod.Portfolio):
    def __init__(self, id=None, partyPortfolioName=None, tradeId=None, partyTradeIdentifier=None, portfolio=None):
        super(PortfolioSub, self).__init__(id, partyPortfolioName, tradeId, partyTradeIdentifier, portfolio, )
...
class TradeIdentifierSub(supermod.TradeIdentifier):
    def __init__(self, id=None, issuer=None, tradeId=None, partyReference=None, accountReference=None, reportingRole=None, versionedTradeId=None):
        super(TradeIdentifierSub, self).__init__(id, issuer, tradeId, partyReference, accountReference, reportingRole, versionedTradeId, )
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_doclib import *\n\n')
        sys.stdout.write('import fpml01/fpml_doclib as model_\n\n')
