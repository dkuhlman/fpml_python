...
#
# Generated Tue Feb 23 09:01:49 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_eqdlib.py')
#   ('-s', 'fpml01/fpml_eqdapp.py')
#   ('--super', 'fpml01/fpml_eqdlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-eqd.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_eqdlib.py" -s "fpml01/fpml_eqdapp.py" --super="fpml01/fpml_eqdlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-eqd.xsd
#
...
import fpml01/fpml_eqdlib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'BrokerEquityOption'
        rootClass = supermod.BrokerEquityOption
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_eqdlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_eqdlib as model_\n\n')
