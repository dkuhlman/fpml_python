...
#
# Generated Tue Feb 23 09:04:09 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_standardlib.py')
#   ('-s', 'fpml01/fpml_standardapp.py')
#   ('--super', 'fpml01/fpml_standardlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-standard.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_standardlib.py" -s "fpml01/fpml_standardapp.py" --super="fpml01/fpml_standardlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-standard.xsd
#
...
import fpml01/fpml_standardlib as supermod
...
class StandardProductSub(supermod.StandardProduct):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, notional=None, quote=None):
        super(StandardProductSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, notional, quote, )
supermod.StandardProduct.subclass = StandardProductSub
# end class StandardProductSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'StandardProduct'
        rootClass = supermod.StandardProduct
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_standardlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_standardlib as model_\n\n')
