...
#
# Generated Tue Feb 23 09:02:32 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_legallib.py')
#   ('-s', 'fpml01/fpml_legalapp.py')
#   ('--super', 'fpml01/fpml_legallib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-legal.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_legallib.py" -s "fpml01/fpml_legalapp.py" --super="fpml01/fpml_legallib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-legal.xsd
#
...
import fpml01/fpml_legallib as supermod
...
class ContractualDocumentSub(supermod.ContractualDocument):
    def __init__(self, id=None, documentType=None):
        super(ContractualDocumentSub, self).__init__(id, documentType, )
...
class LegalDocumentIdentitySub(supermod.LegalDocumentIdentity):
    def __init__(self, id=None, partyReference=None, documentType=None, agreementDate=None, partyDocumentIdentifier=None):
        super(LegalDocumentIdentitySub, self).__init__(id, partyReference, documentType, agreementDate, partyDocumentIdentifier, )
...
class StandardCreditSupportAnnexBaseSub(supermod.StandardCreditSupportAnnexBase):
    def __init__(self, id=None, documentType=None, independentAmounts=None, baseCurrency=None, existingCreditSupportAnnex=None, settlementDay=None):
        super(StandardCreditSupportAnnexBaseSub, self).__init__(id, documentType, independentAmounts, baseCurrency, existingCreditSupportAnnex, settlementDay, )
...
class currencySpecificDayCountType1Sub(supermod.currencySpecificDayCountType1):
    def __init__(self, dayCountValue=None, currency=None):
        super(currencySpecificDayCountType1Sub, self).__init__(dayCountValue, currency, )
supermod.currencySpecificDayCountType1.subclass = currencySpecificDayCountType1Sub
# end class currencySpecificDayCountType1Sub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ContractualDocument'
        rootClass = supermod.ContractualDocument
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_legallib import *\n\n')
        sys.stdout.write('import fpml01/fpml_legallib as model_\n\n')
