...
#
# Generated Tue Feb 23 09:01:53 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_eq_sharedlib.py')
#   ('-s', 'fpml01/fpml_eq_sharedapp.py')
#   ('--super', 'fpml01/fpml_eq_sharedlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-eq-shared.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_eq_sharedlib.py" -s "fpml01/fpml_eq_sharedapp.py" --super="fpml01/fpml_eq_sharedlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-eq-shared.xsd
#
...
import fpml01/fpml_eq_sharedlib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AdditionalDisruptionEvents'
        rootClass = supermod.AdditionalDisruptionEvents
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_eq_sharedlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_eq_sharedlib as model_\n\n')
