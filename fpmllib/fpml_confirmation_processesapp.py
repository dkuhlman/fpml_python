...
#
# Generated Tue Feb 23 09:01:19 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_confirmation_processeslib.py')
#   ('-s', 'fpml01/fpml_confirmation_processesapp.py')
#   ('--super', 'fpml01/fpml_confirmation_processeslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-confirmation-processes.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_confirmation_processeslib.py" -s "fpml01/fpml_confirmation_processesapp.py" --super="fpml01/fpml_confirmation_processeslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-confirmation-processes.xsd
#
...
import fpml01/fpml_confirmation_processeslib as supermod
...
class ClearingSub(supermod.Clearing):
    def __init__(self, submitted=None, cleared=None):
        super(ClearingSub, self).__init__(submitted, cleared, )
supermod.Clearing.subclass = ClearingSub
# end class ClearingSub


class TradeWrapperSub(supermod.TradeWrapper):
    def __init__(self, originatingEvent=None, trade=None, tradeReferenceInformation=None, tradePackage=None):
        super(TradeWrapperSub, self).__init__(originatingEvent, trade, tradeReferenceInformation, tradePackage, )
supermod.TradeWrapper.subclass = TradeWrapperSub
# end class TradeWrapperSub


class RequestedCollateralAllocationActionSub(supermod.RequestedCollateralAllocationAction):
    def __init__(self, requestedCollateralAllocationActionScheme='http://www.fpml.org/coding-scheme/requested-collateral-allocation-action', valueOf_=None):
        super(RequestedCollateralAllocationActionSub, self).__init__(requestedCollateralAllocationActionScheme, valueOf_, )
supermod.RequestedCollateralAllocationAction.subclass = RequestedCollateralAllocationActionSub
# end class RequestedCollateralAllocationActionSub
...
class CollateralAllocationAcceptedSub(supermod.CollateralAllocationAccepted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None):
        super(CollateralAllocationAcceptedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, )
supermod.CollateralAllocationAccepted.subclass = CollateralAllocationAcceptedSub
# end class CollateralAllocationAcceptedSub


class RequestCollateralAllocationSub(supermod.RequestCollateralAllocation):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, serviceName=None, requestedAction=None, collateralGiverPartyReference=None, collateralAllocation=None, party=None, account=None):
        super(RequestCollateralAllocationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, serviceName, requestedAction, collateralGiverPartyReference, collateralAllocation, party, account, )
supermod.RequestCollateralAllocation.subclass = RequestCollateralAllocationSub
# end class RequestCollateralAllocationSub


class TradeChangeAdviceRetractedSub(supermod.TradeChangeAdviceRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradeIdentifier=None, change=None, paymentDetails=None, party=None, account=None):
        super(TradeChangeAdviceRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradeIdentifier, change, paymentDetails, party, account, )
supermod.TradeChangeAdviceRetracted.subclass = TradeChangeAdviceRetractedSub
# end class TradeChangeAdviceRetractedSub


class TradeChangeAdviceSub(supermod.TradeChangeAdvice):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, change=None, quote=None, paymentDetails=None, party=None, account=None):
        super(TradeChangeAdviceSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, change, quote, paymentDetails, party, account, )
supermod.TradeChangeAdvice.subclass = TradeChangeAdviceSub
# end class TradeChangeAdviceSub


class RequestTradeReferenceInformationUpdateRetractedSub(supermod.RequestTradeReferenceInformationUpdateRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradeReferenceInformation=None, party=None, account=None):
        super(RequestTradeReferenceInformationUpdateRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradeReferenceInformation, party, account, )
supermod.RequestTradeReferenceInformationUpdateRetracted.subclass = RequestTradeReferenceInformationUpdateRetractedSub
# end class RequestTradeReferenceInformationUpdateRetractedSub


class RequestTradeReferenceInformationUpdateSub(supermod.RequestTradeReferenceInformationUpdate):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradeReferenceInformation=None, party=None, account=None):
        super(RequestTradeReferenceInformationUpdateSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradeReferenceInformation, party, account, )
supermod.RequestTradeReferenceInformationUpdate.subclass = RequestTradeReferenceInformationUpdateSub
# end class RequestTradeReferenceInformationUpdateSub


class RequestExecutionRetractedSub(supermod.RequestExecutionRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, optionExercise=None, party=None, account=None):
        super(RequestExecutionRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, optionExercise, party, account, )
supermod.RequestExecutionRetracted.subclass = RequestExecutionRetractedSub
# end class RequestExecutionRetractedSub


class RequestExecutionSub(supermod.RequestExecution):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, optionExercise=None, party=None, account=None):
        super(RequestExecutionSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, optionExercise, party, account, )
supermod.RequestExecution.subclass = RequestExecutionSub
# end class RequestExecutionSub


class RequestConsentRetractedSub(supermod.RequestConsentRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, type_=None, approver=None, approvingPartyReference=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, deClear=None, party=None, account=None):
        super(RequestConsentRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, type_, approver, approvingPartyReference, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, deClear, party, account, )
supermod.RequestConsentRetracted.subclass = RequestConsentRetractedSub
# end class RequestConsentRetractedSub


class RequestConsentSub(supermod.RequestConsent):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, requestedAction=None, type_=None, approver=None, approvingPartyReference=None, portfolioReference=None, compressionActivity=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, deClear=None, quote=None, party=None, account=None):
        super(RequestConsentSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, requestedAction, type_, approver, approvingPartyReference, portfolioReference, compressionActivity, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, deClear, quote, party, account, )
supermod.RequestConsent.subclass = RequestConsentSub
# end class RequestConsentSub


class RequestConfirmationSub(supermod.RequestConfirmation):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, optionExercise=None, withdrawal=None, party=None, account=None):
        super(RequestConfirmationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, optionExercise, withdrawal, party, account, )
supermod.RequestConfirmation.subclass = RequestConfirmationSub
# end class RequestConfirmationSub


class RequestClearingRetractedSub(supermod.RequestClearingRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, party=None, account=None):
        super(RequestClearingRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, deClear, party, account, )
supermod.RequestClearingRetracted.subclass = RequestClearingRetractedSub
# end class RequestClearingRetractedSub


class RequestClearingSub(supermod.RequestClearing):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, portfolioReference=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, deClear=None, quote=None, party=None, account=None):
        super(RequestClearingSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, portfolioReference, tradePackage, originatingEvent, trade, tradingEvent, deClear, quote, party, account, )
supermod.RequestClearing.subclass = RequestClearingSub
# end class RequestClearingSub


class RequestAllocationRetractedSub(supermod.RequestAllocationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, blockTradeIdentifier=None, allocations=None, party=None, account=None):
        super(RequestAllocationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, blockTradeIdentifier, allocations, party, account, )
supermod.RequestAllocationRetracted.subclass = RequestAllocationRetractedSub
# end class RequestAllocationRetractedSub


class RequestAllocationSub(supermod.RequestAllocation):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, relatedParty=None, blockTradeIdentifier=None, allocations=None, party=None, account=None):
        super(RequestAllocationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, relatedParty, blockTradeIdentifier, allocations, party, account, )
supermod.RequestAllocation.subclass = RequestAllocationSub
# end class RequestAllocationSub


class MaturityNotificationSub(supermod.MaturityNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, optionExpiry=None, tradeMaturity=None, party=None, account=None):
        super(MaturityNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, optionExpiry, tradeMaturity, party, account, )
supermod.MaturityNotification.subclass = MaturityNotificationSub
# end class MaturityNotificationSub


class ExecutionRetractedSub(supermod.ExecutionRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, optionExercise=None, party=None, account=None):
        super(ExecutionRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, optionExercise, party, account, )
supermod.ExecutionRetracted.subclass = ExecutionRetractedSub
# end class ExecutionRetractedSub


class ExecutionNotificationSub(supermod.ExecutionNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, optionExercise=None, optionExpiry=None, optionEvent=None, quote=None, party=None, account=None):
        super(ExecutionNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, optionExercise, optionExpiry, optionEvent, quote, party, account, )
supermod.ExecutionNotification.subclass = ExecutionNotificationSub
# end class ExecutionNotificationSub


class ExecutionAdviceRetractedSub(supermod.ExecutionAdviceRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, change=None, optionExercise=None, optionExpiry=None, optionEvent=None, paymentDetails=None, party=None, account=None):
        super(ExecutionAdviceRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, change, optionExercise, optionExpiry, optionEvent, paymentDetails, party, account, )
supermod.ExecutionAdviceRetracted.subclass = ExecutionAdviceRetractedSub
# end class ExecutionAdviceRetractedSub


class ExecutionAdviceSub(supermod.ExecutionAdvice):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, productType=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, change=None, optionExercise=None, optionExpiry=None, optionEvent=None, quote=None, paymentDetails=None, party=None, account=None):
        super(ExecutionAdviceSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, productType, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, change, optionExercise, optionExpiry, optionEvent, quote, paymentDetails, party, account, )
supermod.ExecutionAdvice.subclass = ExecutionAdviceSub
# end class ExecutionAdviceSub


class EventRequestAcknowledgementSub(supermod.EventRequestAcknowledgement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, originalMessage=None, tradeReferenceInformation=None, party=None, account=None):
        super(EventRequestAcknowledgementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, originalMessage, tradeReferenceInformation, party, account, )
supermod.EventRequestAcknowledgement.subclass = EventRequestAcknowledgementSub
# end class EventRequestAcknowledgementSub


class ConsentRefusedSub(supermod.ConsentRefused):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, type_=None, approver=None, approvingPartyReference=None, portfolioReference=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, tradeReferenceInformation=None, creditLimitInformation=None, party=None, account=None, reason=None):
        super(ConsentRefusedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, type_, approver, approvingPartyReference, portfolioReference, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, tradeReferenceInformation, creditLimitInformation, party, account, reason, )
supermod.ConsentRefused.subclass = ConsentRefusedSub
# end class ConsentRefusedSub


class ConsentGrantedSub(supermod.ConsentGranted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, type_=None, approver=None, approvingPartyReference=None, approvalId=None, portfolioReference=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, tradeReferenceInformation=None, creditLimitInformation=None, party=None, account=None):
        super(ConsentGrantedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, type_, approver, approvingPartyReference, approvalId, portfolioReference, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, tradeReferenceInformation, creditLimitInformation, party, account, )
supermod.ConsentGranted.subclass = ConsentGrantedSub
# end class ConsentGrantedSub


class ConfirmationStatusSub(supermod.ConfirmationStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, status=None, assertedEvent=None, proposedMatch=None, allegedEvent=None, party=None, account=None):
        super(ConfirmationStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, status, assertedEvent, proposedMatch, allegedEvent, party, account, )
supermod.ConfirmationStatus.subclass = ConfirmationStatusSub
# end class ConfirmationStatusSub


class ConfirmationRetractedSub(supermod.ConfirmationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, optionExercise=None, withdrawal=None, party=None, account=None):
        super(ConfirmationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, optionExercise, withdrawal, party, account, )
supermod.ConfirmationRetracted.subclass = ConfirmationRetractedSub
# end class ConfirmationRetractedSub


class ConfirmationDisputedSub(supermod.ConfirmationDisputed):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, change=None, optionExercise=None, optionExpiry=None, optionEvent=None, withdrawal=None, party=None, account=None, reason=None):
        super(ConfirmationDisputedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, change, optionExercise, optionExpiry, optionEvent, withdrawal, party, account, reason, )
supermod.ConfirmationDisputed.subclass = ConfirmationDisputedSub
# end class ConfirmationDisputedSub


class ConfirmationAgreedSub(supermod.ConfirmationAgreed):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, amendment=None, increase=None, terminatingEvent=None, termination=None, novation=None, change=None, optionExercise=None, optionExpiry=None, optionEvent=None, withdrawal=None, party=None, account=None):
        super(ConfirmationAgreedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, amendment, increase, terminatingEvent, termination, novation, change, optionExercise, optionExpiry, optionEvent, withdrawal, party, account, )
supermod.ConfirmationAgreed.subclass = ConfirmationAgreedSub
# end class ConfirmationAgreedSub


class ClearingStatusSub(supermod.ClearingStatus):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, clearingStatusItem=None, party=None, account=None):
        super(ClearingStatusSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, clearingStatusItem, party, account, )
supermod.ClearingStatus.subclass = ClearingStatusSub
# end class ClearingStatusSub


class ClearingRefusedSub(supermod.ClearingRefused):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, quote=None, party=None, account=None, reason=None):
        super(ClearingRefusedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, tradePackage, originatingEvent, trade, tradingEvent, quote, party, account, reason, )
supermod.ClearingRefused.subclass = ClearingRefusedSub
# end class ClearingRefusedSub


class ClearingConfirmedSub(supermod.ClearingConfirmed):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, compressionActivity=None, portfolioReference=None, tradePackage=None, originatingEvent=None, trade=None, tradingEvent=None, terminatingEvent=None, termination=None, deClear=None, clearing=None, quote=None, creditLimitInformation=None, party=None, account=None):
        super(ClearingConfirmedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, compressionActivity, portfolioReference, tradePackage, originatingEvent, trade, tradingEvent, terminatingEvent, termination, deClear, clearing, quote, creditLimitInformation, party, account, )
supermod.ClearingConfirmed.subclass = ClearingConfirmedSub
# end class ClearingConfirmedSub


class ApprovalStatusNotificationSub(supermod.ApprovalStatusNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, trade=None, tradeIdentifier=None, approvals=None, party=None, account=None):
        super(ApprovalStatusNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, trade, tradeIdentifier, approvals, party, account, )
supermod.ApprovalStatusNotification.subclass = ApprovalStatusNotificationSub
# end class ApprovalStatusNotificationSub


class AllocationRefusedSub(supermod.AllocationRefused):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, blockTradeIdentifier=None, allocations=None, party=None, account=None, reason=None):
        super(AllocationRefusedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, blockTradeIdentifier, allocations, party, account, reason, )
supermod.AllocationRefused.subclass = AllocationRefusedSub
# end class AllocationRefusedSub


class AllocationApprovedSub(supermod.AllocationApproved):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, blockTradeIdentifier=None, allocations=None, party=None, account=None):
        super(AllocationApprovedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, blockTradeIdentifier, allocations, party, account, )
supermod.AllocationApproved.subclass = AllocationApprovedSub
# end class AllocationApprovedSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AllocationApproved'
        rootClass = supermod.AllocationApproved
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_confirmation_processeslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_confirmation_processeslib as model_\n\n')
