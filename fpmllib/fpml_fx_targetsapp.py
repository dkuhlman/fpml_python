...
#
# Generated Tue Feb 23 09:02:06 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_fx_targetslib.py')
#   ('-s', 'fpml01/fpml_fx_targetsapp.py')
#   ('--super', 'fpml01/fpml_fx_targetslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-fx-targets.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_fx_targetslib.py" -s "fpml01/fpml_fx_targetsapp.py" --super="fpml01/fpml_fx_targetslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-fx-targets.xsd
#
...
import fpml01/fpml_fx_targetslib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'FxComplexBarrierBase'
        rootClass = supermod.FxComplexBarrierBase
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_fx_targetslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_fx_targetslib as model_\n\n')
