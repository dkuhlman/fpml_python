...
#
# Generated Tue Feb 23 09:03:57 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_return_swapslib.py')
#   ('-s', 'fpml01/fpml_return_swapsapp.py')
#   ('--super', 'fpml01/fpml_return_swapslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-return-swaps.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_return_swapslib.py" -s "fpml01/fpml_return_swapsapp.py" --super="fpml01/fpml_return_swapslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-return-swaps.xsd
#
...
import fpml01/fpml_return_swapslib as supermod
...
class EquitySwapTransactionSupplementSub(supermod.EquitySwapTransactionSupplement):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, returnSwapLeg=None, principalExchangeFeatures=None, additionalPayment=None, mutualEarlyTermination=None, optionalEarlyTermination=None, optionalEarlyTerminationDate=None, optionalEarlyTerminationElectingPartyReference=None, breakFundingRecovery=None, breakFeeElection=None, breakFeeRate=None, multipleExchangeIndexAnnexFallback=None, componentSecurityIndexAnnexFallback=None, localJurisdiction=None, relevantJurisdiction=None, extraordinaryEvents=None):
        super(EquitySwapTransactionSupplementSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, returnSwapLeg, principalExchangeFeatures, additionalPayment, mutualEarlyTermination, optionalEarlyTermination, optionalEarlyTerminationDate, optionalEarlyTerminationElectingPartyReference, breakFundingRecovery, breakFeeElection, breakFeeRate, multipleExchangeIndexAnnexFallback, componentSecurityIndexAnnexFallback, localJurisdiction, relevantJurisdiction, extraordinaryEvents, )
supermod.EquitySwapTransactionSupplement.subclass = EquitySwapTransactionSupplementSub
# end class EquitySwapTransactionSupplementSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'EquitySwapTransactionSupplement'
        rootClass = supermod.EquitySwapTransactionSupplement
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_return_swapslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_return_swapslib as model_\n\n')
