...
#
# Generated Tue Feb 23 09:01:11 2016 by generateDS.py version 2.19b.
#
...
import fpml01/fpml_comlib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        ...
        rootClass = supermod.AbsoluteTolerance
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_comlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_comlib as model_\n\n')
