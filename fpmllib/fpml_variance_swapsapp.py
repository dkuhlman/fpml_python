...
#
# Generated Tue Feb 23 09:04:42 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_variance_swapslib.py')
#   ('-s', 'fpml01/fpml_variance_swapsapp.py')
#   ('--super', 'fpml01/fpml_variance_swapslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-variance-swaps.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_variance_swapslib.py" -s "fpml01/fpml_variance_swapsapp.py" --super="fpml01/fpml_variance_swapslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-variance-swaps.xsd
#
...
import fpml01/fpml_variance_swapslib as supermod
...
class LimitedVarianceSwapTransactionSupplementSub(supermod.LimitedVarianceSwapTransactionSupplement):
    def __init__(self, varianceLeg=None):
        super(LimitedVarianceSwapTransactionSupplementSub, self).__init__(varianceLeg, )
supermod.LimitedVarianceSwapTransactionSupplement.subclass = LimitedVarianceSwapTransactionSupplementSub
# end class LimitedVarianceSwapTransactionSupplementSub


class EquityExerciseValuationSettlementSub(supermod.EquityExerciseValuationSettlement):
    def __init__(self, equityEuropeanExercise=None, equityAmericanExercise=None, equityBermudaExercise=None, automaticExercise=None, makeWholeProvisions=None, prePayment=None, equityValuation=None, settlementDate=None, settlementCurrency=None, settlementPriceSource=None, settlementType=None, settlementMethodElectionDate=None, settlementMethodElectingPartyReference=None, settlementPriceDefaultElection=None):
        super(EquityExerciseValuationSettlementSub, self).__init__(equityEuropeanExercise, equityAmericanExercise, equityBermudaExercise, automaticExercise, makeWholeProvisions, prePayment, equityValuation, settlementDate, settlementCurrency, settlementPriceSource, settlementType, settlementMethodElectionDate, settlementMethodElectingPartyReference, settlementPriceDefaultElection, )
supermod.EquityExerciseValuationSettlement.subclass = EquityExerciseValuationSettlementSub
# end class EquityExerciseValuationSettlementSub


class EquityMultipleExerciseSub(supermod.EquityMultipleExercise):
    def __init__(self, integralMultipleExercise=None, minimumNumberOfOptions=None, maximumNumberOfOptions=None):
        super(EquityMultipleExerciseSub, self).__init__(integralMultipleExercise, minimumNumberOfOptions, maximumNumberOfOptions, )
supermod.EquityMultipleExercise.subclass = EquityMultipleExerciseSub
# end class EquityMultipleExerciseSub
...
class CalculatedAmountSub(supermod.CalculatedAmount):
    def __init__(self, calculationDates=None, observationStartDate=None, optionsExchangeDividends=None, additionalDividends=None, allDividends=None, extensiontype_=None):
        super(CalculatedAmountSub, self).__init__(calculationDates, observationStartDate, optionsExchangeDividends, additionalDividends, allDividends, extensiontype_, )
...
class SharedAmericanExerciseSub(supermod.SharedAmericanExercise):
    def __init__(self, id=None, commencementDate=None, expirationDate=None, latestExerciseTime=None, latestExerciseTimeDetermination=None, extensiontype_=None):
        super(SharedAmericanExerciseSub, self).__init__(id, commencementDate, expirationDate, latestExerciseTime, latestExerciseTimeDetermination, extensiontype_, )
...
class NettedSwapBaseSub(supermod.NettedSwapBase):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, additionalPayment=None, extraordinaryEvents=None, extensiontype_=None):
        super(NettedSwapBaseSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, additionalPayment, extraordinaryEvents, extensiontype_, )
...
class PrePaymentSub(supermod.PrePayment):
    def __init__(self, id=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, prePayment=None, prePaymentAmount=None, prePaymentDate=None):
        super(PrePaymentSub, self).__init__(id, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, prePayment, prePaymentAmount, prePaymentDate, )
supermod.PrePayment.subclass = PrePaymentSub
# end class PrePaymentSub


class EquityEuropeanExerciseSub(supermod.EquityEuropeanExercise):
    def __init__(self, id=None, expirationDate=None, equityExpirationTimeType=None, equityExpirationTime=None, expirationTimeDetermination=None):
        super(EquityEuropeanExerciseSub, self).__init__(id, expirationDate, equityExpirationTimeType, equityExpirationTime, expirationTimeDetermination, )
supermod.EquityEuropeanExercise.subclass = EquityEuropeanExerciseSub
# end class EquityEuropeanExerciseSub


class EquityDerivativeBaseSub(supermod.EquityDerivativeBase):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, extensiontype_=None):
        super(EquityDerivativeBaseSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, extensiontype_, )
supermod.EquityDerivativeBase.subclass = EquityDerivativeBaseSub
# end class EquityDerivativeBaseSub


class EquityBermudaExerciseSub(supermod.EquityBermudaExercise):
    def __init__(self, id=None, commencementDate=None, expirationDate=None, latestExerciseTime=None, latestExerciseTimeDetermination=None, bermudaExerciseDates=None, latestExerciseTimeType=None, equityExpirationTimeType=None, equityExpirationTime=None, expirationTimeDetermination=None, equityMultipleExercise=None):
        super(EquityBermudaExerciseSub, self).__init__(id, commencementDate, expirationDate, latestExerciseTime, latestExerciseTimeDetermination, bermudaExerciseDates, latestExerciseTimeType, equityExpirationTimeType, equityExpirationTime, expirationTimeDetermination, equityMultipleExercise, )
supermod.EquityBermudaExercise.subclass = EquityBermudaExerciseSub
# end class EquityBermudaExerciseSub


class EquityAmericanExerciseSub(supermod.EquityAmericanExercise):
    def __init__(self, id=None, commencementDate=None, expirationDate=None, latestExerciseTime=None, latestExerciseTimeDetermination=None, latestExerciseTimeType=None, equityExpirationTimeType=None, equityExpirationTime=None, expirationTimeDetermination=None, equityMultipleExercise=None):
        super(EquityAmericanExerciseSub, self).__init__(id, commencementDate, expirationDate, latestExerciseTime, latestExerciseTimeDetermination, latestExerciseTimeType, equityExpirationTimeType, equityExpirationTime, expirationTimeDetermination, equityMultipleExercise, )
supermod.EquityAmericanExercise.subclass = EquityAmericanExerciseSub
# end class EquityAmericanExerciseSub


class VarianceSwapTransactionSupplementSub(supermod.VarianceSwapTransactionSupplement):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, varianceLeg=None, multipleExchangeIndexAnnexFallback=None, componentSecurityIndexAnnexFallback=None, localJurisdiction=None, relevantJurisdiction=None):
        super(VarianceSwapTransactionSupplementSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, varianceLeg, multipleExchangeIndexAnnexFallback, componentSecurityIndexAnnexFallback, localJurisdiction, relevantJurisdiction, )
supermod.VarianceSwapTransactionSupplement.subclass = VarianceSwapTransactionSupplementSub
# end class VarianceSwapTransactionSupplementSub


class VarianceSwapSub(supermod.VarianceSwap):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, additionalPayment=None, extraordinaryEvents=None, varianceLeg=None):
        super(VarianceSwapSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, additionalPayment, extraordinaryEvents, varianceLeg, )
supermod.VarianceSwap.subclass = VarianceSwapSub
# end class VarianceSwapSub


class VarianceAmountSub(supermod.VarianceAmount):
    def __init__(self, calculationDates=None, observationStartDate=None, optionsExchangeDividends=None, additionalDividends=None, allDividends=None, variance=None):
        super(VarianceAmountSub, self).__init__(calculationDates, observationStartDate, optionsExchangeDividends, additionalDividends, allDividends, variance, )
supermod.VarianceAmount.subclass = VarianceAmountSub
# end class VarianceAmountSub
...
class DirectionalLegUnderlyerValuationSub(supermod.DirectionalLegUnderlyerValuation):
    def __init__(self, id=None, legIdentifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, effectiveDate=None, terminationDate=None, underlyer=None, settlementType=None, settlementDate=None, settlementAmount=None, settlementCurrency=None, fxFeature=None, valuation=None, extensiontype_=None):
        super(DirectionalLegUnderlyerValuationSub, self).__init__(id, legIdentifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, effectiveDate, terminationDate, underlyer, settlementType, settlementDate, settlementAmount, settlementCurrency, fxFeature, valuation, extensiontype_, )
...
class EquityDerivativeShortFormBaseSub(supermod.EquityDerivativeShortFormBase):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, strike=None, spotPrice=None, numberOfOptions=None, equityPremium=None, extensiontype_=None):
        super(EquityDerivativeShortFormBaseSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, strike, spotPrice, numberOfOptions, equityPremium, extensiontype_, )
supermod.EquityDerivativeShortFormBase.subclass = EquityDerivativeShortFormBaseSub
# end class EquityDerivativeShortFormBaseSub


class EquityDerivativeLongFormBaseSub(supermod.EquityDerivativeLongFormBase):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, dividendConditions=None, methodOfAdjustment=None, extraordinaryEvents=None, extensiontype_=None):
        super(EquityDerivativeLongFormBaseSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, dividendConditions, methodOfAdjustment, extraordinaryEvents, extensiontype_, )
supermod.EquityDerivativeLongFormBase.subclass = EquityDerivativeLongFormBaseSub
# end class EquityDerivativeLongFormBaseSub


class BrokerEquityOptionSub(supermod.BrokerEquityOption):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, strike=None, spotPrice=None, numberOfOptions=None, equityPremium=None, deltaCrossed=None, brokerageFee=None, brokerNotes=None):
        super(BrokerEquityOptionSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, strike, spotPrice, numberOfOptions, equityPremium, deltaCrossed, brokerageFee, brokerNotes, )
supermod.BrokerEquityOption.subclass = BrokerEquityOptionSub
# end class BrokerEquityOptionSub


class VarianceOptionTransactionSupplementSub(supermod.VarianceOptionTransactionSupplement):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityPremium=None, equityExercise=None, exchangeLookAlike=None, methodOfAdjustment=None, optionEntitlement=None, multiplier=None, clearingInstructions=None, varianceSwapTransactionSupplement=None):
        super(VarianceOptionTransactionSupplementSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityPremium, equityExercise, exchangeLookAlike, methodOfAdjustment, optionEntitlement, multiplier, clearingInstructions, varianceSwapTransactionSupplement, )
supermod.VarianceOptionTransactionSupplement.subclass = VarianceOptionTransactionSupplementSub
# end class VarianceOptionTransactionSupplementSub


class VarianceLegSub(supermod.VarianceLeg):
    def __init__(self, id=None, legIdentifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, effectiveDate=None, terminationDate=None, underlyer=None, settlementType=None, settlementDate=None, settlementAmount=None, settlementCurrency=None, fxFeature=None, valuation=None, amount=None):
        super(VarianceLegSub, self).__init__(id, legIdentifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, effectiveDate, terminationDate, underlyer, settlementType, settlementDate, settlementAmount, settlementCurrency, fxFeature, valuation, amount, )
supermod.VarianceLeg.subclass = VarianceLegSub
# end class VarianceLegSub
...
class EquityOptionTransactionSupplementSub(supermod.EquityOptionTransactionSupplement):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, strike=None, spotPrice=None, numberOfOptions=None, equityPremium=None, exchangeLookAlike=None, exchangeTradedContractNearest=None, multipleExchangeIndexAnnexFallback=None, componentSecurityIndexAnnexFallback=None, methodOfAdjustment=None, localJurisdiction=None, optionEntitlement=None, multiplier=None, extraordinaryEvents=None):
        super(EquityOptionTransactionSupplementSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, strike, spotPrice, numberOfOptions, equityPremium, exchangeLookAlike, exchangeTradedContractNearest, multipleExchangeIndexAnnexFallback, componentSecurityIndexAnnexFallback, methodOfAdjustment, localJurisdiction, optionEntitlement, multiplier, extraordinaryEvents, )
supermod.EquityOptionTransactionSupplement.subclass = EquityOptionTransactionSupplementSub
# end class EquityOptionTransactionSupplementSub


class EquityOptionSub(supermod.EquityOption):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, dividendConditions=None, methodOfAdjustment=None, extraordinaryEvents=None, strike=None, spotPrice=None, numberOfOptions=None, optionEntitlement=None, equityPremium=None):
        super(EquityOptionSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, dividendConditions, methodOfAdjustment, extraordinaryEvents, strike, spotPrice, numberOfOptions, optionEntitlement, equityPremium, )
supermod.EquityOption.subclass = EquityOptionSub
# end class EquityOptionSub


class EquityForwardSub(supermod.EquityForward):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, buyerPartyReference=None, buyerAccountReference=None, sellerPartyReference=None, sellerAccountReference=None, optionType=None, equityEffectiveDate=None, underlyer=None, notional=None, equityExercise=None, feature=None, fxFeature=None, strategyFeature=None, dividendConditions=None, methodOfAdjustment=None, extraordinaryEvents=None, forwardPrice=None):
        super(EquityForwardSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, buyerPartyReference, buyerAccountReference, sellerPartyReference, sellerAccountReference, optionType, equityEffectiveDate, underlyer, notional, equityExercise, feature, fxFeature, strategyFeature, dividendConditions, methodOfAdjustment, extraordinaryEvents, forwardPrice, )
supermod.EquityForward.subclass = EquityForwardSub
# end class EquityForwardSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'LimitedVarianceSwapTransactionSupplement'
        rootClass = supermod.LimitedVarianceSwapTransactionSupplement
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_variance_swapslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_variance_swapslib as model_\n\n')
