...
#
# Generated Tue Feb 23 09:01:44 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_enumlib.py')
#   ('-s', 'fpml01/fpml_enumapp.py')
#   ('--super', 'fpml01/fpml_enumlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-enum.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_enumlib.py" -s "fpml01/fpml_enumapp.py" --super="fpml01/fpml_enumlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-enum.xsd
#
...
import fpml01/fpml_enumlib as supermod
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_enumlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_enumlib as model_\n\n')
