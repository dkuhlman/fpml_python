...
#
# Generated Tue Feb 23 09:04:37 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_valuationlib.py')
#   ('-s', 'fpml01/fpml_valuationapp.py')
#   ('--super', 'fpml01/fpml_valuationlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-valuation.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_valuationlib.py" -s "fpml01/fpml_valuationapp.py" --super="fpml01/fpml_valuationlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-valuation.xsd
#
...
import fpml01/fpml_valuationlib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AssetValuation'
        rootClass = supermod.AssetValuation
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_valuationlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_valuationlib as model_\n\n')
