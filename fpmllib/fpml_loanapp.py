...
#
# Generated Tue Feb 23 09:02:41 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_loanlib.py')
#   ('-s', 'fpml01/fpml_loanapp.py')
#   ('--super', 'fpml01/fpml_loanlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-loan.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_loanlib.py" -s "fpml01/fpml_loanapp.py" --super="fpml01/fpml_loanlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-loan.xsd
#
...
import fpml01/fpml_loanlib as supermod
...
class AbstractEventRequireIdSub(supermod.AbstractEventRequireId):
    def __init__(self, eventIdentifier=None, extensiontype_=None):
        super(AbstractEventRequireIdSub, self).__init__(eventIdentifier, extensiontype_, )
supermod.AbstractEventRequireId.subclass = AbstractEventRequireIdSub
# end class AbstractEventRequireIdSub


class AccrualOptionBaseSub(supermod.AccrualOptionBase):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, extensiontype_=None):
        super(AccrualOptionBaseSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, extensiontype_, )
supermod.AccrualOptionBase.subclass = AccrualOptionBaseSub
# end class AccrualOptionBaseSub


class AccrualPeriodSub(supermod.AccrualPeriod):
    def __init__(self, startDate=None, endDate=None, numberOfDays=None, referenceAmount=None, referenceAmountType=None, rate=None, accrualAmount=None):
        super(AccrualPeriodSub, self).__init__(startDate, endDate, numberOfDays, referenceAmount, referenceAmountType, rate, accrualAmount, )
supermod.AccrualPeriod.subclass = AccrualPeriodSub
# end class AccrualPeriodSub


class AccrualTypeIdSub(supermod.AccrualTypeId):
    def __init__(self, accrualTypeIdScheme=None, valueOf_=None):
        super(AccrualTypeIdSub, self).__init__(accrualTypeIdScheme, valueOf_, )
supermod.AccrualTypeId.subclass = AccrualTypeIdSub
# end class AccrualTypeIdSub


class AccruingFeeTypeSub(supermod.AccruingFeeType):
    def __init__(self, accruingFeeTypeScheme='http://www.fpml.org/coding-scheme/accruing-fee-type', valueOf_=None):
        super(AccruingFeeTypeSub, self).__init__(accruingFeeTypeScheme, valueOf_, )
supermod.AccruingFeeType.subclass = AccruingFeeTypeSub
# end class AccruingFeeTypeSub


class AdjustmentSub(supermod.Adjustment):
    def __init__(self, adjustmentType=None, amount=None):
        super(AdjustmentSub, self).__init__(adjustmentType, amount, )
supermod.Adjustment.subclass = AdjustmentSub
# end class AdjustmentSub


class AssignmentFeeSub(supermod.AssignmentFee):
    def __init__(self, amount=None, rule=None, lenderTypeWaived=None):
        super(AssignmentFeeSub, self).__init__(amount, rule, lenderTypeWaived, )
supermod.AssignmentFee.subclass = AssignmentFeeSub
# end class AssignmentFeeSub


class AssignmentFeeRuleSub(supermod.AssignmentFeeRule):
    def __init__(self, assignmentFeeRuleScheme='http://www.fpml.org/coding-scheme/assignment-fee-rule', valueOf_=None):
        super(AssignmentFeeRuleSub, self).__init__(assignmentFeeRuleScheme, valueOf_, )
supermod.AssignmentFeeRule.subclass = AssignmentFeeRuleSub
# end class AssignmentFeeRuleSub


class CashPayableSub(supermod.CashPayable):
    def __init__(self, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, netAmount=None, taxWithholding=None):
        super(CashPayableSub, self).__init__(payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, netAmount, taxWithholding, )
supermod.CashPayable.subclass = CashPayableSub
# end class CashPayableSub


class CommitmentChangeSub(supermod.CommitmentChange):
    def __init__(self, date=None, adjustment=None, remaining=None):
        super(CommitmentChangeSub, self).__init__(date, adjustment, remaining, )
supermod.CommitmentChange.subclass = CommitmentChangeSub
# end class CommitmentChangeSub


class CommitmentScheduleSub(supermod.CommitmentSchedule):
    def __init__(self, commitmentChange=None):
        super(CommitmentScheduleSub, self).__init__(commitmentChange, )
supermod.CommitmentSchedule.subclass = CommitmentScheduleSub
# end class CommitmentScheduleSub


class EvergreenOptionSub(supermod.EvergreenOption):
    def __init__(self, nonRenewalNoticePeriod=None, extensionPeriod=None):
        super(EvergreenOptionSub, self).__init__(nonRenewalNoticePeriod, extensionPeriod, )
supermod.EvergreenOption.subclass = EvergreenOptionSub
# end class EvergreenOptionSub


class FacilityCommitmentSub(supermod.FacilityCommitment):
    def __init__(self, totalCommitmentAmount=None, fundedUtilizedAmount=None, unfundedUtilizedAmount=None, unavailableToUtilizeAmount=None):
        super(FacilityCommitmentSub, self).__init__(totalCommitmentAmount, fundedUtilizedAmount, unfundedUtilizedAmount, unavailableToUtilizeAmount, )
supermod.FacilityCommitment.subclass = FacilityCommitmentSub
# end class FacilityCommitmentSub


class FacilityFeatureSub(supermod.FacilityFeature):
    def __init__(self, facilityFeatureScheme='http://www.fpml.org/coding-scheme/facility-feature', valueOf_=None):
        super(FacilityFeatureSub, self).__init__(facilityFeatureScheme, valueOf_, )
supermod.FacilityFeature.subclass = FacilityFeatureSub
# end class FacilityFeatureSub


class FacilityPositionSub(supermod.FacilityPosition):
    def __init__(self, facilityReference=None, commitment=None, priorCommitment=None, extensiontype_=None):
        super(FacilityPositionSub, self).__init__(facilityReference, commitment, priorCommitment, extensiontype_, )
supermod.FacilityPosition.subclass = FacilityPositionSub
# end class FacilityPositionSub


class FeeRateOptionBaseSub(supermod.FeeRateOptionBase):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, extensiontype_=None):
        super(FeeRateOptionBaseSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, extensiontype_, )
supermod.FeeRateOptionBase.subclass = FeeRateOptionBaseSub
# end class FeeRateOptionBaseSub


class FixedRateOptionBaseSub(supermod.FixedRateOptionBase):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, pikSpread='xsd:decimal', extensiontype_=None):
        super(FixedRateOptionBaseSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, pikSpread, extensiontype_, )
supermod.FixedRateOptionBase.subclass = FixedRateOptionBaseSub
# end class FixedRateOptionBaseSub


class FloatingRateIndexLoanSub(supermod.FloatingRateIndexLoan):
    def __init__(self, floatingRateIndexScheme='http://www.fpml.org/coding-scheme/floating-rate-index-loan', valueOf_=None):
        super(FloatingRateIndexLoanSub, self).__init__(floatingRateIndexScheme, valueOf_, )
supermod.FloatingRateIndexLoan.subclass = FloatingRateIndexLoanSub
# end class FloatingRateIndexLoanSub


class FloatingRateOptionBaseSub(supermod.FloatingRateOptionBase):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, floatingRateIndex=None, indexTenor=None, spread=None, pikSpread=None, extensiontype_=None):
        super(FloatingRateOptionBaseSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, floatingRateIndex, indexTenor, spread, pikSpread, extensiontype_, )
supermod.FloatingRateOptionBase.subclass = FloatingRateOptionBaseSub
# end class FloatingRateOptionBaseSub


class LcAccrualSub(supermod.LcAccrual):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, currency=None, lcFxRate=None):
        super(LcAccrualSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, currency, lcFxRate, )
supermod.LcAccrual.subclass = LcAccrualSub
# end class LcAccrualSub


class LcOptionSub(supermod.LcOption):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, startDate=None, endDate=None, type_=None, minLcIssuanceFeeAmount=None):
        super(LcOptionSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, startDate, endDate, type_, minLcIssuanceFeeAmount, )
supermod.LcOption.subclass = LcOptionSub
# end class LcOptionSub


class LcPurposeSub(supermod.LcPurpose):
    def __init__(self, lcPurposeScheme='http://www.fpml.org/coding-scheme/lc-purpose', valueOf_=None):
        super(LcPurposeSub, self).__init__(lcPurposeScheme, valueOf_, )
supermod.LcPurpose.subclass = LcPurposeSub
# end class LcPurposeSub


class LcTypeSub(supermod.LcType):
    def __init__(self, lcTypeScheme='http://www.fpml.org/coding-scheme/lc-type', valueOf_=None):
        super(LcTypeSub, self).__init__(lcTypeScheme, valueOf_, )
supermod.LcType.subclass = LcTypeSub
# end class LcTypeSub


class LenderClassificationSub(supermod.LenderClassification):
    def __init__(self, lenderClassificationScheme='http://www.fpml.org/coding-scheme/lender-classification', valueOf_=None):
        super(LenderClassificationSub, self).__init__(lenderClassificationScheme, valueOf_, )
supermod.LenderClassification.subclass = LenderClassificationSub
# end class LenderClassificationSub


class LetterOfCreditSummarySub(supermod.LetterOfCreditSummary):
    def __init__(self, identifier=None, type_=None, effectiveDate=None, borrowerPartyReference=None, issuingBankPartyReference=None, beneficiaryPartyReference=None, amount=None, extensiontype_=None):
        super(LetterOfCreditSummarySub, self).__init__(identifier, type_, effectiveDate, borrowerPartyReference, issuingBankPartyReference, beneficiaryPartyReference, amount, extensiontype_, )
supermod.LetterOfCreditSummary.subclass = LetterOfCreditSummarySub
# end class LetterOfCreditSummarySub


class LoanContractSummarySub(supermod.LoanContractSummary):
    def __init__(self, identifier=None, effectiveDate=None, borrowerPartyReference=None, guarantorPartyReference=None, amount=None, extensiontype_=None):
        super(LoanContractSummarySub, self).__init__(identifier, effectiveDate, borrowerPartyReference, guarantorPartyReference, amount, extensiontype_, )
supermod.LoanContractSummary.subclass = LoanContractSummarySub
# end class LoanContractSummarySub


class LoanEventSub(supermod.LoanEvent):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, extensiontype_=None):
        super(LoanEventSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, extensiontype_, )
supermod.LoanEvent.subclass = LoanEventSub
# end class LoanEventSub


class MultiCurrencySub(supermod.MultiCurrency):
    def __init__(self, drawCurrency=None):
        super(MultiCurrencySub, self).__init__(drawCurrency, )
supermod.MultiCurrency.subclass = MultiCurrencySub
# end class MultiCurrencySub


class NonRecurringMiscFeeTypeSub(supermod.NonRecurringMiscFeeType):
    def __init__(self, nonRecurringMiscFeeTypeScheme='http://www.fpml.org/coding-scheme/non-recurring-misc-fee-type', valueOf_=None):
        super(NonRecurringMiscFeeTypeSub, self).__init__(nonRecurringMiscFeeTypeScheme, valueOf_, )
supermod.NonRecurringMiscFeeType.subclass = NonRecurringMiscFeeTypeSub
# end class NonRecurringMiscFeeTypeSub


class OutstandingsPositionSub(supermod.OutstandingsPosition):
    def __init__(self, loanContractReference=None, letterOfCreditReference=None, amount=None, priorAmount=None, facilityFxRate=None):
        super(OutstandingsPositionSub, self).__init__(loanContractReference, letterOfCreditReference, amount, priorAmount, facilityFxRate, )
supermod.OutstandingsPosition.subclass = OutstandingsPositionSub
# end class OutstandingsPositionSub


class PaymentProjectionSub(supermod.PaymentProjection):
    def __init__(self, nextPaymentDate=None, projectedAmount=None):
        super(PaymentProjectionSub, self).__init__(nextPaymentDate, projectedAmount, )
supermod.PaymentProjection.subclass = PaymentProjectionSub
# end class PaymentProjectionSub


class PeriodRateSub(supermod.PeriodRate):
    def __init__(self, startDate=None, endDate=None, rate=None):
        super(PeriodRateSub, self).__init__(startDate, endDate, rate, )
supermod.PeriodRate.subclass = PeriodRateSub
# end class PeriodRateSub


class ProRataFacilitiesSub(supermod.ProRataFacilities):
    def __init__(self, facilityReference=None):
        super(ProRataFacilitiesSub, self).__init__(facilityReference, )
supermod.ProRataFacilities.subclass = ProRataFacilitiesSub
# end class ProRataFacilitiesSub


class RateLimitsSub(supermod.RateLimits):
    def __init__(self, floorRate=None, capRate=None):
        super(RateLimitsSub, self).__init__(floorRate, capRate, )
supermod.RateLimits.subclass = RateLimitsSub
# end class RateLimitsSub


class TaxWithholdingSub(supermod.TaxWithholding):
    def __init__(self, amount=None, taxRate=None, reason=None):
        super(TaxWithholdingSub, self).__init__(amount, taxRate, reason, )
supermod.TaxWithholding.subclass = TaxWithholdingSub
# end class TaxWithholdingSub


class WithholdingTaxReasonSub(supermod.WithholdingTaxReason):
    def __init__(self, withholdingTaxReasonScheme='http://www.fpml.org/coding-scheme/withholding-tax-reason', valueOf_=None):
        super(WithholdingTaxReasonSub, self).__init__(withholdingTaxReasonScheme, valueOf_, )
supermod.WithholdingTaxReason.subclass = WithholdingTaxReasonSub
# end class WithholdingTaxReasonSub
...
class ContractIdentifierSub(supermod.ContractIdentifier):
    def __init__(self, id=None, partyReference=None, contractId=None, versionedContractId=None, extensiontype_=None):
        super(ContractIdentifierSub, self).__init__(id, partyReference, contractId, versionedContractId, extensiontype_, )
...
class FxFixingSub(supermod.FxFixing):
    def __init__(self, quotedCurrencyPair=None, fixingDate=None, fxSpotRateSource=None, extensiontype_=None):
        super(FxFixingSub, self).__init__(quotedCurrencyPair, fixingDate, fxSpotRateSource, extensiontype_, )
...
class BusinessEventIdentifierSub(supermod.BusinessEventIdentifier):
    def __init__(self, id=None, partyReference=None, accountReference=None, eventId=None, extensiontype_=None):
        super(BusinessEventIdentifierSub, self).__init__(id, partyReference, accountReference, eventId, extensiontype_, )
...
class maturingContractsTypeSub(supermod.maturingContractsType):
    def __init__(self, contractIdentifier=None, contractSummary=None, contract=None):
        super(maturingContractsTypeSub, self).__init__(contractIdentifier, contractSummary, contract, )
supermod.maturingContractsType.subclass = maturingContractsTypeSub
# end class maturingContractsTypeSub


class currentContractsTypeSub(supermod.currentContractsType):
    def __init__(self, contract=None):
        super(currentContractsTypeSub, self).__init__(contract, )
supermod.currentContractsType.subclass = currentContractsTypeSub
# end class currentContractsTypeSub


class maturingContractsType1Sub(supermod.maturingContractsType1):
    def __init__(self, contractIdentifier=None, contractSummary=None, contract=None):
        super(maturingContractsType1Sub, self).__init__(contractIdentifier, contractSummary, contract, )
supermod.maturingContractsType1.subclass = maturingContractsType1Sub
# end class maturingContractsType1Sub


class currentContractsType2Sub(supermod.currentContractsType2):
    def __init__(self, contract=None):
        super(currentContractsType2Sub, self).__init__(contract, )
supermod.currentContractsType2.subclass = currentContractsType2Sub
# end class currentContractsType2Sub
...
class MoneyWithParticipantShareSub(supermod.MoneyWithParticipantShare):
    def __init__(self, id=None, currency=None, amount=None, shareAmount=None):
        super(MoneyWithParticipantShareSub, self).__init__(id, currency, amount, shareAmount, )
supermod.MoneyWithParticipantShare.subclass = MoneyWithParticipantShareSub
# end class MoneyWithParticipantShareSub


class LoanContractReferenceSub(supermod.LoanContractReference):
    def __init__(self, href=None):
        super(LoanContractReferenceSub, self).__init__(href, )
supermod.LoanContractReference.subclass = LoanContractReferenceSub
# end class LoanContractReferenceSub


class LoanContractEventSub(supermod.LoanContractEvent):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, extensiontype_=None):
        super(LoanContractEventSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, extensiontype_, )
supermod.LoanContractEvent.subclass = LoanContractEventSub
# end class LoanContractEventSub


class LoanContractBaseRateSetSub(supermod.LoanContractBaseRateSet):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, fixingDate=None, rate=None):
        super(LoanContractBaseRateSetSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, fixingDate, rate, )
supermod.LoanContractBaseRateSet.subclass = LoanContractBaseRateSetSub
# end class LoanContractBaseRateSetSub


class LoanContractAdjustmentSub(supermod.LoanContractAdjustment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, adjustment=None, amount=None):
        super(LoanContractAdjustmentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, adjustment, amount, )
supermod.LoanContractAdjustment.subclass = LoanContractAdjustmentSub
# end class LoanContractAdjustmentSub


class LoanContractSub(supermod.LoanContract):
    def __init__(self, identifier=None, effectiveDate=None, borrowerPartyReference=None, guarantorPartyReference=None, amount=None, repricingDate=None, maturityDate=None, fixedRateAccrual=None, floatingRateAccrual=None, facilityFxRate=None):
        super(LoanContractSub, self).__init__(identifier, effectiveDate, borrowerPartyReference, guarantorPartyReference, amount, repricingDate, maturityDate, fixedRateAccrual, floatingRateAccrual, facilityFxRate, )
supermod.LoanContract.subclass = LoanContractSub
# end class LoanContractSub


class LetterOfCreditReferenceSub(supermod.LetterOfCreditReference):
    def __init__(self, href=None):
        super(LetterOfCreditReferenceSub, self).__init__(href, )
supermod.LetterOfCreditReference.subclass = LetterOfCreditReferenceSub
# end class LetterOfCreditReferenceSub


class LetterOfCreditSub(supermod.LetterOfCredit):
    def __init__(self, identifier=None, type_=None, effectiveDate=None, borrowerPartyReference=None, issuingBankPartyReference=None, beneficiaryPartyReference=None, amount=None, expiryDate=None, finalExpiryDate=None, lcAccrual=None, purpose=None, evergreenOption=None, lcAutoAdjust=None, minLcIssuanceFeeAmount=None, facilityFxRate=None):
        super(LetterOfCreditSub, self).__init__(identifier, type_, effectiveDate, borrowerPartyReference, issuingBankPartyReference, beneficiaryPartyReference, amount, expiryDate, finalExpiryDate, lcAccrual, purpose, evergreenOption, lcAutoAdjust, minLcIssuanceFeeAmount, facilityFxRate, )
supermod.LetterOfCredit.subclass = LetterOfCreditSub
# end class LetterOfCreditSub


class LcEventSub(supermod.LcEvent):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, extensiontype_=None):
        super(LcEventSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, extensiontype_, )
supermod.LcEvent.subclass = LcEventSub
# end class LcEventSub


class LcAdjustmentSub(supermod.LcAdjustment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, adjustment=None, amount=None, relatedBorrowing=None):
        super(LcAdjustmentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, adjustment, amount, relatedBorrowing, )
supermod.LcAdjustment.subclass = LcAdjustmentSub
# end class LcAdjustmentSub


class InterestPaymentSub(supermod.InterestPayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, startDate=None, endDate=None, calculationMethod=None, amount=None, accrualSchedule=None, projection=None):
        super(InterestPaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, startDate, endDate, calculationMethod, amount, accrualSchedule, projection, )
supermod.InterestPayment.subclass = InterestPaymentSub
# end class InterestPaymentSub


class InterestCapitalizationSub(supermod.InterestCapitalization):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, startDate=None, endDate=None, calculationMethod=None, amount=None, accrualSchedule=None, projection=None):
        super(InterestCapitalizationSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, startDate, endDate, calculationMethod, amount, accrualSchedule, projection, )
supermod.InterestCapitalization.subclass = InterestCapitalizationSub
# end class InterestCapitalizationSub


class FxTermsSub(supermod.FxTerms):
    def __init__(self, quotedCurrencyPair=None, fixingDate=None, fxSpotRateSource=None, rate=None):
        super(FxTermsSub, self).__init__(quotedCurrencyPair, fixingDate, fxSpotRateSource, rate, )
supermod.FxTerms.subclass = FxTermsSub
# end class FxTermsSub


class FloatingRateOptionSub(supermod.FloatingRateOption):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, floatingRateIndex=None, indexTenor=None, spread=None, pikSpread=None, currency=None, startDate=None, endDate=None, baseRateLimits=None, allInRateLimits=None, borrowerPartyReference=None, drawdownNoticeDays=None, fxRateSetNoticeDays=None, rateSetNoticeDays=None):
        super(FloatingRateOptionSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, floatingRateIndex, indexTenor, spread, pikSpread, currency, startDate, endDate, baseRateLimits, allInRateLimits, borrowerPartyReference, drawdownNoticeDays, fxRateSetNoticeDays, rateSetNoticeDays, )
supermod.FloatingRateOption.subclass = FloatingRateOptionSub
# end class FloatingRateOptionSub


class FloatingRateAccrualSub(supermod.FloatingRateAccrual):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, floatingRateIndex=None, indexTenor=None, spread=None, pikSpread=None, startDate=None, endDate=None, numberOfDays=None, rateFixingDate=None, baseRate=None, penaltySpread=None, defaultSpread=None, mandatoryCostRate=None, allInRate=None, paymentProjection=None):
        super(FloatingRateAccrualSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, floatingRateIndex, indexTenor, spread, pikSpread, startDate, endDate, numberOfDays, rateFixingDate, baseRate, penaltySpread, defaultSpread, mandatoryCostRate, allInRate, paymentProjection, )
supermod.FloatingRateAccrual.subclass = FloatingRateAccrualSub
# end class FloatingRateAccrualSub


class FixedRateOptionSub(supermod.FixedRateOption):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, pikSpread='xsd:decimal', startDate=None, endDate=None, currency=None, allInRateLimits=None, borrowerPartyReference=None, drawdownNoticeDays=None, fxRateSetNoticeDays=None, rateSetNoticeDays=None):
        super(FixedRateOptionSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, pikSpread, startDate, endDate, currency, allInRateLimits, borrowerPartyReference, drawdownNoticeDays, fxRateSetNoticeDays, rateSetNoticeDays, )
supermod.FixedRateOption.subclass = FixedRateOptionSub
# end class FixedRateOptionSub


class FixedRateAccrualSub(supermod.FixedRateAccrual):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, pikSpread='xsd:decimal', startDate=None, endDate=None, numberOfDays=None, penaltySpread=None, defaultSpread=None, mandatoryCostRate=None, allInRate=None, paymentProjection=None):
        super(FixedRateAccrualSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, pikSpread, startDate, endDate, numberOfDays, penaltySpread, defaultSpread, mandatoryCostRate, allInRate, paymentProjection, )
supermod.FixedRateAccrual.subclass = FixedRateAccrualSub
# end class FixedRateAccrualSub


class FacilityReferenceSub(supermod.FacilityReference):
    def __init__(self, href=None):
        super(FacilityReferenceSub, self).__init__(href, )
supermod.FacilityReference.subclass = FacilityReferenceSub
# end class FacilityReferenceSub


class FacilityOutstandingsPositionSub(supermod.FacilityOutstandingsPosition):
    def __init__(self, facilityReference=None, commitment=None, priorCommitment=None, outstandingsPosition=None):
        super(FacilityOutstandingsPositionSub, self).__init__(facilityReference, commitment, priorCommitment, outstandingsPosition, )
supermod.FacilityOutstandingsPosition.subclass = FacilityOutstandingsPositionSub
# end class FacilityOutstandingsPositionSub


class FacilityIdentifierSub(supermod.FacilityIdentifier):
    def __init__(self, id=None, instrumentId=None, description=None, extensiontype_=None):
        super(FacilityIdentifierSub, self).__init__(id, instrumentId, description, extensiontype_, )
supermod.FacilityIdentifier.subclass = FacilityIdentifierSub
# end class FacilityIdentifierSub


class FacilityEventSub(supermod.FacilityEvent):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, extensiontype_=None):
        super(FacilityEventSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, extensiontype_, )
supermod.FacilityEvent.subclass = FacilityEventSub
# end class FacilityEventSub


class FacilityContractIdentifierSub(supermod.FacilityContractIdentifier):
    def __init__(self, id=None, partyReference=None, contractId=None, versionedContractId=None, facilityReference=None):
        super(FacilityContractIdentifierSub, self).__init__(id, partyReference, contractId, versionedContractId, facilityReference, )
supermod.FacilityContractIdentifier.subclass = FacilityContractIdentifierSub
# end class FacilityContractIdentifierSub


class FacilityContractEventSub(supermod.FacilityContractEvent):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, extensiontype_=None):
        super(FacilityContractEventSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, extensiontype_, )
supermod.FacilityContractEvent.subclass = FacilityContractEventSub
# end class FacilityContractEventSub


class DefaultRateExpirySub(supermod.DefaultRateExpiry):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None):
        super(DefaultRateExpirySub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, )
supermod.DefaultRateExpiry.subclass = DefaultRateExpirySub
# end class DefaultRateExpirySub


class DealIdentifierSub(supermod.DealIdentifier):
    def __init__(self, id=None, instrumentId=None, description=None, extensiontype_=None):
        super(DealIdentifierSub, self).__init__(id, instrumentId, description, extensiontype_, )
supermod.DealIdentifier.subclass = DealIdentifierSub
# end class DealIdentifierSub


class CommitmentAdjustmentSub(supermod.CommitmentAdjustment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, refusalAllowed=None, scheduled=None, pik=None, facilityCommitment=None, adjustment=None, commitmentSchedule=None):
        super(CommitmentAdjustmentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, refusalAllowed, scheduled, pik, facilityCommitment, adjustment, commitmentSchedule, )
supermod.CommitmentAdjustment.subclass = CommitmentAdjustmentSub
# end class CommitmentAdjustmentSub


class BusinessEventGroupIdentifierSub(supermod.BusinessEventGroupIdentifier):
    def __init__(self, id=None, partyReference=None, accountReference=None, eventId=None, description=None):
        super(BusinessEventGroupIdentifierSub, self).__init__(id, partyReference, accountReference, eventId, description, )
supermod.BusinessEventGroupIdentifier.subclass = BusinessEventGroupIdentifierSub
# end class BusinessEventGroupIdentifierSub


class BorrowingSub(supermod.Borrowing):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, amount=None, conditionsPrecedentMet=None):
        super(BorrowingSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, amount, conditionsPrecedentMet, )
supermod.Borrowing.subclass = BorrowingSub
# end class BorrowingSub


class AccruingPikPaymentSub(supermod.AccruingPikPayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, startDate=None, endDate=None, amount=None, accrualSchedule=None):
        super(AccruingPikPaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, startDate, endDate, amount, accrualSchedule, )
supermod.AccruingPikPayment.subclass = AccruingPikPaymentSub
# end class AccruingPikPaymentSub


class AccruingPikOptionChangeSub(supermod.AccruingPikOptionChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, accruingPikOption=None):
        super(AccruingPikOptionChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, accruingPikOption, )
supermod.AccruingPikOptionChange.subclass = AccruingPikOptionChangeSub
# end class AccruingPikOptionChangeSub


class AccruingPikOptionSub(supermod.AccruingPikOption):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, startDate=None, endDate=None):
        super(AccruingPikOptionSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, startDate, endDate, )
supermod.AccruingPikOption.subclass = AccruingPikOptionSub
# end class AccruingPikOptionSub


class AccruingFeePaymentSub(supermod.AccruingFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, id=None, startDate=None, endDate=None, amount=None, accrualSchedule=None, projection=None):
        super(AccruingFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, id, startDate, endDate, amount, accrualSchedule, projection, )
supermod.AccruingFeePayment.subclass = AccruingFeePaymentSub
# end class AccruingFeePaymentSub


class AccruingFeeOptionSub(supermod.AccruingFeeOption):
    def __init__(self, accrualOptionId=None, dayCountFraction=None, paymentFrequency=None, rate=None, type_=None, startDate=None, endDate=None, calculationDefinition=None):
        super(AccruingFeeOptionSub, self).__init__(accrualOptionId, dayCountFraction, paymentFrequency, rate, type_, startDate, endDate, calculationDefinition, )
supermod.AccruingFeeOption.subclass = AccruingFeeOptionSub
# end class AccruingFeeOptionSub


class AccruingFeeExpirySub(supermod.AccruingFeeExpiry):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, id=None, type_=None):
        super(AccruingFeeExpirySub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, id, type_, )
supermod.AccruingFeeExpiry.subclass = AccruingFeeExpirySub
# end class AccruingFeeExpirySub


class AccruingFeeChangeSub(supermod.AccruingFeeChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, accruingFeeOption=None):
        super(AccruingFeeChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, accruingFeeOption, )
supermod.AccruingFeeChange.subclass = AccruingFeeChangeSub
# end class AccruingFeeChangeSub
...
class SyndicatedLoanStatementSub(supermod.SyndicatedLoanStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, statementDate=None, comments=None, extensiontype_=None):
        super(SyndicatedLoanStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, statementDate, comments, extensiontype_, )
supermod.SyndicatedLoanStatement.subclass = SyndicatedLoanStatementSub
# end class SyndicatedLoanStatementSub


class RolloverNotificationRetractedSub(supermod.RolloverNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, businessEventGroupId=None, party=None, maturingContracts=None, currentContracts=None, baseRateSet=None, borrowing=None, commitmentAdjustment=None, interestCapitalization=None, interestPayment=None, repayment=None, facilityIdentifier=None, facilitySummary=None):
        super(RolloverNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, businessEventGroupId, party, maturingContracts, currentContracts, baseRateSet, borrowing, commitmentAdjustment, interestCapitalization, interestPayment, repayment, facilityIdentifier, facilitySummary, )
supermod.RolloverNotificationRetracted.subclass = RolloverNotificationRetractedSub
# end class RolloverNotificationRetractedSub


class RepaymentSub(supermod.Repayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, amount=None, price=None, refusalAllowed=None, borrowerMandatory=None, scheduledRepayment=None):
        super(RepaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, amount, price, refusalAllowed, borrowerMandatory, scheduledRepayment, )
supermod.Repayment.subclass = RepaymentSub
# end class RepaymentSub


class PrepaymentNotificationRetractedSub(supermod.PrepaymentNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, businessEventGroupId=None, party=None, repayment=None, commitmentAdjustment=None, breakageFeePayment=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None):
        super(PrepaymentNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, businessEventGroupId, party, repayment, commitmentAdjustment, breakageFeePayment, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, )
supermod.PrepaymentNotificationRetracted.subclass = PrepaymentNotificationRetractedSub
# end class PrepaymentNotificationRetractedSub


class PenaltyRateExpirySub(supermod.PenaltyRateExpiry):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None):
        super(PenaltyRateExpirySub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, )
supermod.PenaltyRateExpiry.subclass = PenaltyRateExpirySub
# end class PenaltyRateExpirySub


class OutstandingContractsStatementSub(supermod.OutstandingContractsStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, statementDate=None, comments=None, facilityIdentifier=None, loanContract=None, letterOfCredit=None, party=None):
        super(OutstandingContractsStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, statementDate, comments, facilityIdentifier, loanContract, letterOfCredit, party, )
supermod.OutstandingContractsStatement.subclass = OutstandingContractsStatementSub
# end class OutstandingContractsStatementSub


class NonRecurringFeePaymentNotificationRetractedSub(supermod.NonRecurringFeePaymentNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, facilityFeePaymentGroup=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None):
        super(NonRecurringFeePaymentNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, facilityFeePaymentGroup, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, )
supermod.NonRecurringFeePaymentNotificationRetracted.subclass = NonRecurringFeePaymentNotificationRetractedSub
# end class NonRecurringFeePaymentNotificationRetractedSub


class NonRecurringFeePaymentSub(supermod.NonRecurringFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None, extensiontype_=None):
        super(NonRecurringFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, extensiontype_, )
supermod.NonRecurringFeePayment.subclass = NonRecurringFeePaymentSub
# end class NonRecurringFeePaymentSub


class MiscFeePaymentSub(supermod.MiscFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None, type_=None):
        super(MiscFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, type_, )
supermod.MiscFeePayment.subclass = MiscFeePaymentSub
# end class MiscFeePaymentSub


class MandatoryCostRateExpirySub(supermod.MandatoryCostRateExpiry):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None):
        super(MandatoryCostRateExpirySub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, )
supermod.MandatoryCostRateExpiry.subclass = MandatoryCostRateExpirySub
# end class MandatoryCostRateExpirySub


class LoanContractNotificationRetractedSub(supermod.LoanContractNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, loanContractEventGroup=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None):
        super(LoanContractNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, loanContractEventGroup, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, )
supermod.LoanContractNotificationRetracted.subclass = LoanContractNotificationRetractedSub
# end class LoanContractNotificationRetractedSub


class LoanContractMaturityChangeSub(supermod.LoanContractMaturityChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, loanContractReference=None, currentMaturityDate=None, priorMaturityDate=None):
        super(LoanContractMaturityChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, loanContractReference, currentMaturityDate, priorMaturityDate, )
supermod.LoanContractMaturityChange.subclass = LoanContractMaturityChangeSub
# end class LoanContractMaturityChangeSub


class LcTerminationSub(supermod.LcTermination):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, expiry=None):
        super(LcTerminationSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, expiry, )
supermod.LcTermination.subclass = LcTerminationSub
# end class LcTerminationSub


class LcRenewalSub(supermod.LcRenewal):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, finalExpiryDate=None, maturityDate=None):
        super(LcRenewalSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, finalExpiryDate, maturityDate, )
supermod.LcRenewal.subclass = LcRenewalSub
# end class LcRenewalSub


class LcRateChangeSub(supermod.LcRateChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, rate=None):
        super(LcRateChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, rate, )
supermod.LcRateChange.subclass = LcRateChangeSub
# end class LcRateChangeSub


class LcOptionChangeSub(supermod.LcOptionChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, lcOption=None):
        super(LcOptionChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, lcOption, )
supermod.LcOptionChange.subclass = LcOptionChangeSub
# end class LcOptionChangeSub


class LcNotificationRetractedSub(supermod.LcNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, lcEventGroup=None, facilityIdentifier=None, facilitySummary=None, letterOfCreditIdentifier=None, letterOfCreditSummary=None, letterOfCredit=None):
        super(LcNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, lcEventGroup, facilityIdentifier, facilitySummary, letterOfCreditIdentifier, letterOfCreditSummary, letterOfCredit, )
supermod.LcNotificationRetracted.subclass = LcNotificationRetractedSub
# end class LcNotificationRetractedSub


class LcIssuanceFeePaymentSub(supermod.LcIssuanceFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, id=None, startDate=None, endDate=None, amount=None, accrualSchedule=None):
        super(LcIssuanceFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, id, startDate, endDate, amount, accrualSchedule, )
supermod.LcIssuanceFeePayment.subclass = LcIssuanceFeePaymentSub
# end class LcIssuanceFeePaymentSub


class LcIssuanceSub(supermod.LcIssuance):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, amount=None):
        super(LcIssuanceSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, amount, )
supermod.LcIssuance.subclass = LcIssuanceSub
# end class LcIssuanceSub


class LcFxRevaluationSub(supermod.LcFxRevaluation):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, letterOfCreditReference=None, lcFxRate=None, facilityFxRate=None):
        super(LcFxRevaluationSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, letterOfCreditReference, lcFxRate, facilityFxRate, )
supermod.LcFxRevaluation.subclass = LcFxRevaluationSub
# end class LcFxRevaluationSub


class FundingFeePaymentSub(supermod.FundingFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None):
        super(FundingFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, )
supermod.FundingFeePayment.subclass = FundingFeePaymentSub
# end class FundingFeePaymentSub


class FloatingRateOptionChangeSub(supermod.FloatingRateOptionChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, floatingRateOption=None):
        super(FloatingRateOptionChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, floatingRateOption, )
supermod.FloatingRateOptionChange.subclass = FloatingRateOptionChangeSub
# end class FloatingRateOptionChangeSub


class FixedRateOptionChangeSub(supermod.FixedRateOptionChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, fixedRateOption=None):
        super(FixedRateOptionChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, fixedRateOption, )
supermod.FixedRateOptionChange.subclass = FixedRateOptionChangeSub
# end class FixedRateOptionChangeSub


class FacilityTerminationSub(supermod.FacilityTermination):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None):
        super(FacilityTerminationSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, )
supermod.FacilityTermination.subclass = FacilityTerminationSub
# end class FacilityTerminationSub


class FacilitySummarySub(supermod.FacilitySummary):
    def __init__(self, id=None, instrumentId=None, description=None, borrowerPartyReference=None, coBorrowerPartyReference=None, agentPartyReference=None, lcIssuingBankPartyReference=None, guarantorPartyReference=None, startDate=None, expiryDate=None, maturityDate=None, currentCommitment=None, originalCommitment=None, commitmentSchedule=None, dealFxRate=None, extensiontype_=None):
        super(FacilitySummarySub, self).__init__(id, instrumentId, description, borrowerPartyReference, coBorrowerPartyReference, agentPartyReference, lcIssuingBankPartyReference, guarantorPartyReference, startDate, expiryDate, maturityDate, currentCommitment, originalCommitment, commitmentSchedule, dealFxRate, extensiontype_, )
supermod.FacilitySummary.subclass = FacilitySummarySub
# end class FacilitySummarySub


class FacilityStatementSub(supermod.FacilityStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, statementDate=None, comments=None, facilityGroup=None, party=None):
        super(FacilityStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, statementDate, comments, facilityGroup, party, )
supermod.FacilityStatement.subclass = FacilityStatementSub
# end class FacilityStatementSub


class FacilityRateChangeNotificationRetractedSub(supermod.FacilityRateChangeNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, facilityRateChangeGroup=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None):
        super(FacilityRateChangeNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, facilityRateChangeGroup, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, )
supermod.FacilityRateChangeNotificationRetracted.subclass = FacilityRateChangeNotificationRetractedSub
# end class FacilityRateChangeNotificationRetractedSub


class FacilityRateChangeEventSub(supermod.FacilityRateChangeEvent):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, rate=None, extensiontype_=None):
        super(FacilityRateChangeEventSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, rate, extensiontype_, )
supermod.FacilityRateChangeEvent.subclass = FacilityRateChangeEventSub
# end class FacilityRateChangeEventSub


class FacilityPositionStatementSub(supermod.FacilityPositionStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, statementDate=None, comments=None, facilityPosition=None, positionPartyReference=None, facilityIdentifier=None, facilitySummary=None, party=None):
        super(FacilityPositionStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, statementDate, comments, facilityPosition, positionPartyReference, facilityIdentifier, facilitySummary, party, )
supermod.FacilityPositionStatement.subclass = FacilityPositionStatementSub
# end class FacilityPositionStatementSub


class FacilityOutstandingsPositionStatementSub(supermod.FacilityOutstandingsPositionStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, statementDate=None, comments=None, facilityOutstandingsPosition=None, positionPartyReference=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None, party=None):
        super(FacilityOutstandingsPositionStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, statementDate, comments, facilityOutstandingsPosition, positionPartyReference, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, party, )
supermod.FacilityOutstandingsPositionStatement.subclass = FacilityOutstandingsPositionStatementSub
# end class FacilityOutstandingsPositionStatementSub


class FacilityNotificationRetractedSub(supermod.FacilityNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, facilityEventGroup=None, facilityIdentifier=None, facilitySummary=None):
        super(FacilityNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, facilityEventGroup, facilityIdentifier, facilitySummary, )
supermod.FacilityNotificationRetracted.subclass = FacilityNotificationRetractedSub
# end class FacilityNotificationRetractedSub


class FacilityExtensionFeePaymentSub(supermod.FacilityExtensionFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None):
        super(FacilityExtensionFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, )
supermod.FacilityExtensionFeePayment.subclass = FacilityExtensionFeePaymentSub
# end class FacilityExtensionFeePaymentSub


class FacilitySub(supermod.Facility):
    def __init__(self, id=None, instrumentId=None, description=None, borrowerPartyReference=None, coBorrowerPartyReference=None, agentPartyReference=None, lcIssuingBankPartyReference=None, guarantorPartyReference=None, startDate=None, expiryDate=None, maturityDate=None, currentCommitment=None, originalCommitment=None, commitmentSchedule=None, dealFxRate=None, governingLaw=None, feature=None, lien=None, seniority=None, fixedRateOption=None, floatingRateOption=None, lcOption=None, accruingPikOption=None, accruingFeeOption=None, defaultRate=None, mandatoryCostRate=None, penaltyRate=None, multiCurrency=None, extensiontype_=None):
        super(FacilitySub, self).__init__(id, instrumentId, description, borrowerPartyReference, coBorrowerPartyReference, agentPartyReference, lcIssuingBankPartyReference, guarantorPartyReference, startDate, expiryDate, maturityDate, currentCommitment, originalCommitment, commitmentSchedule, dealFxRate, governingLaw, feature, lien, seniority, fixedRateOption, floatingRateOption, lcOption, accruingPikOption, accruingFeeOption, defaultRate, mandatoryCostRate, penaltyRate, multiCurrency, extensiontype_, )
supermod.Facility.subclass = FacilitySub
# end class FacilitySub


class DelayedDrawSub(supermod.DelayedDraw):
    def __init__(self, id=None, instrumentId=None, description=None, borrowerPartyReference=None, coBorrowerPartyReference=None, agentPartyReference=None, lcIssuingBankPartyReference=None, guarantorPartyReference=None, startDate=None, expiryDate=None, maturityDate=None, currentCommitment=None, originalCommitment=None, commitmentSchedule=None, dealFxRate=None, governingLaw=None, feature=None, lien=None, seniority=None, fixedRateOption=None, floatingRateOption=None, lcOption=None, accruingPikOption=None, accruingFeeOption=None, defaultRate=None, mandatoryCostRate=None, penaltyRate=None, multiCurrency=None, delayedDraw=None, mustDrawByDate=None):
        super(DelayedDrawSub, self).__init__(id, instrumentId, description, borrowerPartyReference, coBorrowerPartyReference, agentPartyReference, lcIssuingBankPartyReference, guarantorPartyReference, startDate, expiryDate, maturityDate, currentCommitment, originalCommitment, commitmentSchedule, dealFxRate, governingLaw, feature, lien, seniority, fixedRateOption, floatingRateOption, lcOption, accruingPikOption, accruingFeeOption, defaultRate, mandatoryCostRate, penaltyRate, multiCurrency, delayedDraw, mustDrawByDate, )
supermod.DelayedDraw.subclass = DelayedDrawSub
# end class DelayedDrawSub


class DefaultRateChangeSub(supermod.DefaultRateChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, rate=None):
        super(DefaultRateChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, rate, )
supermod.DefaultRateChange.subclass = DefaultRateChangeSub
# end class DefaultRateChangeSub


class DealSummarySub(supermod.DealSummary):
    def __init__(self, id=None, instrumentId=None, description=None, issuerPartyReference=None, guarantorPartyReference=None, agentPartyReference=None, syndicationLeadPartyReference=None, syndicationCoLeadPartyReference=None, creditAgreementDate=None, currency=None, issuedAmount=None, currentDealAmount=None, extensiontype_=None):
        super(DealSummarySub, self).__init__(id, instrumentId, description, issuerPartyReference, guarantorPartyReference, agentPartyReference, syndicationLeadPartyReference, syndicationCoLeadPartyReference, creditAgreementDate, currency, issuedAmount, currentDealAmount, extensiontype_, )
supermod.DealSummary.subclass = DealSummarySub
# end class DealSummarySub


class DealStatementSub(supermod.DealStatement):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, statementDate=None, comments=None, deal=None, party=None):
        super(DealStatementSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, statementDate, comments, deal, party, )
supermod.DealStatement.subclass = DealStatementSub
# end class DealStatementSub


class DealSub(supermod.Deal):
    def __init__(self, id=None, instrumentId=None, description=None, issuerPartyReference=None, guarantorPartyReference=None, agentPartyReference=None, syndicationLeadPartyReference=None, syndicationCoLeadPartyReference=None, creditAgreementDate=None, currency=None, issuedAmount=None, currentDealAmount=None, assignmentFee=None, proRataFacilities=None, facilityGroup=None):
        super(DealSub, self).__init__(id, instrumentId, description, issuerPartyReference, guarantorPartyReference, agentPartyReference, syndicationLeadPartyReference, syndicationCoLeadPartyReference, creditAgreementDate, currency, issuedAmount, currentDealAmount, assignmentFee, proRataFacilities, facilityGroup, )
supermod.Deal.subclass = DealSub
# end class DealSub


class BreakageFeePaymentSub(supermod.BreakageFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None, breakageFeeClaimDate=None, breakageFeeCalculatedBy=None):
        super(BreakageFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, breakageFeeClaimDate, breakageFeeCalculatedBy, )
supermod.BreakageFeePayment.subclass = BreakageFeePaymentSub
# end class BreakageFeePaymentSub


class AmendmentFeePaymentSub(supermod.AmendmentFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None):
        super(AmendmentFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, )
supermod.AmendmentFeePayment.subclass = AmendmentFeePaymentSub
# end class AmendmentFeePaymentSub


class AccruingPikPaymentNotificationRetractedSub(supermod.AccruingPikPaymentNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, accruingPikPayment=None, facilityIdentifier=None, facilitySummary=None):
        super(AccruingPikPaymentNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, accruingPikPayment, facilityIdentifier, facilitySummary, )
supermod.AccruingPikPaymentNotificationRetracted.subclass = AccruingPikPaymentNotificationRetractedSub
# end class AccruingPikPaymentNotificationRetractedSub


class AccruingFeePaymentNotificationRetractedSub(supermod.AccruingFeePaymentNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, accruingFeePayment=None, facilityIdentifier=None, facilitySummary=None):
        super(AccruingFeePaymentNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, accruingFeePayment, facilityIdentifier, facilitySummary, )
supermod.AccruingFeePaymentNotificationRetracted.subclass = AccruingFeePaymentNotificationRetractedSub
# end class AccruingFeePaymentNotificationRetractedSub


class AccruingFeeChangeNotificationRetractedSub(supermod.AccruingFeeChangeNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, accruingFeeChangeGroup=None, facilityIdentifier=None, facilitySummary=None):
        super(AccruingFeeChangeNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, accruingFeeChangeGroup, facilityIdentifier, facilitySummary, )
supermod.AccruingFeeChangeNotificationRetracted.subclass = AccruingFeeChangeNotificationRetractedSub
# end class AccruingFeeChangeNotificationRetractedSub


class AccrualOptionChangeNotificationRetractedSub(supermod.AccrualOptionChangeNotificationRetracted):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, eventIdentifier=None, party=None, fixedRateOptionChange=None, floatingRateOptionChange=None, contract=None, accruingPikOptionChange=None, lcOptionChange=None, letterOfCredit=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, letterOfCreditIdentifier=None, letterOfCreditSummary=None):
        super(AccrualOptionChangeNotificationRetractedSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, eventIdentifier, party, fixedRateOptionChange, floatingRateOptionChange, contract, accruingPikOptionChange, lcOptionChange, letterOfCredit, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, letterOfCreditIdentifier, letterOfCreditSummary, )
supermod.AccrualOptionChangeNotificationRetracted.subclass = AccrualOptionChangeNotificationRetractedSub
# end class AccrualOptionChangeNotificationRetractedSub


class AbstractServicingNotificationSub(supermod.AbstractServicingNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, extensiontype_=None):
        super(AbstractServicingNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, extensiontype_, )
supermod.AbstractServicingNotification.subclass = AbstractServicingNotificationSub
# end class AbstractServicingNotificationSub


class AbstractFacilityNotificationSub(supermod.AbstractFacilityNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityPosition=None, extensiontype_=None):
        super(AbstractFacilityNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityPosition, extensiontype_, )
supermod.AbstractFacilityNotification.subclass = AbstractFacilityNotificationSub
# end class AbstractFacilityNotificationSub


class AbstractContractNotificationSub(supermod.AbstractContractNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, extensiontype_=None):
        super(AbstractContractNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, extensiontype_, )
supermod.AbstractContractNotification.subclass = AbstractContractNotificationSub
# end class AbstractContractNotificationSub
...
class WaiverFeePaymentSub(supermod.WaiverFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None):
        super(WaiverFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, )
supermod.WaiverFeePayment.subclass = WaiverFeePaymentSub
# end class WaiverFeePaymentSub


class UpfrontFeePaymentSub(supermod.UpfrontFeePayment):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, amount=None):
        super(UpfrontFeePaymentSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, amount, )
supermod.UpfrontFeePayment.subclass = UpfrontFeePaymentSub
# end class UpfrontFeePaymentSub


class TermLoanSub(supermod.TermLoan):
    def __init__(self, id=None, instrumentId=None, description=None, borrowerPartyReference=None, coBorrowerPartyReference=None, agentPartyReference=None, lcIssuingBankPartyReference=None, guarantorPartyReference=None, startDate=None, expiryDate=None, maturityDate=None, currentCommitment=None, originalCommitment=None, commitmentSchedule=None, dealFxRate=None, governingLaw=None, feature=None, lien=None, seniority=None, fixedRateOption=None, floatingRateOption=None, lcOption=None, accruingPikOption=None, accruingFeeOption=None, defaultRate=None, mandatoryCostRate=None, penaltyRate=None, multiCurrency=None):
        super(TermLoanSub, self).__init__(id, instrumentId, description, borrowerPartyReference, coBorrowerPartyReference, agentPartyReference, lcIssuingBankPartyReference, guarantorPartyReference, startDate, expiryDate, maturityDate, currentCommitment, originalCommitment, commitmentSchedule, dealFxRate, governingLaw, feature, lien, seniority, fixedRateOption, floatingRateOption, lcOption, accruingPikOption, accruingFeeOption, defaultRate, mandatoryCostRate, penaltyRate, multiCurrency, )
supermod.TermLoan.subclass = TermLoanSub
# end class TermLoanSub


class RolloverNotificationSub(supermod.RolloverNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, maturingContracts=None, currentContracts=None, baseRateSet=None, borrowing=None, commitmentAdjustment=None, interestCapitalization=None, interestPayment=None, repayment=None, facilityIdentifier=None, facilitySummary=None, party=None):
        super(RolloverNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, maturingContracts, currentContracts, baseRateSet, borrowing, commitmentAdjustment, interestCapitalization, interestPayment, repayment, facilityIdentifier, facilitySummary, party, )
supermod.RolloverNotification.subclass = RolloverNotificationSub
# end class RolloverNotificationSub


class RevolverSub(supermod.Revolver):
    def __init__(self, id=None, instrumentId=None, description=None, borrowerPartyReference=None, coBorrowerPartyReference=None, agentPartyReference=None, lcIssuingBankPartyReference=None, guarantorPartyReference=None, startDate=None, expiryDate=None, maturityDate=None, currentCommitment=None, originalCommitment=None, commitmentSchedule=None, dealFxRate=None, governingLaw=None, feature=None, lien=None, seniority=None, fixedRateOption=None, floatingRateOption=None, lcOption=None, accruingPikOption=None, accruingFeeOption=None, defaultRate=None, mandatoryCostRate=None, penaltyRate=None, multiCurrency=None):
        super(RevolverSub, self).__init__(id, instrumentId, description, borrowerPartyReference, coBorrowerPartyReference, agentPartyReference, lcIssuingBankPartyReference, guarantorPartyReference, startDate, expiryDate, maturityDate, currentCommitment, originalCommitment, commitmentSchedule, dealFxRate, governingLaw, feature, lien, seniority, fixedRateOption, floatingRateOption, lcOption, accruingPikOption, accruingFeeOption, defaultRate, mandatoryCostRate, penaltyRate, multiCurrency, )
supermod.Revolver.subclass = RevolverSub
# end class RevolverSub


class PrepaymentNotificationSub(supermod.PrepaymentNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, repayment=None, commitmentAdjustment=None, breakageFeePayment=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None, party=None):
        super(PrepaymentNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, repayment, commitmentAdjustment, breakageFeePayment, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, party, )
supermod.PrepaymentNotification.subclass = PrepaymentNotificationSub
# end class PrepaymentNotificationSub


class PenaltyRateChangeSub(supermod.PenaltyRateChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, rate=None):
        super(PenaltyRateChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, rate, )
supermod.PenaltyRateChange.subclass = PenaltyRateChangeSub
# end class PenaltyRateChangeSub


class NonRecurringFeePaymentNotificationSub(supermod.NonRecurringFeePaymentNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, facilityFeePaymentGroup=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None, party=None):
        super(NonRecurringFeePaymentNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, facilityFeePaymentGroup, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, party, )
supermod.NonRecurringFeePaymentNotification.subclass = NonRecurringFeePaymentNotificationSub
# end class NonRecurringFeePaymentNotificationSub


class MandatoryCostRateChangeSub(supermod.MandatoryCostRateChange):
    def __init__(self, eventIdentifier=None, businessEventGroupId=None, previousInaccurateEventId=None, agentPartyReference=None, borrowerPartyReference=None, effectiveDate=None, lenderPartyReference=None, cashPayable=None, comment=None, facilityReference=None, loanContractReference=None, rate=None):
        super(MandatoryCostRateChangeSub, self).__init__(eventIdentifier, businessEventGroupId, previousInaccurateEventId, agentPartyReference, borrowerPartyReference, effectiveDate, lenderPartyReference, cashPayable, comment, facilityReference, loanContractReference, rate, )
supermod.MandatoryCostRateChange.subclass = MandatoryCostRateChangeSub
# end class MandatoryCostRateChangeSub


class LoanContractNotificationSub(supermod.LoanContractNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, loanContractEventGroup=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None, party=None):
        super(LoanContractNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, loanContractEventGroup, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, party, )
supermod.LoanContractNotification.subclass = LoanContractNotificationSub
# end class LoanContractNotificationSub


class LetterOfCreditFacilitySub(supermod.LetterOfCreditFacility):
    def __init__(self, id=None, instrumentId=None, description=None, borrowerPartyReference=None, coBorrowerPartyReference=None, agentPartyReference=None, lcIssuingBankPartyReference=None, guarantorPartyReference=None, startDate=None, expiryDate=None, maturityDate=None, currentCommitment=None, originalCommitment=None, commitmentSchedule=None, dealFxRate=None, governingLaw=None, feature=None, lien=None, seniority=None, fixedRateOption=None, floatingRateOption=None, lcOption=None, accruingPikOption=None, accruingFeeOption=None, defaultRate=None, mandatoryCostRate=None, penaltyRate=None, multiCurrency=None):
        super(LetterOfCreditFacilitySub, self).__init__(id, instrumentId, description, borrowerPartyReference, coBorrowerPartyReference, agentPartyReference, lcIssuingBankPartyReference, guarantorPartyReference, startDate, expiryDate, maturityDate, currentCommitment, originalCommitment, commitmentSchedule, dealFxRate, governingLaw, feature, lien, seniority, fixedRateOption, floatingRateOption, lcOption, accruingPikOption, accruingFeeOption, defaultRate, mandatoryCostRate, penaltyRate, multiCurrency, )
supermod.LetterOfCreditFacility.subclass = LetterOfCreditFacilitySub
# end class LetterOfCreditFacilitySub


class LcNotificationSub(supermod.LcNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, lcEventGroup=None, facilityIdentifier=None, facilitySummary=None, letterOfCreditIdentifier=None, letterOfCreditSummary=None, letterOfCredit=None, party=None):
        super(LcNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, lcEventGroup, facilityIdentifier, facilitySummary, letterOfCreditIdentifier, letterOfCreditSummary, letterOfCredit, party, )
supermod.LcNotification.subclass = LcNotificationSub
# end class LcNotificationSub


class FacilityRateChangeNotificationSub(supermod.FacilityRateChangeNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityPosition=None, facilityRateChangeGroup=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, contract=None, party=None):
        super(FacilityRateChangeNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityPosition, facilityRateChangeGroup, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, contract, party, )
supermod.FacilityRateChangeNotification.subclass = FacilityRateChangeNotificationSub
# end class FacilityRateChangeNotificationSub


class FacilityNotificationSub(supermod.FacilityNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityPosition=None, facilityEventGroup=None, facilityIdentifier=None, facilitySummary=None, party=None):
        super(FacilityNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityPosition, facilityEventGroup, facilityIdentifier, facilitySummary, party, )
supermod.FacilityNotification.subclass = FacilityNotificationSub
# end class FacilityNotificationSub


class AccruingPikPaymentNotificationSub(supermod.AccruingPikPaymentNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityPosition=None, accruingPikPayment=None, facilityIdentifier=None, facilitySummary=None, party=None):
        super(AccruingPikPaymentNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityPosition, accruingPikPayment, facilityIdentifier, facilitySummary, party, )
supermod.AccruingPikPaymentNotification.subclass = AccruingPikPaymentNotificationSub
# end class AccruingPikPaymentNotificationSub


class AccruingFeePaymentNotificationSub(supermod.AccruingFeePaymentNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityPosition=None, accruingFeePayment=None, facilityIdentifier=None, facilitySummary=None, party=None):
        super(AccruingFeePaymentNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityPosition, accruingFeePayment, facilityIdentifier, facilitySummary, party, )
supermod.AccruingFeePaymentNotification.subclass = AccruingFeePaymentNotificationSub
# end class AccruingFeePaymentNotificationSub


class AccruingFeeChangeNotificationSub(supermod.AccruingFeeChangeNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityPosition=None, accruingFeeChangeGroup=None, facilityIdentifier=None, facilitySummary=None, party=None):
        super(AccruingFeeChangeNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityPosition, accruingFeeChangeGroup, facilityIdentifier, facilitySummary, party, )
supermod.AccruingFeeChangeNotification.subclass = AccruingFeeChangeNotificationSub
# end class AccruingFeeChangeNotificationSub


class AccrualOptionChangeNotificationSub(supermod.AccrualOptionChangeNotification):
    def __init__(self, fpmlVersion=None, expectedBuild=None, actualBuild=None, header=None, validation=None, isCorrection=None, parentCorrelationId=None, correlationId=None, sequenceNumber=None, onBehalfOf=None, noticeDate=None, isGlobalOnly=None, paymentDetails=None, facilityOutstandingsPosition=None, fixedRateOptionChange=None, floatingRateOptionChange=None, contract=None, accruingPikOptionChange=None, lcOptionChange=None, letterOfCredit=None, facilityIdentifier=None, facilitySummary=None, contractIdentifier=None, contractSummary=None, letterOfCreditIdentifier=None, letterOfCreditSummary=None, party=None):
        super(AccrualOptionChangeNotificationSub, self).__init__(fpmlVersion, expectedBuild, actualBuild, header, validation, isCorrection, parentCorrelationId, correlationId, sequenceNumber, onBehalfOf, noticeDate, isGlobalOnly, paymentDetails, facilityOutstandingsPosition, fixedRateOptionChange, floatingRateOptionChange, contract, accruingPikOptionChange, lcOptionChange, letterOfCredit, facilityIdentifier, facilitySummary, contractIdentifier, contractSummary, letterOfCreditIdentifier, letterOfCreditSummary, party, )
supermod.AccrualOptionChangeNotification.subclass = AccrualOptionChangeNotificationSub
# end class AccrualOptionChangeNotificationSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AbstractContractNotification'
        rootClass = supermod.AbstractContractNotification
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_loanlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_loanlib as model_\n\n')
