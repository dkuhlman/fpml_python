...
#
# Generated Tue Feb 23 09:02:48 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_mktenvlib.py')
#   ('-s', 'fpml01/fpml_mktenvapp.py')
#   ('--super', 'fpml01/fpml_mktenvlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-mktenv.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_mktenvlib.py" -s "fpml01/fpml_mktenvapp.py" --super="fpml01/fpml_mktenvlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-mktenv.xsd
#
...
import fpml01/fpml_mktenvlib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'CompoundingFrequency'
        rootClass = supermod.CompoundingFrequency
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_mktenvlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_mktenvlib as model_\n\n')
