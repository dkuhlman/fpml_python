...
#
# Generated Tue Feb 23 09:01:35 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_dividend_swapslib.py')
#   ('-s', 'fpml01/fpml_dividend_swapsapp.py')
#   ('--super', 'fpml01/fpml_dividend_swapslib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-dividend-swaps.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_dividend_swapslib.py" -s "fpml01/fpml_dividend_swapsapp.py" --super="fpml01/fpml_dividend_swapslib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-dividend-swaps.xsd
#
...
import fpml01/fpml_dividend_swapslib as supermod
...
class FixedPaymentLegSub(supermod.FixedPaymentLeg):
    def __init__(self, id=None, legIdentifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, effectiveDate=None, terminationDate=None, fixedPayment=None):
        super(FixedPaymentLegSub, self).__init__(id, legIdentifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, effectiveDate, terminationDate, fixedPayment, )
supermod.FixedPaymentLeg.subclass = FixedPaymentLegSub
# end class FixedPaymentLegSub


class FixedPaymentAmountSub(supermod.FixedPaymentAmount):
    def __init__(self, id=None, paymentAmount=None, paymentDate=None):
        super(FixedPaymentAmountSub, self).__init__(id, paymentAmount, paymentDate, )
supermod.FixedPaymentAmount.subclass = FixedPaymentAmountSub
# end class FixedPaymentAmountSub


class DividendSwapTransactionSupplementSub(supermod.DividendSwapTransactionSupplement):
    def __init__(self, id=None, primaryAssetClass=None, secondaryAssetClass=None, productType=None, productId=None, assetClass=None, embeddedOptionType=None, dividendLeg=None, fixedLeg=None, multipleExchangeIndexAnnexFallback=None, componentSecurityIndexAnnexFallback=None, localJurisdiction=None, relevantJurisdiction=None):
        super(DividendSwapTransactionSupplementSub, self).__init__(id, primaryAssetClass, secondaryAssetClass, productType, productId, assetClass, embeddedOptionType, dividendLeg, fixedLeg, multipleExchangeIndexAnnexFallback, componentSecurityIndexAnnexFallback, localJurisdiction, relevantJurisdiction, )
supermod.DividendSwapTransactionSupplement.subclass = DividendSwapTransactionSupplementSub
# end class DividendSwapTransactionSupplementSub


class DividendPeriodPaymentSub(supermod.DividendPeriodPayment):
    def __init__(self, id=None, unadjustedStartDate=None, unadjustedEndDate=None, dateAdjustments=None, underlyerReference=None, fixedStrike=None, paymentDate=None, valuationDate=None):
        super(DividendPeriodPaymentSub, self).__init__(id, unadjustedStartDate, unadjustedEndDate, dateAdjustments, underlyerReference, fixedStrike, paymentDate, valuationDate, )
supermod.DividendPeriodPayment.subclass = DividendPeriodPaymentSub
# end class DividendPeriodPaymentSub


class DividendLegSub(supermod.DividendLeg):
    def __init__(self, id=None, legIdentifier=None, payerPartyReference=None, payerAccountReference=None, receiverPartyReference=None, receiverAccountReference=None, effectiveDate=None, terminationDate=None, underlyer=None, settlementType=None, settlementDate=None, settlementAmount=None, settlementCurrency=None, fxFeature=None, declaredCashDividendPercentage=None, declaredCashEquivalentDividendPercentage=None, dividendPeriod=None, specialDividends=None, materialDividend=None):
        super(DividendLegSub, self).__init__(id, legIdentifier, payerPartyReference, payerAccountReference, receiverPartyReference, receiverAccountReference, effectiveDate, terminationDate, underlyer, settlementType, settlementDate, settlementAmount, settlementCurrency, fxFeature, declaredCashDividendPercentage, declaredCashEquivalentDividendPercentage, dividendPeriod, specialDividends, materialDividend, )
supermod.DividendLeg.subclass = DividendLegSub
# end class DividendLegSub
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'DividendLeg'
        rootClass = supermod.DividendLeg
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_dividend_swapslib import *\n\n')
        sys.stdout.write('import fpml01/fpml_dividend_swapslib as model_\n\n')
