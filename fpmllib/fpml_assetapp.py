...
#
# Generated Tue Feb 23 09:00:27 2016 by generateDS.py version 2.19b.
#
# Command line options:
#   ('-f', '')
#   ('-o', 'fpml01/fpml_assetlib.py')
#   ('-s', 'fpml01/fpml_assetapp.py')
#   ('--super', 'fpml01/fpml_assetlib')
#   ('--member-specs', 'dict')
#   ('--export', 'write')
#
# Command line arguments:
#   fpml-master-schema-and-key-gen-scripts/src/schema/fpml-asset.xsd
#
# Command line:
#   ./generateDS.py -f -o "fpml01/fpml_assetlib.py" -s "fpml01/fpml_assetapp.py" --super="fpml01/fpml_assetlib" --member-specs="dict" --export="write" fpml-master-schema-and-key-gen-scripts/src/schema/fpml-asset.xsd
#
...
import fpml01/fpml_assetlib as supermod
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ActualPrice'
        rootClass = supermod.ActualPrice
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from fpml01/fpml_assetlib import *\n\n')
        sys.stdout.write('import fpml01/fpml_assetlib as model_\n\n')
